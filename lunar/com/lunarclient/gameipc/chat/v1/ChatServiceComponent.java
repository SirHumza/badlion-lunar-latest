...
public abstract class ChatService implements Service {
   ...
   public static Service newReflectiveService(final ChatService.Interface var0) {
      return new ChatService() {
         @Override
         public void receiveMessage(RpcController var1, ReceiveMessageRequest var2, RpcCallback<ReceiveMessageResponse> var3) {
            var0.receiveMessage(var1, var2, var3);
         }
      };
   }
      ...
      return new BlockingService() {
         ...
         public final Message callBlockingMethod(Descriptors.MethodDescriptor var1, RpcController var2, Message var3) {
            ...
            switch (var1.getIndex()) {
               case 0:
                  return var0.receiveMessage(var2, (ReceiveMessageRequest)var3);
               default:
   ...
   public abstract void receiveMessage(RpcController var1, ReceiveMessageRequest var2, RpcCallback<ReceiveMessageResponse> var3);
   ...
   public final void callMethod(Descriptors.MethodDescriptor var1, RpcController var2, Message var3, RpcCallback<Message> var4) {
      ...
      switch (var1.getIndex()) {
         case 0:
            this.receiveMessage(var2, (ReceiveMessageRequest)var3, RpcUtil.specializeCallback(var4));
            return;
         default:
            throw new AssertionError("Can't get here.");
      }
   ...
   public interface BlockingInterface {
      ReceiveMessageResponse receiveMessage(RpcController var1, ReceiveMessageRequest var2);
   }
   ...
   private static final class BlockingStub implements ChatService.BlockingInterface {
      ...
      @Override
      public ReceiveMessageResponse receiveMessage(RpcController var1, ReceiveMessageRequest var2) {
         return (ReceiveMessageResponse)this.channel
            .callBlockingMethod(ChatService.getDescriptor().getMethods().get(0), var1, var2, ReceiveMessageResponse.getDefaultInstance());
      }
   }

   public interface Interface {
      void receiveMessage(RpcController var1, ReceiveMessageRequest var2, RpcCallback<ReceiveMessageResponse> var3);
   }
      ...
      public void receiveMessage(RpcController var1, ReceiveMessageRequest var2, RpcCallback<ReceiveMessageResponse> var3) {
         this.channel
            .callMethod(
               ...
               var1,
               var2,
               ReceiveMessageResponse.getDefaultInstance(),
               RpcUtil.generalizeCallback(var3, ReceiveMessageResponse.class, ReceiveMessageResponse.getDefaultInstance())
            );
      }
   }
}
