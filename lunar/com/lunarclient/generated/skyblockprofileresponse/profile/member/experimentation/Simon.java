...
public record Simon() {
   ...
   public Simon(@NotNull BetterJson var1) {
      if (var1 == null) {
   ...
   public Optional<Double> attempts0() {
      return this.elm.get("attempts_0").asDouble();
   }
   ...
   public Optional<Double> attempts5() {
      return this.elm.get("attempts_5").asDouble();
   }
