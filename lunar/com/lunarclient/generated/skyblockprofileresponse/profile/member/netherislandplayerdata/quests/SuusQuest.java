...
public record SuusQuest() {
   @NotNull
   private final BetterJson elm;

   public SuusQuest(@NotNull BetterJson var1) {
      if (var1 == null) {
   ...
   public Optional<Double> lastToyDrop() {
      return this.elm.get("last_toy_drop").asDouble();
   }

   public Optional<String> mobId() {
      return this.elm.get("mob_id").asString();
   }
