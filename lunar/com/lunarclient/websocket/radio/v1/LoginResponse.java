...
public final class LoginResponse extends GeneratedMessageV3 implements LoginResponseOrBuilder {
   ...
   public static final int IS_PREMIUM_FIELD_NUMBER = 1;
   private boolean isPremium_ = false;
   public static final int RADIO_PLAYING_VISIBILITY_FIELD_NUMBER = 2;
   private int radioPlayingVisibility_ = 0;
   ...
   private LoginResponse() {
      this.radioPlayingVisibility_ = 0;
   }
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return ServiceProto.internal_static_lunarclient_websocket_radio_v1_LoginResponse_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return ServiceProto.internal_static_lunarclient_websocket_radio_v1_LoginResponse_fieldAccessorTable
   ...
   @Override
   public int getRadioPlayingVisibilityValue() {
      return this.radioPlayingVisibility_;
   }

   @Override
   public RadioPlayingVisibility getRadioPlayingVisibility() {
      RadioPlayingVisibility var1 = RadioPlayingVisibility.forNumber(this.radioPlayingVisibility_);
   ...
   public void writeTo(CodedOutputStream var1) {
      if (this.isPremium_) {
         var1.writeBool(1, this.isPremium_);
      }

      if (this.radioPlayingVisibility_ != RadioPlayingVisibility.RADIO_PLAYING_VISIBILITY_UNSPECIFIED.getNumber()) {
         var1.writeEnum(2, this.radioPlayingVisibility_);
      }
   ...
   public int getSerializedSize() {
      ...
      var1 = 0;
      if (this.isPremium_) {
         var1 += CodedOutputStream.computeBoolSize(1, this.isPremium_);
      }

      if (this.radioPlayingVisibility_ != RadioPlayingVisibility.RADIO_PLAYING_VISIBILITY_UNSPECIFIED.getNumber()) {
         var1 += CodedOutputStream.computeEnumSize(2, this.radioPlayingVisibility_);
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         ...
         if (this.getIsPremium() != var2.getIsPremium()) {
            return false;
         } else {
            return this.radioPlayingVisibility_ != var2.radioPlayingVisibility_ ? false : this.getUnknownFields().equals(var2.getUnknownFields());
         }
      }
   }
   ...
   public int hashCode() {
      ...
      var1 = 37 * var1 + 1;
      var1 = 53 * var1 + Internal.hashBoolean(this.getIsPremium());
      var1 = 37 * var1 + 2;
      var1 = 53 * var1 + this.radioPlayingVisibility_;
   ...
   public static final class Builder extends GeneratedMessageV3.Builder<LoginResponse.Builder> implements LoginResponseOrBuilder {
      ...
      private void buildPartial0(LoginResponse var1) {
         ...
         if ((var2 & 1) != 0) {
            var1.isPremium_ = this.isPremium_;
         }

         if ((var2 & 2) != 0) {
            var1.radioPlayingVisibility_ = this.radioPlayingVisibility_;
         }
      }
      ...
      public LoginResponse.Builder mergeFrom(LoginResponse var1) {
         ...
         if (var1.getIsPremium()) {
            this.setIsPremium(var1.getIsPremium());
         }

         if (var1.radioPlayingVisibility_ != 0) {
            this.setRadioPlayingVisibilityValue(var1.getRadioPlayingVisibilityValue());
         }
            ...
            while (!var3) {
               ...
               switch (var4) {
                  case 0:
                     ...
                     break;
                  case 8:
                     this.isPremium_ = var1.readBool();
                     this.bitField0_ |= 1;
                     break;
                  case 16:
                     this.radioPlayingVisibility_ = var1.readEnum();
                     this.bitField0_ |= 2;
                     break;
                  default:
      ...
      public LoginResponse.Builder setIsPremium(boolean var1) {
         this.isPremium_ = var1;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      }

      public LoginResponse.Builder clearIsPremium() {
         this.bitField0_ &= -2;
         this.isPremium_ = false;
         this.onChanged();
         return this;
      ...
      public LoginResponse.Builder setRadioPlayingVisibilityValue(int var1) {
         this.radioPlayingVisibility_ = var1;
         this.bitField0_ |= 2;
         this.onChanged();
         return this;
      }
      ...
      public LoginResponse.Builder setRadioPlayingVisibility(RadioPlayingVisibility var1) {
         if (var1 == null) {
            throw new NullPointerException();
         }

         this.bitField0_ |= 2;
         this.radioPlayingVisibility_ = var1.getNumber();
         this.onChanged();
         return this;
      }

      public LoginResponse.Builder clearRadioPlayingVisibility() {
         this.bitField0_ &= -3;
         this.radioPlayingVisibility_ = 0;
         this.onChanged();
         return this;
