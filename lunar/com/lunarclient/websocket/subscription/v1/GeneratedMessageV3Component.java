...
public final class SubscribeRequest extends GeneratedMessageV3 implements SubscribeRequestOrBuilder {
   ...
   private static final Parser<SubscribeRequest> PARSER = new AbstractParser<SubscribeRequest>() {
      public SubscribeRequest parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
         SubscribeRequest.Builder var3 = SubscribeRequest.newBuilder();
   ...
   private SubscribeRequest(GeneratedMessageV3.Builder<?> var1) {
      super(var1);
   }
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return ServiceProto.internal_static_lunarclient_websocket_subscription_v1_SubscribeRequest_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return ServiceProto.internal_static_lunarclient_websocket_subscription_v1_SubscribeRequest_fieldAccessorTable
         .ensureFieldAccessorsInitialized(SubscribeRequest.class, SubscribeRequest.Builder.class);
   }
   ...
   public boolean equals(Object var1) {
      ...
      if (!(var1 instanceof SubscribeRequest)) {
         return super.equals(var1);
      }

      SubscribeRequest var2 = (SubscribeRequest)var1;
   ...
   public static SubscribeRequest parseFrom(ByteBuffer var0) {
      return PARSER.parseFrom(var0);
   }

   public static SubscribeRequest parseFrom(ByteBuffer var0, ExtensionRegistryLite var1) {
      return PARSER.parseFrom(var0, var1);
   }

   public static SubscribeRequest parseFrom(ByteString var0) {
      return PARSER.parseFrom(var0);
   }

   public static SubscribeRequest parseFrom(ByteString var0, ExtensionRegistryLite var1) {
      return PARSER.parseFrom(var0, var1);
   }

   public static SubscribeRequest parseFrom(byte[] var0) {
      return PARSER.parseFrom(var0);
   }

   public static SubscribeRequest parseFrom(byte[] var0, ExtensionRegistryLite var1) {
      return PARSER.parseFrom(var0, var1);
   }

   public static SubscribeRequest parseFrom(InputStream var0) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0);
   }

   public static SubscribeRequest parseFrom(InputStream var0, ExtensionRegistryLite var1) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0, var1);
   }

   public static SubscribeRequest parseDelimitedFrom(InputStream var0) {
      return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, var0);
   }

   public static SubscribeRequest parseDelimitedFrom(InputStream var0, ExtensionRegistryLite var1) {
      return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, var0, var1);
   }

   public static SubscribeRequest parseFrom(CodedInputStream var0) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0);
   }

   public static SubscribeRequest parseFrom(CodedInputStream var0, ExtensionRegistryLite var1) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0, var1);
   }
   ...
   public static SubscribeRequest.Builder newBuilder(SubscribeRequest var0) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(var0);
   }

   public SubscribeRequest.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new SubscribeRequest.Builder() : new SubscribeRequest.Builder().mergeFrom(this);
   }

   protected SubscribeRequest.Builder newBuilderForType(GeneratedMessageV3.BuilderParent var1) {
      return new SubscribeRequest.Builder(var1);
   }
   ...
   public static final class Builder extends GeneratedMessageV3.Builder<SubscribeRequest.Builder> implements SubscribeRequestOrBuilder {
      ...
      public SubscribeRequest build() {
         SubscribeRequest var1 = this.buildPartial();
      ...
      public SubscribeRequest buildPartial() {
         SubscribeRequest var1 = new SubscribeRequest(this);
      ...
      private void buildPartialRepeatedFields(SubscribeRequest var1) {
         if (this.targetUuidsBuilder_ == null) {
      ...
      private void buildPartial0(SubscribeRequest var1) {
         int var2 = this.bitField0_;
      }

      public SubscribeRequest.Builder clone() {
         return (SubscribeRequest.Builder)super.clone();
      }

      public SubscribeRequest.Builder setField(Descriptors.FieldDescriptor var1, Object var2) {
         return (SubscribeRequest.Builder)super.setField(var1, var2);
      }

      public SubscribeRequest.Builder clearField(Descriptors.FieldDescriptor var1) {
         return (SubscribeRequest.Builder)super.clearField(var1);
      }

      public SubscribeRequest.Builder clearOneof(Descriptors.OneofDescriptor var1) {
         return (SubscribeRequest.Builder)super.clearOneof(var1);
      }

      public SubscribeRequest.Builder setRepeatedField(Descriptors.FieldDescriptor var1, int var2, Object var3) {
         return (SubscribeRequest.Builder)super.setRepeatedField(var1, var2, var3);
      }

      public SubscribeRequest.Builder addRepeatedField(Descriptors.FieldDescriptor var1, Object var2) {
         return (SubscribeRequest.Builder)super.addRepeatedField(var1, var2);
      }

      public SubscribeRequest.Builder mergeFrom(Message var1) {
         if (var1 instanceof SubscribeRequest) {
            return this.mergeFrom((SubscribeRequest)var1);
         }
      ...
      public SubscribeRequest.Builder mergeFrom(SubscribeRequest var1) {
         if (var1 == SubscribeRequest.getDefaultInstance()) {
            return this;
         }
         ...
         if (this.targetUuidsBuilder_ == null) {
            ...
            if (this.targetUuidsBuilder_.isEmpty()) {
               ...
               this.targetUuids_ = var1.targetUuids_;
               this.bitField0_ &= -2;
               this.targetUuidsBuilder_ = SubscribeRequest.alwaysUseFieldBuilders ? this.getTargetUuidsFieldBuilder() : null;
            } else {
      ...
      public SubscribeRequest.Builder mergeFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
         if (var2 == null) {
      ...
      public SubscribeRequest.Builder setTargetUuids(int var1, Uuid var2) {
         if (this.targetUuidsBuilder_ == null) {
            if (var2 == null) {
               throw new NullPointerException();
            }
      ...
      public SubscribeRequest.Builder setTargetUuids(int var1, Uuid.Builder var2) {
         if (this.targetUuidsBuilder_ == null) {
            this.ensureTargetUuidsIsMutable();
      ...
      public SubscribeRequest.Builder addTargetUuids(Uuid var1) {
         if (this.targetUuidsBuilder_ == null) {
            if (var1 == null) {
               throw new NullPointerException();
            }
      ...
      public SubscribeRequest.Builder addTargetUuids(int var1, Uuid var2) {
         if (this.targetUuidsBuilder_ == null) {
            if (var2 == null) {
               throw new NullPointerException();
            }
      ...
      public SubscribeRequest.Builder addTargetUuids(Uuid.Builder var1) {
         if (this.targetUuidsBuilder_ == null) {
            this.ensureTargetUuidsIsMutable();
      ...
      public SubscribeRequest.Builder addTargetUuids(int var1, Uuid.Builder var2) {
         if (this.targetUuidsBuilder_ == null) {
            this.ensureTargetUuidsIsMutable();
      ...
      public SubscribeRequest.Builder addAllTargetUuids(Iterable<? extends Uuid> var1) {
         if (this.targetUuidsBuilder_ == null) {
            this.ensureTargetUuidsIsMutable();
      ...
      public SubscribeRequest.Builder clearTargetUuids() {
         if (this.targetUuidsBuilder_ == null) {
            this.targetUuids_ = Collections.emptyList();
            this.bitField0_ &= -2;
            this.onChanged();
      ...
      public SubscribeRequest.Builder removeTargetUuids(int var1) {
         if (this.targetUuidsBuilder_ == null) {
            this.ensureTargetUuidsIsMutable();
      ...
      public final SubscribeRequest.Builder setUnknownFields(UnknownFieldSet var1) {
         return (SubscribeRequest.Builder)super.setUnknownFields(var1);
      }

      public final SubscribeRequest.Builder mergeUnknownFields(UnknownFieldSet var1) {
         return (SubscribeRequest.Builder)super.mergeUnknownFields(var1);
      }
   }
}
