...
public abstract class JamService implements Service {
   protected JamService() {
   }

   public static Service newReflectiveService(final JamService.Interface var0) {
   ...
   public static BlockingService newReflectiveBlockingService(final JamService.BlockingInterface var0) {
      return new BlockingService() {
         @Override
         public final Descriptors.ServiceDescriptor getDescriptorForType() {
            return JamService.getDescriptor();
         }

         @Override
         public final Message callBlockingMethod(Descriptors.MethodDescriptor var1, RpcController var2, Message var3) {
            if (var1.getService() != JamService.getDescriptor()) {
   ...
   public static JamService.Stub newStub(RpcChannel var0) {
      return new JamService.Stub(var0);
   }

   public static JamService.BlockingInterface newBlockingStub(BlockingRpcChannel var0) {
      return new JamService.BlockingStub(var0);
   }
   ...
   private static final class BlockingStub implements JamService.BlockingInterface {
      ...
      public LoginResponse login(RpcController var1, LoginRequest var2) {
         return (LoginResponse)this.channel.callBlockingMethod(JamService.getDescriptor().getMethods().get(0), var1, var2, LoginResponse.getDefaultInstance());
      }
   }
   ...
   public static final class Stub extends JamService implements JamService.Interface {
