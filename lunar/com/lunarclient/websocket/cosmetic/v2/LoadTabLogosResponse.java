...
public final class LoadTabLogosResponse extends GeneratedMessageV3 implements LoadTabLogosResponseOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return ServiceProto.internal_static_lunarclient_websocket_cosmetic_v2_LoadTabLogosResponse_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return ServiceProto.internal_static_lunarclient_websocket_cosmetic_v2_LoadTabLogosResponse_fieldAccessorTable
   ...
   public static final class TabLogo extends GeneratedMessageV3 implements LoadTabLogosResponse.TabLogoOrBuilder {
      ...
      public static final Descriptors.Descriptor getDescriptor() {
         return ServiceProto.internal_static_lunarclient_websocket_cosmetic_v2_LoadTabLogosResponse_TabLogo_descriptor;
      }

      @Override
      protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
         return ServiceProto.internal_static_lunarclient_websocket_cosmetic_v2_LoadTabLogosResponse_TabLogo_fieldAccessorTable
