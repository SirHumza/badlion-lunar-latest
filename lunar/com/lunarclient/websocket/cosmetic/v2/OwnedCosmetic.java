...
public final class OwnedCosmetic extends GeneratedMessageV3 implements OwnedCosmeticOrBuilder {
   ...
   private static final Parser<OwnedCosmetic> PARSER = new AbstractParser<OwnedCosmetic>() {
      public OwnedCosmetic parsePartialFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
         OwnedCosmetic.Builder var3 = OwnedCosmetic.newBuilder();
   ...
   private OwnedCosmetic(GeneratedMessageV3.Builder<?> var1) {
      super(var1);
   }
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return CommonProto.internal_static_lunarclient_websocket_cosmetic_v2_OwnedCosmetic_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return CommonProto.internal_static_lunarclient_websocket_cosmetic_v2_OwnedCosmetic_fieldAccessorTable
         .ensureFieldAccessorsInitialized(OwnedCosmetic.class, OwnedCosmetic.Builder.class);
   }
   ...
   @Override
   public OwnedCosmetic.ExpirationReason getExpirationReason() {
      OwnedCosmetic.ExpirationReason var1 = OwnedCosmetic.ExpirationReason.forNumber(this.expirationReason_);
      return var1 == null ? OwnedCosmetic.ExpirationReason.UNRECOGNIZED : var1;
   }
   ...
   public void writeTo(CodedOutputStream var1) {
      ...
      if (this.expirationReason_ != OwnedCosmetic.ExpirationReason.EXPIRATION_REASON_UNSPECIFIED.getNumber()) {
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof OwnedCosmetic)) {
         return super.equals(var1);
      } else {
         OwnedCosmetic var2 = (OwnedCosmetic)var1;
   ...
   public static OwnedCosmetic parseFrom(ByteBuffer var0) {
      return PARSER.parseFrom(var0);
   }

   public static OwnedCosmetic parseFrom(ByteBuffer var0, ExtensionRegistryLite var1) {
      return PARSER.parseFrom(var0, var1);
   }

   public static OwnedCosmetic parseFrom(ByteString var0) {
      return PARSER.parseFrom(var0);
   }

   public static OwnedCosmetic parseFrom(ByteString var0, ExtensionRegistryLite var1) {
      return PARSER.parseFrom(var0, var1);
   }

   public static OwnedCosmetic parseFrom(byte[] var0) {
      return PARSER.parseFrom(var0);
   }

   public static OwnedCosmetic parseFrom(byte[] var0, ExtensionRegistryLite var1) {
      return PARSER.parseFrom(var0, var1);
   }

   public static OwnedCosmetic parseFrom(InputStream var0) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0);
   }

   public static OwnedCosmetic parseFrom(InputStream var0, ExtensionRegistryLite var1) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0, var1);
   }

   public static OwnedCosmetic parseDelimitedFrom(InputStream var0) {
      return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, var0);
   }

   public static OwnedCosmetic parseDelimitedFrom(InputStream var0, ExtensionRegistryLite var1) {
      return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, var0, var1);
   }

   public static OwnedCosmetic parseFrom(CodedInputStream var0) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0);
   }

   public static OwnedCosmetic parseFrom(CodedInputStream var0, ExtensionRegistryLite var1) {
      return GeneratedMessageV3.parseWithIOException(PARSER, var0, var1);
   }

   public OwnedCosmetic.Builder newBuilderForType() {
      return newBuilder();
   }

   public static OwnedCosmetic.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static OwnedCosmetic.Builder newBuilder(OwnedCosmetic var0) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(var0);
   }

   public OwnedCosmetic.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new OwnedCosmetic.Builder() : new OwnedCosmetic.Builder().mergeFrom(this);
   }

   protected OwnedCosmetic.Builder newBuilderForType(GeneratedMessageV3.BuilderParent var1) {
      return new OwnedCosmetic.Builder(var1);
   }
   ...
   public static final class Builder extends GeneratedMessageV3.Builder<OwnedCosmetic.Builder> implements OwnedCosmeticOrBuilder {
      private int bitField0_;
      ...
      public OwnedCosmetic.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.cosmeticId_ = 0;
      ...
      public OwnedCosmetic build() {
         OwnedCosmetic var1 = this.buildPartial();
      ...
      public OwnedCosmetic buildPartial() {
         OwnedCosmetic var1 = new OwnedCosmetic(this);
      ...
      private void buildPartial0(OwnedCosmetic var1) {
         ...
         OwnedCosmetic var4 = var1;
         var4.bitField0_ = var4.bitField0_ | var3;
      }

      public OwnedCosmetic.Builder clone() {
         return (OwnedCosmetic.Builder)super.clone();
      }

      public OwnedCosmetic.Builder setField(Descriptors.FieldDescriptor var1, Object var2) {
         return (OwnedCosmetic.Builder)super.setField(var1, var2);
      }

      public OwnedCosmetic.Builder clearField(Descriptors.FieldDescriptor var1) {
         return (OwnedCosmetic.Builder)super.clearField(var1);
      }

      public OwnedCosmetic.Builder clearOneof(Descriptors.OneofDescriptor var1) {
         return (OwnedCosmetic.Builder)super.clearOneof(var1);
      }

      public OwnedCosmetic.Builder setRepeatedField(Descriptors.FieldDescriptor var1, int var2, Object var3) {
         return (OwnedCosmetic.Builder)super.setRepeatedField(var1, var2, var3);
      }

      public OwnedCosmetic.Builder addRepeatedField(Descriptors.FieldDescriptor var1, Object var2) {
         return (OwnedCosmetic.Builder)super.addRepeatedField(var1, var2);
      }

      public OwnedCosmetic.Builder mergeFrom(Message var1) {
         if (var1 instanceof OwnedCosmetic) {
            return this.mergeFrom((OwnedCosmetic)var1);
         }
      ...
      public OwnedCosmetic.Builder mergeFrom(OwnedCosmetic var1) {
         if (var1 == OwnedCosmetic.getDefaultInstance()) {
            return this;
         }
      ...
      public OwnedCosmetic.Builder mergeFrom(CodedInputStream var1, ExtensionRegistryLite var2) {
         if (var2 == null) {
      ...
      public OwnedCosmetic.Builder setCosmeticId(int var1) {
      ...
      public OwnedCosmetic.Builder clearCosmeticId() {
         this.bitField0_ &= -2;
         this.cosmeticId_ = 0;
         this.onChanged();
         return this;
      ...
      public OwnedCosmetic.Builder setGrantedAt(Timestamp var1) {
         if (this.grantedAtBuilder_ == null) {
            if (var1 == null) {
               throw new NullPointerException();
            }
      ...
      public OwnedCosmetic.Builder setGrantedAt(Timestamp.Builder var1) {
         if (this.grantedAtBuilder_ == null) {
      ...
      public OwnedCosmetic.Builder mergeGrantedAt(Timestamp var1) {
         if (this.grantedAtBuilder_ == null) {
      ...
      public OwnedCosmetic.Builder clearGrantedAt() {
         this.bitField0_ &= -3;
         this.grantedAt_ = null;
         if (this.grantedAtBuilder_ != null) {
            this.grantedAtBuilder_.dispose();
      ...
      public OwnedCosmetic.Builder setExpiresAt(Timestamp var1) {
         if (this.expiresAtBuilder_ == null) {
            if (var1 == null) {
               throw new NullPointerException();
            }
      ...
      public OwnedCosmetic.Builder setExpiresAt(Timestamp.Builder var1) {
         if (this.expiresAtBuilder_ == null) {
      ...
      public OwnedCosmetic.Builder mergeExpiresAt(Timestamp var1) {
         if (this.expiresAtBuilder_ == null) {
      ...
      public OwnedCosmetic.Builder clearExpiresAt() {
         this.bitField0_ &= -5;
         this.expiresAt_ = null;
         if (this.expiresAtBuilder_ != null) {
            this.expiresAtBuilder_.dispose();
      ...
      public OwnedCosmetic.Builder setExpirationReasonValue(int var1) {
      ...
      public OwnedCosmetic.Builder setExpirationReason(OwnedCosmetic.ExpirationReason var1) {
         if (var1 == null) {
            throw new NullPointerException();
         }
      ...
      public OwnedCosmetic.Builder clearExpirationReason() {
         this.bitField0_ &= -9;
         this.expirationReason_ = 0;
         this.onChanged();
         return this;
      ...
      public OwnedCosmetic.Builder setGiftInfo(GiftInfo var1) {
         if (this.giftInfoBuilder_ == null) {
            if (var1 == null) {
               throw new NullPointerException();
            }
      ...
      public OwnedCosmetic.Builder setGiftInfo(GiftInfo.Builder var1) {
         if (this.giftInfoBuilder_ == null) {
      ...
      public OwnedCosmetic.Builder mergeGiftInfo(GiftInfo var1) {
         if (this.giftInfoBuilder_ == null) {
      ...
      public OwnedCosmetic.Builder clearGiftInfo() {
         this.bitField0_ &= -17;
         this.giftInfo_ = null;
         if (this.giftInfoBuilder_ != null) {
            this.giftInfoBuilder_.dispose();
      ...
      public final OwnedCosmetic.Builder setUnknownFields(UnknownFieldSet var1) {
         return (OwnedCosmetic.Builder)super.setUnknownFields(var1);
      }

      public final OwnedCosmetic.Builder mergeUnknownFields(UnknownFieldSet var1) {
         return (OwnedCosmetic.Builder)super.mergeUnknownFields(var1);
      }
   }
   ...
   public enum ExpirationReason implements ProtocolMessageEnum {
      ...
      private static final Internal.EnumLiteMap<OwnedCosmetic.ExpirationReason> internalValueMap = new Internal.EnumLiteMap<OwnedCosmetic.ExpirationReason>() {
         public OwnedCosmetic.ExpirationReason findValueByNumber(int var1) {
            return OwnedCosmetic.ExpirationReason.forNumber(var1);
         }
      };
      private static final OwnedCosmetic.ExpirationReason[] VALUES = values();
      ...
      @Deprecated
      public static OwnedCosmetic.ExpirationReason valueOf(int var0) {
         return forNumber(var0);
      }

      public static OwnedCosmetic.ExpirationReason forNumber(int var0) {
         switch (var0) {
            case 0:
      ...
      public static Internal.EnumLiteMap<OwnedCosmetic.ExpirationReason> internalGetValueMap() {
      ...
      public static OwnedCosmetic.ExpirationReason valueOf(Descriptors.EnumValueDescriptor var0) {
