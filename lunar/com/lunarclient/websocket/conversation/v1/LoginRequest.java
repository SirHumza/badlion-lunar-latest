...
public final class LoginRequest extends GeneratedMessageV3 implements LoginRequestOrBuilder {
   ...
   public static final int USING_SATELLITE_FIELD_NUMBER = 1;
   private boolean usingSatellite_ = false;
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return ServiceProto.internal_static_lunarclient_websocket_conversation_v1_LoginRequest_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return ServiceProto.internal_static_lunarclient_websocket_conversation_v1_LoginRequest_fieldAccessorTable
         .ensureFieldAccessorsInitialized(LoginRequest.class, LoginRequest.Builder.class);
   }

   @Override
   public boolean hasUsingSatellite() {
      return (this.bitField0_ & 1) != 0;
   }

   @Override
   public boolean getUsingSatellite() {
      return this.usingSatellite_;
   }
   ...
   public void writeTo(CodedOutputStream var1) {
      if ((this.bitField0_ & 1) != 0) {
         var1.writeBool(1, this.usingSatellite_);
      }
   ...
   public int getSerializedSize() {
      ...
      var1 = 0;
      if ((this.bitField0_ & 1) != 0) {
         var1 += CodedOutputStream.computeBoolSize(1, this.usingSatellite_);
      }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof LoginRequest)) {
         return super.equals(var1);
      } else {
         LoginRequest var2 = (LoginRequest)var1;
         if (this.hasUsingSatellite() != var2.hasUsingSatellite()) {
            return false;
         } else {
            return this.hasUsingSatellite() && this.getUsingSatellite() != var2.getUsingSatellite()
               ? false
   ...
   public int hashCode() {
      ...
      if (this.hasUsingSatellite()) {
         var1 = 37 * var1 + 1;
         var1 = 53 * var1 + Internal.hashBoolean(this.getUsingSatellite());
      }
   ...
   public static final class Builder extends GeneratedMessageV3.Builder<LoginRequest.Builder> implements LoginRequestOrBuilder {
      private int bitField0_;
      private boolean usingSatellite_;
      ...
      private void buildPartial0(LoginRequest var1) {
         int var2 = this.bitField0_;
         byte var3 = 0;
         if ((var2 & 1) != 0) {
            var1.usingSatellite_ = this.usingSatellite_;
            var3 |= 1;
         }

         LoginRequest var4 = var1;
      ...
      public LoginRequest.Builder mergeFrom(LoginRequest var1) {
         ...
         if (var1.hasUsingSatellite()) {
            this.setUsingSatellite(var1.getUsingSatellite());
         }
            ...
            while (!var3) {
               ...
               switch (var4) {
                  case 0:
                     ...
                     break;
                  case 8:
                     this.usingSatellite_ = var1.readBool();
                     this.bitField0_ |= 1;
                     break;
                  default:
      ...
      public LoginRequest.Builder setUsingSatellite(boolean var1) {
         this.usingSatellite_ = var1;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      }

      public LoginRequest.Builder clearUsingSatellite() {
         this.bitField0_ &= -2;
         this.usingSatellite_ = false;
         this.onChanged();
         return this;
