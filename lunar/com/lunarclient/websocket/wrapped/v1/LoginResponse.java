...
public final class LoginResponse extends GeneratedMessageV3 implements LoginResponseOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return ServiceProto.internal_static_lunarclient_websocket_wrapped_v1_LoginResponse_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return ServiceProto.internal_static_lunarclient_websocket_wrapped_v1_LoginResponse_fieldAccessorTable
   ...
   public static final class Builder extends GeneratedMessageV3.Builder<LoginResponse.Builder> implements LoginResponseOrBuilder {
      ...
      public LoginResponse.Builder setLeaderboardVisibilityValue(int var1) {
      ...
      public LoginResponse.Builder setLeaderboardVisibility(WrappedLeaderboardVisibility var1) {
         if (var1 == null) {
            throw new NullPointerException();
         }
      ...
      public LoginResponse.Builder clearLeaderboardVisibility() {
         this.bitField0_ &= -2;
         this.leaderboardVisibility_ = 0;
         this.onChanged();
         return this;
