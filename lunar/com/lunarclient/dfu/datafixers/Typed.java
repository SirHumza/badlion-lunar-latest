...
import com.lunarclient.dfu.datafixers.kinds.Const;
import com.lunarclient.dfu.datafixers.kinds.IdF;
import com.lunarclient.dfu.datafixers.kinds.Monoid;
import com.lunarclient.dfu.datafixers.optics.Forget;
import com.lunarclient.dfu.datafixers.optics.ForgetOpt;
import com.lunarclient.dfu.datafixers.optics.Optic;
import com.lunarclient.dfu.datafixers.optics.Optics;
import com.lunarclient.dfu.datafixers.optics.ReForgetC;
...
public final class Typed<A> {
   ...
   public <FT> Typed<FT> getTyped(OpticFinder<FT> var1) {
      TypedOptic var2 = var1.findType(this.type, false).orThrow();
      return (Typed<FT>)(new Typed<>(
         var2.aType(),
         this.ops,
         Forget.unbox(var2.apply(new TypeToken<Forget.Instance.Mu<FT>>() {}, new Forget.Instance(), Optics.forget(Function.identity()))).run(this.value)
      ));
   }

   public <FT> Optional<FT> getOptional(OpticFinder<FT> var1) {
      TypedOptic var2 = var1.findType(this.type, false).orThrow();
      return ForgetOpt.unbox(var2.apply(new TypeToken<ForgetOpt.Instance.Mu<FT>>() {}, new ForgetOpt.Instance(), Optics.forgetOpt(Optional::of)))
         .run(this.value);
   }

   public <FT> FT getOrCreate(OpticFinder<FT> var1) {
      return DataFixUtils.<FT>or(this.getOptional(var1), () -> var1.type().point(this.ops))
         .orElseThrow(() -> new IllegalStateException("Could not create default value for type: " + var1.type()));
   }
   ...
   public <FT> Optional<Typed<FT>> getOptionalTyped(OpticFinder<FT> var1) {
      ...
      return ForgetOpt.unbox(var2.apply(new TypeToken<ForgetOpt.Instance.Mu<FT>>() {}, new ForgetOpt.Instance(), Optics.forgetOpt(Optional::of)))
         .run(this.value)
         .map(var2x -> new Typed<>(var2.aType(), this.ops, var2x));
   }

   public <FT> Typed<FT> getOrCreateTyped(OpticFinder<FT> var1) {
      return DataFixUtils.<Typed<FT>>or(this.getOptionalTyped(var1), () -> var1.type().pointTyped(this.ops))
         .orElseThrow(() -> new IllegalStateException("Could not create default value for type: " + var1.type()));
   }
   ...
   public <FT, FR> Typed<?> set(OpticFinder<FT> var1, Typed<FR> var2) {
      TypedOptic var3 = var1.findType(this.type, var2.type, false).orThrow();
      return this.setCap(var3, var2);
   }

   private <B, FT, FR> Typed<B> setCap(TypedOptic<A, B, FT, FR> var1, Typed<FR> var2) {
      Object var3 = ReForgetC.<A, A, B>unbox(
            var1.apply(
               (TypeToken<ReForgetC.Instance.Mu<A>>)(new TypeToken<ReForgetC.Instance.Mu<FR>>() {}),
               new ReForgetC.Instance<>(),
               Optics.reForgetC("set", Either.left((Function<A, B>)Function.identity()))
            )
         )
         .run(this.value, var2.value);
      return (Typed<B>)(new Typed<>(var1.tType(), this.ops, var3));
   }
   ...
   public <FT, FR> Typed<?> updateTyped(OpticFinder<FT> var1, Type<FR> var2, Function<Typed<?>, Typed<?>> var3) {
      TypedOptic var4 = var1.<A, FR>findType(this.type, var2, false).orThrow();
      return this.updateCap(var4, var4x -> {
         Typed var5 = (Typed)var3.apply(new Typed<>(var1.type(), this.ops, var4x));
         return (FR)var4.bType().ifSame(var5).orElseThrow(() -> new IllegalArgumentException("Function didn't update to the expected type"));
      });
   }
   ...
   public <FT, FR> Typed<?> updateRecursiveTyped(OpticFinder<FT> var1, Type<FR> var2, Function<Typed<?>, Typed<?>> var3) {
      TypedOptic var4 = var1.<A, FR>findType(this.type, var2, true).orThrow();
      return this.updateCap(var4, var4x -> {
         Typed var5 = (Typed)var3.apply(new Typed<>(var1.type(), this.ops, var4x));
         return (FR)var4.bType().ifSame(var5).orElseThrow(() -> new IllegalArgumentException("Function didn't update to the expected type"));
      });
   ...
   private <B, FT, FR> Typed<B> updateCap(TypedOptic<A, B, FT, FR> var1, Function<FT, FR> var2) {
      ...
      Object var4 = IdF.get((App<IdF.Mu, A>)var3.<IdF.Mu>wander(IdF.Instance.INSTANCE, var1x -> IdF.create(var2.apply(var1x))).apply(this.value));
      return (Typed<B>)(new Typed<>(var1.tType(), this.ops, var4));
   }
   ...
   public <FT> List<Typed<FT>> getAllTyped(OpticFinder<FT> var1) {
      ...
      return this.<Object>getAll(var2).stream().map(var2x -> new Typed<>(var1.type(), this.ops, var2x)).collect(Collectors.toList());
   }
   ...
   public <FT> List<FT> getAll(TypedOptic<A, ?, FT, ?> var1) {
      ...
      return Const.unbox((App)var2.<Const.Mu<C>>wander(new Const.Instance(Monoid.listMonoid()), var0 -> Const.create(ImmutableList.of(var0))).apply(this.value));
   }
   ...
   public <B> Typed<Either<A, B>> inj1(Type<B> var1) {
      return new Typed<>(DSL.or(this.type, var1), this.ops, Optics.inj1().build(this.value));
   }

   public <B> Typed<Either<B, A>> inj2(Type<B> var1) {
      return new Typed<>(DSL.or(var1, this.type), this.ops, Optics.inj2().build(this.value));
   }

   public static <A, B> Typed<Pair<A, B>> pair(Typed<A> var0, Typed<B> var1) {
      return new Typed<>(DSL.and(var0.type, (Type<B>)var1.type), var0.ops, Pair.of(var0.value, (B)var1.value));
   }
