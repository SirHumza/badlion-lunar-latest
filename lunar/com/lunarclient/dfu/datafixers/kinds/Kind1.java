...
import com.lunarclient.dfu.datafixers.Products;
...
public interface Kind1<F extends K1, Mu extends Kind1.Mu> extends App<Mu, F> {
   ...
   default <T1, T2, T3, T4, T5, T6> Products.P6<F, T1, T2, T3, T4, T5, T6> group(
      App<F, T1> var1, App<F, T2> var2, App<F, T3> var3, App<F, T4> var4, App<F, T5> var5, App<F, T6> var6
   ) {
      return new Products.P6<>(var1, var2, var3, var4, var5, var6);
   }

   default <T1, T2, T3, T4, T5, T6, T7> Products.P7<F, T1, T2, T3, T4, T5, T6, T7> group(
      App<F, T1> var1, App<F, T2> var2, App<F, T3> var3, App<F, T4> var4, App<F, T5> var5, App<F, T6> var6, App<F, T7> var7
   ) {
   ...
   default <T1, T2, T3, T4, T5, T6, T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> group(
      App<F, T1> var1, App<F, T2> var2, App<F, T3> var3, App<F, T4> var4, App<F, T5> var5, App<F, T6> var6, App<F, T7> var7, App<F, T8> var8
   ) {
   ...
   default <T1, T2, T3, T4, T5, T6, T7, T8, T9> Products.P9<F, T1, T2, T3, T4, T5, T6, T7, T8, T9> group(
      App<F, T1> var1, App<F, T2> var2, App<F, T3> var3, App<F, T4> var4, App<F, T5> var5, App<F, T6> var6, App<F, T7> var7, App<F, T8> var8, App<F, T9> var9
   ) {
