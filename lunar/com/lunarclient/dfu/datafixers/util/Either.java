...
public abstract class Either<L, R> implements App<Either.Mu<R>, L> {
   ...
   public <T> Either<T, R> mapLeft(Function<? super L, ? extends T> var1) {
      return this.map(var1x -> (Either<T, R>)left(var1.apply(var1x)), Either::right);
   }

   public <T> Either<L, T> mapRight(Function<? super R, ? extends T> var1) {
      return this.map(Either::left, var1x -> (Either<L, T>)right(var1.apply(var1x)));
   }

   public static <L, R> Either<L, R> left(L var0) {
      return new Either.Left<>((L)var0);
   }

   public static <L, R> Either<L, R> right(R var0) {
      return new Either.Right<>((R)var0);
   }

   public L orThrow() {
      return this.map(var0 -> (L)var0, var0 -> {
   ...
   public <L2> Either<L2, R> flatMap(Function<L, Either<L2, R>> var1) {
      return this.map(var1, Either::right);
   }

   public static <U> U unwrap(Either<? extends U, ? extends U> var0) {
   ...
   public static final class Instance<R2>
      ...
      public <A> App<Either.Mu<R2>, A> point(A var1) {
         return (App<Either.Mu<R2>, A>)Either.left(var1);
      }

      @Override
      public <A, R> Function<App<Either.Mu<R2>, A>, App<Either.Mu<R2>, R>> lift1(App<Either.Mu<R2>, Function<A, R>> var1) {
         return var1x -> Either.<Function, R>unbox(var1).flatMap(var1xx -> Either.<L, R>unbox(var1x).mapLeft(var1xx));
      }
      ...
      public <A, B, R> BiFunction<App<Either.Mu<R2>, A>, App<Either.Mu<R2>, B>, App<Either.Mu<R2>, R>> lift2(App<Either.Mu<R2>, BiFunction<A, B, R>> var1) {
         return (var1x, var2) -> Either.<BiFunction, R>unbox(var1)
            .flatMap(var2x -> Either.<L, R>unbox(var1x).flatMap(var2xx -> Either.<L, R>unbox(var2).mapLeft(var2xxx -> (R)var2x.apply(var2xx, var2xxx))));
      }
      ...
      public <F extends K1, A, B> App<F, App<Either.Mu<R2>, B>> traverse(Applicative<F, ?> var1, Function<A, App<F, B>> var2, App<Either.Mu<R2>, A> var3) {
         return Either.<Object, Object>unbox(var3).map(var2x -> {
            App var3x = (App)var2.apply(var2x);
            return var1.ap(Either::left, var3x);
         }, var1x -> var1.point(Either.right(var1x)));
      }
      ...
      public static final class Mu<R2> implements Applicative.Mu, CocartesianLike.Mu, Traversable.Mu {
      }
   }
   ...
   private static final class Left<L, R> extends Either<L, R> {
      ...
      public <C, D> Either<C, D> mapBoth(Function<? super L, ? extends C> var1, Function<? super R, ? extends D> var2) {
         return (Either<C, D>)(new Either.Left<>(var1.apply(this.value)));
      }

      @Override
      public <T> T map(Function<? super L, ? extends T> var1, Function<? super R, ? extends T> var2) {
         return (T)var1.apply(this.value);
      }
   ...
   private static final class Right<L, R> extends Either<L, R> {
      ...
      @Override
      public <C, D> Either<C, D> mapBoth(Function<? super L, ? extends C> var1, Function<? super R, ? extends D> var2) {
         return (Either<C, D>)(new Either.Right<>(var2.apply(this.value)));
      }

      @Override
      public <T> T map(Function<? super L, ? extends T> var1, Function<? super R, ? extends T> var2) {
         return (T)var2.apply(this.value);
      }
