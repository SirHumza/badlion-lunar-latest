...
import com.lunarclient.dfu.datafixers.util.Function10;
import com.lunarclient.dfu.datafixers.util.Function11;
import com.lunarclient.dfu.datafixers.util.Function12;
import com.lunarclient.dfu.datafixers.util.Function13;
import com.lunarclient.dfu.datafixers.util.Function14;
import com.lunarclient.dfu.datafixers.util.Function15;
import com.lunarclient.dfu.datafixers.util.Function16;
import com.lunarclient.dfu.datafixers.util.Function3;
import com.lunarclient.dfu.datafixers.util.Function4;
import com.lunarclient.dfu.datafixers.util.Function5;
import com.lunarclient.dfu.datafixers.util.Function6;
import com.lunarclient.dfu.datafixers.util.Function7;
import com.lunarclient.dfu.datafixers.util.Function8;
import com.lunarclient.dfu.datafixers.util.Function9;
import java.util.function.BiFunction;
import java.util.function.Function;

public interface Products {
   static <T1, T2> Products.P2<IdF.Mu, T1, T2> of(T1 var0, T2 var1) {
      return new Products.P2<>(IdF.create((T1)var0), IdF.create((T2)var1));
   }
   ...
   final class P1<F extends K1, T1> {
      ...
      public <T2, T3> Products.P3<F, T1, T2, T3> and(Products.P2<F, T2, T3> var1) {
         return new Products.P3<>(this.t1, (App<F, T2>)var1.t1, (App<F, T3>)var1.t2);
      }

      public <T2, T3, T4> Products.P4<F, T1, T2, T3, T4> and(Products.P3<F, T2, T3, T4> var1) {
         return new Products.P4<>(this.t1, (App<F, T2>)var1.t1, (App<F, T3>)var1.t2, (App<F, T4>)var1.t3);
      }

      public <T2, T3, T4, T5> Products.P5<F, T1, T2, T3, T4, T5> and(Products.P4<F, T2, T3, T4, T5> var1) {
         return new Products.P5<>(this.t1, (App<F, T2>)var1.t1, (App<F, T3>)var1.t2, (App<F, T4>)var1.t3, (App<F, T5>)var1.t4);
      }

      public <T2, T3, T4, T5, T6> Products.P6<F, T1, T2, T3, T4, T5, T6> and(Products.P5<F, T2, T3, T4, T5, T6> var1) {
         return new Products.P6<>(this.t1, (App<F, T2>)var1.t1, (App<F, T3>)var1.t2, (App<F, T4>)var1.t3, (App<F, T5>)var1.t4, (App<F, T6>)var1.t5);
      }

      public <T2, T3, T4, T5, T6, T7> Products.P7<F, T1, T2, T3, T4, T5, T6, T7> and(Products.P6<F, T2, T3, T4, T5, T6, T7> var1) {
         return new Products.P7<>(
            this.t1, (App<F, T2>)var1.t1, (App<F, T3>)var1.t2, (App<F, T4>)var1.t3, (App<F, T5>)var1.t4, (App<F, T6>)var1.t5, (App<F, T7>)var1.t6
         );
      }

      public <T2, T3, T4, T5, T6, T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(Products.P7<F, T2, T3, T4, T5, T6, T7, T8> var1) {
         return new Products.P8<>(
            this.t1,
            (App<F, T2>)var1.t1,
            (App<F, T3>)var1.t2,
            (App<F, T4>)var1.t3,
   ...
   final class P14<F extends K1, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> {
      ...
      public <R> App<F, R> apply(Applicative<F, ?> var1, App<F, Function14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, R>> var2) {
         return var1.ap14(
            var2, this.t1, this.t2, this.t3, this.t4, this.t5, this.t6, this.t7, this.t8, this.t9, this.t10, this.t11, this.t12, this.t13, this.t14
         );
      }
   }
   ...
   final class P15<F extends K1, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> {
      ...
      public <R> App<F, R> apply(Applicative<F, ?> var1, App<F, Function15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, R>> var2) {
         return var1.ap15(
            var2, this.t1, this.t2, this.t3, this.t4, this.t5, this.t6, this.t7, this.t8, this.t9, this.t10, this.t11, this.t12, this.t13, this.t14, this.t15
         );
      }
   }
   ...
   final class P2<F extends K1, T1, T2> {
      ...
      public <T3, T4> Products.P4<F, T1, T2, T3, T4> and(Products.P2<F, T3, T4> var1) {
         return new Products.P4<>(this.t1, this.t2, (App<F, T3>)var1.t1, (App<F, T4>)var1.t2);
      }

      public <T3, T4, T5> Products.P5<F, T1, T2, T3, T4, T5> and(Products.P3<F, T3, T4, T5> var1) {
         return new Products.P5<>(this.t1, this.t2, (App<F, T3>)var1.t1, (App<F, T4>)var1.t2, (App<F, T5>)var1.t3);
      }

      public <T3, T4, T5, T6> Products.P6<F, T1, T2, T3, T4, T5, T6> and(Products.P4<F, T3, T4, T5, T6> var1) {
         return new Products.P6<>(this.t1, this.t2, (App<F, T3>)var1.t1, (App<F, T4>)var1.t2, (App<F, T5>)var1.t3, (App<F, T6>)var1.t4);
      }

      public <T3, T4, T5, T6, T7> Products.P7<F, T1, T2, T3, T4, T5, T6, T7> and(Products.P5<F, T3, T4, T5, T6, T7> var1) {
         return new Products.P7<>(this.t1, this.t2, (App<F, T3>)var1.t1, (App<F, T4>)var1.t2, (App<F, T5>)var1.t3, (App<F, T6>)var1.t4, (App<F, T7>)var1.t5);
      }

      public <T3, T4, T5, T6, T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(Products.P6<F, T3, T4, T5, T6, T7, T8> var1) {
         return new Products.P8<>(
            this.t1, this.t2, (App<F, T3>)var1.t1, (App<F, T4>)var1.t2, (App<F, T5>)var1.t3, (App<F, T6>)var1.t4, (App<F, T7>)var1.t5, (App<F, T8>)var1.t6
         );
      }
   ...
   final class P3<F extends K1, T1, T2, T3> {
      ...
      public <T4, T5> Products.P5<F, T1, T2, T3, T4, T5> and(Products.P2<F, T4, T5> var1) {
         return new Products.P5<>(this.t1, this.t2, this.t3, (App<F, T4>)var1.t1, (App<F, T5>)var1.t2);
      }

      public <T4, T5, T6> Products.P6<F, T1, T2, T3, T4, T5, T6> and(Products.P3<F, T4, T5, T6> var1) {
         return new Products.P6<>(this.t1, this.t2, this.t3, (App<F, T4>)var1.t1, (App<F, T5>)var1.t2, (App<F, T6>)var1.t3);
      }

      public <T4, T5, T6, T7> Products.P7<F, T1, T2, T3, T4, T5, T6, T7> and(Products.P4<F, T4, T5, T6, T7> var1) {
         return new Products.P7<>(this.t1, this.t2, this.t3, (App<F, T4>)var1.t1, (App<F, T5>)var1.t2, (App<F, T6>)var1.t3, (App<F, T7>)var1.t4);
      }

      public <T4, T5, T6, T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(Products.P5<F, T4, T5, T6, T7, T8> var1) {
         return new Products.P8<>(
            this.t1, this.t2, this.t3, (App<F, T4>)var1.t1, (App<F, T5>)var1.t2, (App<F, T6>)var1.t3, (App<F, T7>)var1.t4, (App<F, T8>)var1.t5
         );
      }
   ...
   final class P4<F extends K1, T1, T2, T3, T4> {
      ...
      public <T5, T6> Products.P6<F, T1, T2, T3, T4, T5, T6> and(Products.P2<F, T5, T6> var1) {
         return new Products.P6<>(this.t1, this.t2, this.t3, this.t4, (App<F, T5>)var1.t1, (App<F, T6>)var1.t2);
      }

      public <T5, T6, T7> Products.P7<F, T1, T2, T3, T4, T5, T6, T7> and(Products.P3<F, T5, T6, T7> var1) {
         return new Products.P7<>(this.t1, this.t2, this.t3, this.t4, (App<F, T5>)var1.t1, (App<F, T6>)var1.t2, (App<F, T7>)var1.t3);
      }

      public <T5, T6, T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(Products.P4<F, T5, T6, T7, T8> var1) {
         return new Products.P8<>(this.t1, this.t2, this.t3, this.t4, (App<F, T5>)var1.t1, (App<F, T6>)var1.t2, (App<F, T7>)var1.t3, (App<F, T8>)var1.t4);
      }
   ...
   final class P5<F extends K1, T1, T2, T3, T4, T5> {
      ...
      public <T6, T7> Products.P7<F, T1, T2, T3, T4, T5, T6, T7> and(Products.P2<F, T6, T7> var1) {
         return new Products.P7<>(this.t1, this.t2, this.t3, this.t4, this.t5, (App<F, T6>)var1.t1, (App<F, T7>)var1.t2);
      }

      public <T6, T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(Products.P3<F, T6, T7, T8> var1) {
         return new Products.P8<>(this.t1, this.t2, this.t3, this.t4, this.t5, (App<F, T6>)var1.t1, (App<F, T7>)var1.t2, (App<F, T8>)var1.t3);
      }
   ...
   final class P6<F extends K1, T1, T2, T3, T4, T5, T6> {
      ...
      public <T7, T8> Products.P8<F, T1, T2, T3, T4, T5, T6, T7, T8> and(Products.P2<F, T7, T8> var1) {
         return new Products.P8<>(this.t1, this.t2, this.t3, this.t4, this.t5, this.t6, (App<F, T7>)var1.t1, (App<F, T8>)var1.t2);
      }
