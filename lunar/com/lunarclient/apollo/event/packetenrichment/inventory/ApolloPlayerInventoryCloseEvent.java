...
public final class ApolloPlayerInventoryCloseEvent implements Event {
   private final ApolloPlayer player;
   private final long instantiationTimeMs;
   private final PlayerInfo playerInfo;

   @Generated
   public ApolloPlayerInventoryCloseEvent(ApolloPlayer var1, long var2, PlayerInfo var4) {
      this.player = var1;
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof ApolloPlayerInventoryCloseEvent)) {
         return false;
      } else {
         ApolloPlayerInventoryCloseEvent var2 = (ApolloPlayerInventoryCloseEvent)var1;
   ...
   public String toString() {
      return "ApolloPlayerInventoryCloseEvent(player="
         + this.getPlayer()
         + ", instantiationTimeMs="
