...
public final class ApolloPlayerInventoryOpenEvent implements Event {
   private final ApolloPlayer player;
   private final long instantiationTimeMs;
   private final PlayerInfo playerInfo;

   @Generated
   public ApolloPlayerInventoryOpenEvent(ApolloPlayer var1, long var2, PlayerInfo var4) {
      this.player = var1;
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof ApolloPlayerInventoryOpenEvent)) {
         return false;
      } else {
         ApolloPlayerInventoryOpenEvent var2 = (ApolloPlayerInventoryOpenEvent)var1;
   ...
   public String toString() {
      return "ApolloPlayerInventoryOpenEvent(player="
         + this.getPlayer()
         + ", instantiationTimeMs="
