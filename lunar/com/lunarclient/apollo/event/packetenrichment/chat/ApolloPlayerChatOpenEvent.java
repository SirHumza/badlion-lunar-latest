...
public final class ApolloPlayerChatOpenEvent implements Event {
   private final ApolloPlayer player;
   private final long instantiationTimeMs;
   private final PlayerInfo playerInfo;

   @Generated
   public ApolloPlayerChatOpenEvent(ApolloPlayer var1, long var2, PlayerInfo var4) {
      this.player = var1;
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof ApolloPlayerChatOpenEvent)) {
         return false;
      } else {
         ApolloPlayerChatOpenEvent var2 = (ApolloPlayerChatOpenEvent)var1;
   ...
   public String toString() {
      return "ApolloPlayerChatOpenEvent(player="
         + this.getPlayer()
         + ", instantiationTimeMs="
