...
public final class Uuid extends GeneratedMessageV3 implements UuidOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return UuidProto.internal_static_lunarclient_apollo_common_v1_Uuid_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return UuidProto.internal_static_lunarclient_apollo_common_v1_Uuid_fieldAccessorTable.ensureFieldAccessorsInitialized(Uuid.class, Uuid.Builder.class);
   }
