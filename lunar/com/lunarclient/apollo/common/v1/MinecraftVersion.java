...
public final class MinecraftVersion extends GeneratedMessageV3 implements MinecraftVersionOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return VersionProto.internal_static_lunarclient_apollo_common_v1_MinecraftVersion_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return VersionProto.internal_static_lunarclient_apollo_common_v1_MinecraftVersion_fieldAccessorTable
   ...
   public boolean equals(Object var1) {
      ...
      return !this.getEnum().equals(var2.getEnum()) ? false : this.getUnknownFields().equals(var2.getUnknownFields());
   }
