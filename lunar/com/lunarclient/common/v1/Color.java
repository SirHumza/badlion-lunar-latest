...
public final class Color extends GeneratedMessageV3 implements ColorOrBuilder {
   ...
   public static final Descriptors.Descriptor getDescriptor() {
      return ColorProto.internal_static_lunarclient_common_v1_Color_descriptor;
   }

   @Override
   protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return ColorProto.internal_static_lunarclient_common_v1_Color_fieldAccessorTable.ensureFieldAccessorsInitialized(Color.class, Color.Builder.class);
   }
