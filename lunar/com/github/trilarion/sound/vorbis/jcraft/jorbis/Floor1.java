...
class Floor1 extends FuncFloor {
   ...
   private static final float[] FLOOR_fromdB_LOOKUP = new float[]{
      1.0649863E-7F,
      1.1341951E-7F,
      1.2079015E-7F,
      1.2863978E-7F,
   ...
   Object look(DspState var1, InfoMode var2, Object var3) {
      ...
      System.arraycopy(var5, 0, var7.forward_index, 0, var4);
      int var20 = 0;

      while (var20 < var4) {
         var7.reverse_index[var7.forward_index[var20]] = var20++;
      }

      for (int var21 = 0; var21 < var4; var21++) {
         var7.sorted_index[var21] = var6.postlist[var7.forward_index[var21]];
      }
      ...
      for (int var22 = 0; var22 < var4 - 2; var22++) {
         int var23 = 0;
         int var11 = 1;
         int var12 = 0;
         int var13 = var7.n;
         int var14 = var6.postlist[var22 + 2];

         for (int var15 = 0; var15 < var22 + 2; var15++) {
         ...
         var7.loneighbor[var22] = var23;
         var7.hineighbor[var22] = var11;
      }
   ...
   Object inverse1(Block var1, Object var2, Object var3) {
      ...
      if (var1.opb.read(1) == 1) {
         ...
         for (int var18 = 2; var18 < var4.posts; var18++) {
            ...
            int var20 = var4.quant_q - var9;
            int var21 = var9;
            int var22 = (var20 < var21 ? var20 : var21) << 1;
   ...
   private static void render_line(int var0, int var1, int var2, int var3, float[] var4) {
      ...
      for (var4[var10] *= FLOOR_fromdB_LOOKUP[var11]; ++var10 < var1; var4[var10] *= FLOOR_fromdB_LOOKUP[var11]) {
         var12 += var7;
         if (var12 >= var6) {
            var12 -= var6;
            var11 += var9;
   ...
   class InfoFloor1 {
      ...
      Object copy_info() {
         ...
         var2.partitions = var1.partitions;
         System.arraycopy(var1.partitionclass, 0, var2.partitionclass, 0, 31);
         System.arraycopy(var1.class_dim, 0, var2.class_dim, 0, 16);
         System.arraycopy(var1.class_subs, 0, var2.class_subs, 0, 16);
         System.arraycopy(var1.class_book, 0, var2.class_book, 0, 16);
