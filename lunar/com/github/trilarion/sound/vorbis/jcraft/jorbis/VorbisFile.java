...
public class VorbisFile {
   ...
   public VorbisFile(String var1) {
      ...
      } catch (IOException | SoundException var11) {
         throw new SoundException("VorbisFile: " + var11.toString());
      } finally {
         if (var2 != null) {
            try {
               var2.close();
            } catch (IOException var10) {
               LOG.log(Level.FINE, var10.getMessage());
            }
         }
      }
   }
   ...
   private int get_prev_page(Page var1) {
   ...
   final int open(InputStream var1, byte[] var2, int var3) {
   ...
   public int raw_seek(int var1) {
      ...
      if (var1 >= 0 && var1 <= this.offsets[this.links]) {
         this.pcm_offset = -1L;
         this.decode_clear();
   ...
   public int pcm_seek(long var1) {
      ...
      if (var1 >= 0L && var1 <= var4) {
         ...
         if (this.pcm_offset >= var1) {
            this.pcm_offset = -1L;
            this.decode_clear();
            return -1;
         }

         if (var1 > this.pcm_total(-1)) {
            this.pcm_offset = -1L;
            this.decode_clear();
            return -1;
         }
   ...
   static class SeekableInputStream extends InputStream {
      ...
      SeekableInputStream(String var1) {
         this.raf = null;
