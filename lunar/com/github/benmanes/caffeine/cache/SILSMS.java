...
class SILSMS<K, V> extends SILS<K, V> {
   static final LocalCacheFactory FACTORY = SILSMS::new;
   long maximum;
   long weightedSize;
   long windowMaximum;
   ...
   SILSMS(Caffeine<K, V> var1, @Nullable AsyncCacheLoader<? super K, V> var2, boolean var3) {
      super(var1, var2, var3);
      if (var1.hasInitialCapacity()) {
         long var4 = Math.min(var1.getMaximum(), var1.getInitialCapacity());
