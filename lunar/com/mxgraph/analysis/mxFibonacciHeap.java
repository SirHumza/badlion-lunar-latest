...
public class mxFibonacciHeap {
   protected Map<Object, mxFibonacciHeap.Node> nodes = new Hashtable<>();
   protected mxFibonacciHeap.Node min;
   protected int size;

   public mxFibonacciHeap.Node getNode(Object var1, boolean var2) {
      mxFibonacciHeap.Node var3 = this.nodes.get(var1);
      if (var3 == null && var2) {
   ...
   public mxFibonacciHeap.Node removeMin() {
      ...
      if (var1 != null) {
         ...
         mxFibonacciHeap.Node var3 = var1.child;
   ...
   protected void consolidate() {
      ...
      while (var9 > 0) {
         int var5 = var4.degree;
         mxFibonacciHeap.Node var6 = var4.right;
      ...
      for (int var10 = 0; var10 < var1; var10++) {
         if (var2[var10] != null) {
            if (this.min != null) {
               var2[var10].left.right = var2[var10].right;
               var2[var10].right.left = var2[var10].left;
               var2[var10].left = this.min;
               var2[var10].right = this.min.right;
               this.min.right = var2[var10];
               var2[var10].right.left = var2[var10];
               if (var2[var10].key < this.min.key) {
                  this.min = var2[var10];
               }
            } else {
               this.min = var2[var10];
