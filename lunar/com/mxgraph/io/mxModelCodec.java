...
public class mxModelCodec extends mxObjectCodec {
   ...
   public mxModelCodec(Object var1, String[] var2, String[] var3, Map<String, String> var4) {
   ...
   protected void encodeObject(mxCodec var1, Object var2, Node var3) {
      if (var2 instanceof mxGraphModel) {
         Element var4 = var1.document.createElement("root");
         mxGraphModel var5 = (mxGraphModel)var2;
         var1.encodeCell((mxICell)var5.getRoot(), var4, true);
