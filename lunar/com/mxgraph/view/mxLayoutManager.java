...
public class mxLayoutManager extends mxEventSource {
   ...
   protected mxEventSource.mxIEventListener moveHandler = new mxEventSource.mxIEventListener() {
      ...
      public void invoke(Object var1, mxEventObject var2) {
         if (mxLayoutManager.this.isEnabled()) {
            mxLayoutManager.this.cellsMoved((Object[])var2.getProperty("cells"), (Point)var2.getProperty("location"));
         }
      }
   };
   ...
   public void setGraph(mxGraph var1) {
      ...
      if (this.graph != null) {
         ...
         var3.addListener("beforeUndo", this.undoHandler);
   ...
   protected void cellsMoved(Object[] var1, Point var2) {
      if (var1 != null && var2 != null) {
         ...
         for (int var4 = 0; var4 < var1.length; var4++) {
            ...
            if (var5 != null) {
               var5.moveCell(var1[var4], var2.x, var2.y);
            }
         }
      }
   }
   ...
   protected Collection<Object> getCellsForChanges(List<mxUndoableEdit.mxUndoableChange> var1) {
      HashSet var2 = new HashSet();

      for (mxUndoableEdit.mxUndoableChange var4 : var1) {
   ...
   protected Collection<Object> getCellsForChange(mxUndoableEdit.mxUndoableChange var1) {
      ...
      if (var1 instanceof mxGraphModel.mxChildChange) {
         ...
         Object var5 = var2.getParent(var4.getChild());
         ...
         Object var6 = var1 instanceof mxGraphModel.mxTerminalChange
            ? ((mxGraphModel.mxTerminalChange)var1).getCell()
            : ((mxGraphModel.mxGeometryChange)var1).getCell();
         if (var6 != null) {
            var3.add(var6);
            Object var7 = var2.getParent(var6);
            if (var7 != null) {
               var3.add(var7);
            }
         }
   ...
   protected void layoutCells(Object[] var1) {
      if (var1.length > 0) {
         ...
         try {
            ...
            this.fireEvent(new mxEventObject(mxEvent.LAYOUT_CELLS, "cells", var1));
         } finally {
            var2.endUpdate();
         }
      }
