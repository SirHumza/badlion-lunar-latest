...
public class mxGraphSelectionModel extends mxEventSource {
   ...
   public void removeCells(Object[] var1) {
      if (var1 != null) {
         ...
         this.changeSelection(null, var2);
      }
   }

   protected void changeSelection(Collection<Object> var1, Collection<Object> var2) {
      if (var1 != null && !var1.isEmpty() || var2 != null && !var2.isEmpty()) {
         ...
         var4.add(var3);
         this.fireEvent(new mxEventObject("undo", "edit", var4));
      }
   }
   ...
   public static class mxSelectionChange implements mxUndoableEdit.mxUndoableChange {
      ...
      public mxSelectionChange(mxGraphSelectionModel var1, Collection<Object> var2, Collection<Object> var3) {
         this.model = var1;
      ...
      public void execute() {
         ...
         if (this.added != null) {
            Iterator var2 = this.added.iterator();

            while (var2.hasNext()) {
               this.model.cellAdded(var2.next());
            }
         }

         Collection var3 = this.added;
