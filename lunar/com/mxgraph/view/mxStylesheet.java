...
public class mxStylesheet {
   ...
   public void setStyles(Map<String, Map<String, Object>> var1) {
      this.styles = var1;
   }
   ...
   public void setDefaultVertexStyle(Map<String, Object> var1) {
   ...
   public void setDefaultEdgeStyle(Map<String, Object> var1) {
      this.putCellStyle("defaultEdge", var1);
   }

   public void putCellStyle(String var1, Map<String, Object> var2) {
      this.styles.put(var1, var2);
   }

   public Map<String, Object> getCellStyle(String var1, Map<String, Object> var2) {
      Map var3 = var2;
      if (var1 != null && var1.length() > 0) {
         String[] var4 = var1.split(";");
         if (var3 != null && !var1.startsWith(";")) {
            var3 = new Hashtable(var3);
         } else {
            var3 = new Hashtable();
         }
         ...
         for (int var5 = 0; var5 < var4.length; var5++) {
            ...
            if (var7 >= 0) {
               ...
               Map var10 = this.styles.get(var6);
               if (var10 != null) {
                  var3.putAll(var10);
               }
            }
