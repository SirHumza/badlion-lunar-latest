...
public abstract class mxGraphViewReader extends DefaultHandler {
   ...
   public void parseElement(String var1, Map<String, Object> var2) {
      if (this.canvas == null && var1.equalsIgnoreCase("graph")) {
         ...
         if (var3 && var2.containsKey("points")
            || (var5 || var4) && var2.containsKey("x") && var2.containsKey("y") && var2.containsKey("width") && var2.containsKey("height")) {
            mxCellState var6 = new mxCellState(null, null, var2);
   ...
   public static List<mxPoint> parsePoints(String var0) {
