...
public class mxCurveShape extends mxConnectorShape {
   ...
   public mxCurveShape(mxCurve var1) {
      this.curve = var1;
   }
   ...
   public void validateCurve(List<mxPoint> var1, double var2, Map<String, Object> var4) {
      if (this.curve == null) {
   ...
   protected mxLine getMarkerVector(List<mxPoint> var1, boolean var2, double var3) {
      ...
      if (var2) {
         mxLine var11 = this.curve.getCurveParallel(mxCurve.CORE_CURVE, var7);
         return new mxLine(var11.getX(), var11.getY(), (mxPoint)var1.get(0));
      } else {
         mxLine var9 = this.curve.getCurveParallel(mxCurve.CORE_CURVE, 1.0 - var7);
         int var10 = var1.size();
         return new mxLine(var9.getX(), var9.getY(), (mxPoint)var1.get(var10 - 1));
      }
   }
}
