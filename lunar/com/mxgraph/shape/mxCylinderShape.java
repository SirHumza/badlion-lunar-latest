...
public class mxCylinderShape extends mxBasicShape {
   ...
   public void paintShape(mxGraphics2DCanvas var1, mxCellState var2) {
      ...
      if (this.configureGraphics(var1, var2, true)) {
         Area var11 = new Area(new Rectangle(var4, var5 + var8 / 2, var10, var7 - var8));
         var11.add(new Area(new Rectangle(var4, var5 + var8 / 2, var10, var7 - var8)));
         var11.add(new Area(new Float(var4, var5, var10, var8)));
         var11.add(new Area(new Float(var4, var5 + var7 - var8, var10, var8)));
         var1.fillShape(var11, this.hasShadow(var1, var2));
      }

      if (this.configureGraphics(var1, var2, false)) {
         var1.getGraphics().drawOval(var4, var5, var10, var8);
         ...
         var1.getGraphics().drawArc(var4, var5 + var7 - var8, var10, var8, 0, -180);
      }
   }
}
