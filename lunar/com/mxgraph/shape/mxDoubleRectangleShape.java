...
public class mxDoubleRectangleShape extends mxRectangleShape {
   ...
   public void paintShape(mxGraphics2DCanvas var1, mxCellState var2) {
      ...
      int var3 = (int)Math.round((mxUtils.getFloat(var2.getStyle(), mxConstants.STYLE_STROKEWIDTH, 1.0F) + 3.0F) * var1.getScale());
      ...
      var1.getGraphics().drawRect(var5, var6, var7, var8);
   }
}
