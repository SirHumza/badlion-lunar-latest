...
public class mxPartitionLayout extends mxGraphLayout {
   ...
   public void moveCell(Object var1, double var2, double var4) {
      ...
      if (var1 instanceof mxICell && var7 instanceof mxICell) {
         ...
         for (var8 = 0; var8 < var11; var8++) {
            Object var12 = var6.getChildAt(var7, var8);
         ...
         var17 = Math.max(0, var8 - (var8 > var17 ? 1 : 0));
   ...
   public void execute(Object var1) {
      ...
      if (var3 != null) {
         ...
         int var25 = var5.size();
         if (var25 > 0) {
            double var26 = this.border;
            double var9 = this.border;
            ...
            var26 += var13.getWidth();
            var9 += var13.getHeight();
            double var14 = this.border + (var25 - 1) * this.spacing;
            double var16 = this.horizontal ? (var3.getWidth() - var26 - var14) / var25 : (var3.getHeight() - var9 - var14) / var25;
            if (var16 > 0.0) {
               var2.beginUpdate();
