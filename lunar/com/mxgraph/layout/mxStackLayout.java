...
public class mxStackLayout extends mxGraphLayout {
   ...
   public void moveCell(Object var1, double var2, double var4) {
      ...
      if (var1 instanceof mxICell && var7 instanceof mxICell) {
         ...
         for (var9 = 0; var9 < var12; var9++) {
            Object var16 = var6.getChildAt(var7, var9);
            if (var16 != var1) {
         ...
         var21 = Math.max(0, var9 - (var9 > var21 ? 1 : 0));
   ...
   public void execute(Object var1) {
      if (var1 != null) {
         ...
         double var23 = 0.0;
         if (var4 != null) {
            var23 = var2 ? var4.getHeight() : var4.getWidth();
         }

         var23 -= 2 * this.spacing + 2 * this.border;
         mxRectangle var7 = this.graph.getStartSize(var1);
         var23 -= var2 ? var7.getHeight() : var7.getWidth();
         double var8 = this.x0 + var7.getWidth() + this.border;
         double var10 = this.y0 + var7.getHeight() + this.border;
         var3.beginUpdate();
         ...
         try {
               ...
               if (!this.isVertexIgnored(var17) && this.isVertexMovable(var17)) {
                  ...
                  if (var18 != null) {
                     ...
                     if (this.wrap != 0
                        && var14 != null
                        && (
                           var2 && var14.getX() + var14.getWidth() + var18.getWidth() + 2 * this.spacing > this.wrap
                              || !var2 && var14.getY() + var14.getHeight() + var18.getHeight() + 2 * this.spacing > this.wrap
                        )) {
                        var14 = null;
                        if (var2) {
                           var10 += var12 + this.spacing;
                        } else {
                           var8 += var12 + this.spacing;
                        }
                     ...
                     if (var14 != null) {
                        if (var2) {
                           var18.setX(var14.getX() + var14.getWidth() + this.spacing);
                        } else {
                           var18.setY(var14.getY() + var14.getHeight() + this.spacing);
                        }
                     } else if (var2) {
                        var18.setX(var8);
                     } else {
                     ...
                     if (this.fill && var23 > 0.0) {
                        if (var2) {
                           var18.setHeight(var23);
                        } else {
                           var18.setWidth(var23);
                        }
                     }
            ...
            if (this.resizeParent && var4 != null && var14 != null && !this.graph.isCellCollapsed(var1)) {
               ...
               if (var2) {
                  var4.setWidth(var14.getX() + var14.getWidth() + this.spacing);
               } else {
                  var4.setHeight(var14.getY() + var14.getHeight() + this.spacing);
               }
