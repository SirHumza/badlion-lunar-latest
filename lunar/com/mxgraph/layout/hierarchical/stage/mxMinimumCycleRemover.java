...
public class mxMinimumCycleRemover implements mxHierarchicalLayoutStage {
   ...
   public void execute(Object var1) {
      ...
      final HashSet var4 = new HashSet<>(var2.getVertexMapper().values());
      ...
      if (var2.roots != null) {
         ...
         for (int var7 = 0; var7 < var6.length; var7++) {
            ...
            mxGraphHierarchyNode var9 = var2.getVertexMapper().get(var8);
            var5[var7] = var9;
         }
      }
      ...
      var2.visit(new mxGraphHierarchyModel.CellVisitor() {
         @Override
         public void visit(mxGraphHierarchyNode var1, mxGraphHierarchyNode var2x, mxGraphHierarchyEdge var3x, int var4x, int var5x) {
            if (var2x.isAncestor(var1)) {
               var3x.invert();
               var1.connectsAsSource.remove(var3x);
               var1.connectsAsTarget.add(var3x);
               var2x.connectsAsTarget.remove(var3x);
               var2x.connectsAsSource.add(var3x);
            }
