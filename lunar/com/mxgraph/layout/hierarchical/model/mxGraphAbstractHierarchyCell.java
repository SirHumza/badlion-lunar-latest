...
public abstract class mxGraphAbstractHierarchyCell {
   ...
   public abstract List<mxGraphAbstractHierarchyCell> getNextLayerConnectedCells(int var1);

   public abstract List<mxGraphAbstractHierarchyCell> getPreviousLayerConnectedCells(int var1);
