...
public class mxHtmlCanvas extends mxBasicCanvas {
   ...
   public Object drawCell(mxCellState var1) {
      ...
      if (var1.getAbsolutePointCount() > 1) {
         ...
         var3 = mxUtils.translatePoints(var3, this.translate.getX(), this.translate.getY());
         this.drawLine(var3, var2);
      } else {
         int var10 = (int)(var1.getX() + this.translate.getX());
         int var4 = (int)(var1.getY() + this.translate.getY());
         int var5 = (int)var1.getWidth();
         int var6 = (int)var1.getHeight();
         if (!mxUtils.getString(var2, mxConstants.STYLE_SHAPE, "").equals("swimlane")) {
            this.drawShape(var10, var4, var5, var6, var2);
         } else {
            int var7 = (int)Math.round(mxUtils.getInt(var2, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_STARTSIZE) * this.scale);
            ...
            if (mxUtils.isTrue(var2, mxConstants.STYLE_HORIZONTAL, true)) {
               this.drawShape(var10, var4, var5, var7, var2);
               this.drawShape(var10, var4 + var7, var5, var6 - var7, var8);
            } else {
               this.drawShape(var10, var4, var7, var6, var2);
               this.drawShape(var10 + var7, var4, var5 - var7, var6, var8);
            }
         }
      }
   ...
   public Object drawLabel(String var1, mxCellState var2, boolean var3) {
      ...
      if (this.drawLabels && var4 != null) {
         int var5 = (int)(var4.getX() + this.translate.getY());
   ...
   public Element drawShape(int var1, int var2, int var3, int var4, Map<String, Object> var5) {
      ...
      if (var9.equals("line")) {
         String var11 = mxUtils.getString(var5, mxConstants.STYLE_DIRECTION, "east");
         if (!var11.equals("east") && !var11.equals("west")) {
            var1 = Math.round(var2 + var3 / 2);
            var3 = 1;
         } else {
            var2 = Math.round(var2 + var4 / 2);
            var4 = 1;
         }
      }
      ...
      if (mxUtils.isTrue(var5, mxConstants.STYLE_SHADOW, false) && var6 != null) {
         ...
         String var12 = "overflow:hidden;position:absolute;left:"
            + String.valueOf(var1 + mxConstants.SHADOW_OFFSETX)
            + "px;top:"
            + (var2 + mxConstants.SHADOW_OFFSETY)
            + "px;width:"
            + var3
            + "px;height:"
            + var4
      ...
      if (var9.equals("image")) {
         String var14 = this.getImageForStyle(var5);
         if (var14 != null) {
            var10 = this.document.createElement("img");
            var10.setAttribute("border", "0");
            var10.setAttribute("src", var14);
         }
      }

      String var15 = "overflow:hidden;position:absolute;left:"
         + String.valueOf(var1)
         + "px;top:"
         + var2
         + "px;width:"
         ...
         + Math.round(var8)
         + ";";
      var10.setAttribute("style", var15);
      this.appendHtmlElement(var10);
      return var10;
   }

   public void drawLine(List<mxPoint> var1, Map<String, Object> var2) {
      String var3 = mxUtils.getString(var2, mxConstants.STYLE_STROKECOLOR);
      int var4 = (int)(mxUtils.getInt(var2, mxConstants.STYLE_STROKEWIDTH, 1) * this.scale);
      if (var3 != null && var4 > 0) {
   ...
   protected void drawSegment(int var1, int var2, int var3, int var4, String var5, int var6) {
      ...
      var2 = var8;
      if (var9 != 0 && var10 != 0) {
         int var15 = var1 + (var3 - var1) / 2;
         this.drawSegment(var1, var2, var15, var2, var5, var6);
         this.drawSegment(var15, var2, var15, var4, var5, var6);
         this.drawSegment(var15, var4, var3, var4, var5, var6);
      } else {
         String var11 = "overflow:hidden;position:absolute;left:"
            + String.valueOf(var1)
            + "px;top:"
            + var2
            + "px;width:"
