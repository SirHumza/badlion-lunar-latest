...
public class mxCellRenderer {
   ...
   public static mxICanvas drawCells(mxGraph var0, Object[] var1, double var2, mxRectangle var4, mxCellRenderer.CanvasFactory var5) {
      mxICanvas var6 = null;
      if (var1 == null) {
      ...
      try {
         ...
         if (var4 != null && var4.getWidth() > 0.0 && var4.getHeight() > 0.0) {
            ...
            if (var6 != null) {
               ...
               mxPoint var13 = var6.getTranslate();
               ...
               try {
                  ...
                  var6.setScale(var11);
                  var6.setTranslate(var13.getX(), var13.getY());
               }
            }
         }
      } finally {
   ...
   public static BufferedImage createBufferedImage(
      mxGraph var0, Object[] var1, double var2, final Color var4, final boolean var5, mxRectangle var6, final mxGraphics2DCanvas var7
   ) {
      mxImageCanvas var8 = (mxImageCanvas)drawCells(var0, var1, var2, var6, new mxCellRenderer.CanvasFactory() {
         @Override
         public mxICanvas createCanvas(int var1, int var2x) {
            return new mxImageCanvas(var7, var1, var2x, var4, var5);
         }
      });
   ...
   public static Document createHtmlDocument(mxGraph var0, Object[] var1, double var2, Color var4, mxRectangle var5) {
      mxHtmlCanvas var6 = (mxHtmlCanvas)drawCells(var0, var1, var2, var5, new mxCellRenderer.CanvasFactory() {
         @Override
         public mxICanvas createCanvas(int var1, int var2x) {
            return new mxHtmlCanvas(mxDomUtils.createHtmlDocument());
         }
      });
      return var6 != null ? var6.getDocument() : null;
   }

   public static Document createSvgDocument(mxGraph var0, Object[] var1, double var2, Color var4, mxRectangle var5) {
      mxSvgCanvas var6 = (mxSvgCanvas)drawCells(var0, var1, var2, var5, new mxCellRenderer.CanvasFactory() {
         @Override
         public mxICanvas createCanvas(int var1, int var2x) {
            return new mxSvgCanvas(mxDomUtils.createSvgDocument(var1, var2x));
         }
      });
      return var6 != null ? var6.getDocument() : null;
   }
   ...
   public static Document createVmlDocument(mxGraph var0, Object[] var1, double var2, Color var4, mxRectangle var5) {
      mxVmlCanvas var6 = (mxVmlCanvas)drawCells(var0, var1, var2, var5, new mxCellRenderer.CanvasFactory() {
         @Override
         public mxICanvas createCanvas(int var1, int var2x) {
