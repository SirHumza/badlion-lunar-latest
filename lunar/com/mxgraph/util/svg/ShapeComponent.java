...
public class ExtendedGeneralPath implements Shape, Cloneable {
   ...
   public synchronized void arcTo(float var1, float var2, float var3, boolean var4, boolean var5, float var6, float var7) {
      if (var1 != 0.0F && var2 != 0.0F) {
         this.checkMoveTo();
         double var8 = this.cx;
         double var10 = this.cy;
         if (var8 != var6 || var10 != var7) {
            Arc2D var12 = computeArc(var8, var10, var1, var2, var3, var4, var5, var6, var7);
            if (var12 != null) {
               AffineTransform var13 = AffineTransform.getRotateInstance(Math.toRadians(var3), var12.getCenterX(), var12.getCenterY());
   ...
   public static Arc2D computeArc(double var0, double var2, double var4, double var6, double var8, boolean var10, boolean var11, double var12, double var14) {
      ...
      double var68 = Math.toDegrees(var38 * Math.acos(var64 / var66));
      var66 = Math.sqrt((var56 * var56 + var58 * var58) * (var60 * var60 + var62 * var62));
      var64 = var56 * var60 + var58 * var62;
   ...
   public synchronized Point2D getCurrentPoint() {
      return this.numVals == 0 ? null : new java.awt.geom.Point2D.Double(this.cx, this.cy);
   }
   ...
   public ExtendedPathIterator getExtendedPathIterator() {
      return new ExtendedGeneralPath.EPI();
   }
   ...
   public Object clone() {
      try {
         ...
         log.log(Level.SEVERE, "Failed to clone the path", var2);
         return null;
      }
   }
      ...
      public int currentSegment(double[] var1) {
         ...
         switch (var2) {
            ...
            case 2:
               var1[0] = ExtendedGeneralPath.this.values[this.valsIdx];
               var1[1] = ExtendedGeneralPath.this.values[this.valsIdx + 1];
               var1[2] = ExtendedGeneralPath.this.values[this.valsIdx + 2];
               var1[3] = ExtendedGeneralPath.this.values[this.valsIdx + 3];
               break;
            case 3:
               var1[0] = ExtendedGeneralPath.this.values[this.valsIdx];
               var1[1] = ExtendedGeneralPath.this.values[this.valsIdx + 1];
               var1[2] = ExtendedGeneralPath.this.values[this.valsIdx + 2];
               var1[3] = ExtendedGeneralPath.this.values[this.valsIdx + 3];
               var1[4] = ExtendedGeneralPath.this.values[this.valsIdx + 4];
               var1[5] = ExtendedGeneralPath.this.values[this.valsIdx + 5];
            case 4:
            default:
               break;
            case 4321:
               ...
               var1[4] = ExtendedGeneralPath.this.values[this.valsIdx + 4];
               var1[5] = ExtendedGeneralPath.this.values[this.valsIdx + 5];
               var1[6] = ExtendedGeneralPath.this.values[this.valsIdx + 6];
         }
