...
public class mxCellStatePreview {
   ...
   public mxPoint moveState(mxCellState var1, double var2, double var4, boolean var6, boolean var7) {
      mxPoint var8 = this.deltas.get(var1);
      if (var8 == null) {
   ...
   public mxRectangle show() {
      ...
      if (this.isCloned()) {
         ...
         for (mxCellState var5 : this.deltas.keySet()) {
            var3.addAll(this.snapshot(var5));
         }
      }

      for (mxCellState var13 : this.deltas.keySet()) {
         mxPoint var6 = this.deltas.get(var13);
         mxCellState var7 = var1.getView().getState(var2.getParent(var13.getCell()));
         this.translateState(var7, var13, var6.getX(), var6.getY());
      }

      mxRectangle var14 = null;

      for (mxCellState var15 : this.deltas.keySet()) {
         mxPoint var17 = this.deltas.get(var15);
         mxCellState var8 = var1.getView().getState(var2.getParent(var15.getCell()));
         mxRectangle var9 = this.revalidateState(var8, var15, var17.getX(), var17.getY());
         if (var14 != null) {
            var14.add(var9);
         } else {
            var14 = var9;
      ...
      if (var3 != null) {
         ...
         for (mxCellState var16 : this.deltas.keySet()) {
            this.cellStates.addAll(this.snapshot(var16));
         }
   ...
   public void restore(List<mxCellState> var1) {
      mxGraph var2 = this.graphComponent.getGraph();

      for (mxCellState var4 : var1) {
   ...
   public List<mxCellState> snapshot(mxCellState var1) {
   ...
   protected void translateState(mxCellState var1, mxCellState var2, double var3, double var5) {
      if (var2 != null) {
         ...
         if (var8.isVertex(var9)) {
            var2.getView().updateCellState(var2);
            mxGeometry var10 = var7.getCellGeometry(var9);
            if ((var3 != 0.0 || var5 != 0.0) && var10 != null && (!var10.isRelative() || this.deltas.get(var2) != null)) {
   ...
   protected mxRectangle revalidateState(mxCellState var1, mxCellState var2, double var3, double var5) {
      ...
      if (var2 != null) {
         ...
         if (var9.isEdge(var10)) {
            var2.getView().updateCellState(var2);
         }

         var7 = var2.getView().getBoundingBox(var2, false);
         mxGeometry var11 = var8.getCellGeometry(var10);
         if ((var3 != 0.0 || var5 != 0.0)
            && var11 != null
            && var11.isRelative()
            && var9.isVertex(var10)
            && (var1 == null || var9.isVertex(var1.getCell()) || this.deltas.get(var2) != null)) {
            var2.setX(var2.getX() + var3);
            var2.setY(var2.getY() + var5);
            var7.setX(var7.getX() + var3);
            var7.setY(var7.getY() + var5);
   ...
   public void paint(Graphics var1) {
      if (this.cellStates != null && this.cellStates.size() > 0) {
         ...
         mxPoint var4 = var2.getTranslate();
         ...
         try {
            ...
            var2.setScale(var5);
            var2.setTranslate(var4.getX(), var4.getY());
   ...
   protected void paintPreview(mxGraphics2DCanvas var1) {
      ...
      for (mxCellState var4 : this.cellStates) {
   ...
   protected void paintPreviewState(mxGraphics2DCanvas var1, mxCellState var2) {
      this.graphComponent.getGraph().drawState(var1, var2, var2.getCell() != this.graphComponent.getCellEditor().getEditingCell());
   }
}
