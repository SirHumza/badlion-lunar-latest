...
public class mxVertexHandler extends mxCellHandler {
   public static Cursor[] CURSORS = new Cursor[]{
      new Cursor(6), new Cursor(8), new Cursor(7), new Cursor(10), new Cursor(11), new Cursor(4), new Cursor(9), new Cursor(5), new Cursor(13)
   };
   ...
   protected Rectangle[] createHandles() {
      ...
      if (this.graphComponent.getGraph().isCellResizable(this.getState().getCell())) {
         ...
         ((Object[])var1)[0] = new Rectangle(var4, var5, var10, var10);
         ((Object[])var1)[1] = new Rectangle(var6, var5, var10, var10);
         ((Object[])var1)[2] = new Rectangle(var8, var5, var10, var10);
         ((Object[])var1)[3] = new Rectangle(var4, var7, var10, var10);
         ((Object[])var1)[4] = new Rectangle(var8, var7, var10, var10);
         ((Object[])var1)[5] = new Rectangle(var4, var9, var10, var10);
         ((Object[])var1)[6] = new Rectangle(var6, var9, var10, var10);
         ((Object[])var1)[7] = new Rectangle(var8, var9, var10, var10);
      } else {
         var1 = new Rectangle[1];
      }

      int var12 = mxConstants.LABEL_HANDLE_SIZE;
      mxRectangle var13 = this.state.getLabelBounds();
      ((Object[])var1)[((Object[])var1).length - 1] = new Rectangle(
         (int)(var13.getX() + var13.getWidth() / 2.0 - var12), (int)(var13.getY() + var13.getHeight() / 2.0 - var12), 2 * var12, 2 * var12
      );
      return var1;
   }
   ...
   public void mouseDragged(MouseEvent var1) {
      if (!var1.isConsumed() && this.first != null) {
         ...
         double var2 = var1.getX() - this.first.x;
         ...
         if (this.isLabel(this.index)) {
            ...
            int var7 = (int)Math.round(var6.getX() - this.first.x);
            int var8 = (int)Math.round(var6.getY() - this.first.y);
   ...
   protected void moveLabel(MouseEvent var1) {
      ...
      if (var3 != null) {
         ...
         double var7 = (var6.getX() - this.first.x) / var4;
         double var9 = (var6.getY() - this.first.y) / var4;
         if (this.constrainedEvent) {
         ...
         var3.setOffset(new mxPoint(Math.round(var7), Math.round(var9)));
   ...
   protected void resizeCell(MouseEvent var1) {
      ...
      if (var6 != null) {
         double var7 = (var1.getX() - this.first.x) / var3;
         double var9 = (var1.getY() - this.first.y) / var3;
         if (this.isLabel(this.index)) {
            ...
            if (this.gridEnabledEvent) {
               int var13 = (int)var2.snap(var12.x);
               int var14 = (int)var2.snap(var12.y);
               var12.width = (int)var2.snap(var12.width - var13 + var12.x);
               var12.height = (int)var2.snap(var12.height - var14 + var12.y);
               var12.x = var13;
               var12.y = var14;
            }
