...
public class mxCellMarker extends JComponent {
   ...
   public mxCellMarker(mxGraphComponent var1) {
      this(var1, mxSwingConstants.DEFAULT_VALID_COLOR);
   }

   public mxCellMarker(mxGraphComponent var1, Color var2) {
      this(var1, var2, mxSwingConstants.DEFAULT_INVALID_COLOR);
   }
   ...
   public mxCellState process(MouseEvent var1) {
      ...
      if (this.isEnabled()) {
         ...
         this.highlight(var2, var4, var3);
      }

      return var2;
   }

   public void highlight(mxCellState var1, Color var2) {
      this.highlight(var1, var2, true);
   }

   public void highlight(mxCellState var1, Color var2, boolean var3) {
      if (var3) {
         this.validState = var1;
      } else {
         this.validState = null;
      }

      if (var1 != this.markedState || var2 != this.currentColor) {
         this.currentColor = var2;
         if (var1 != null && this.currentColor != null) {
            this.markedState = var1;
            this.mark();
   ...
   protected boolean intersects(mxCellState var1, MouseEvent var2) {
      return this.isHotspotEnabled()
         ? mxUtils.intersectsHotspot(var1, var2.getX(), var2.getY(), this.hotspot, mxConstants.MIN_HOTSPOT_SIZE, mxConstants.MAX_HOTSPOT_SIZE)
         : true;
   }
