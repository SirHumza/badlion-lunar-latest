...
public class mxInsertHandler extends mxMouseAdapter {
   ...
   public mxInsertHandler(mxGraphComponent var1, String var2) {
      ...
      var1.addListener("afterPaint", new mxEventSource.mxIEventListener() {
         @Override
         public void invoke(Object var1, mxEventObject var2x) {
            Graphics var3 = (Graphics)var2x.getProperty("g");
   ...
   public void mouseDragged(MouseEvent var1) {
      if (this.graphComponent.isEnabled() && this.isEnabled() && !var1.isConsumed() && this.first != null) {
         ...
         this.current.add(new mxRectangle(var1.getX(), var1.getY(), 0.0, 0.0));
         if (var2 != null) {
         ...
         int var4 = (int)Math.ceil(this.lineWidth);
   ...
   public void mouseReleased(MouseEvent var1) {
      if (this.graphComponent.isEnabled() && this.isEnabled() && !var1.isConsumed() && this.current != null) {
         ...
         this.eventSource.fireEvent(new mxEventObject("insert", "cell", var6));
         var1.consume();
      }
   ...
   public Object insertCell(mxRectangle var1) {
      return this.graphComponent.getGraph().insertVertex(null, null, "", var1.getX(), var1.getY(), var1.getWidth(), var1.getHeight(), this.style);
   }
   ...
   public void reset() {
      ...
      this.first = null;
      if (var1 != null) {
         int var2 = (int)Math.ceil(this.lineWidth);
