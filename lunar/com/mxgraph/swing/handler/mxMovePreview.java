...
public class mxMovePreview extends mxEventSource {
   ...
   protected mxCellState[] getPreviewStates() {
      ...
      for (Object var6 : this.movingCells) {
      ...
      return var2.toArray(new mxCellState[var2.size()]);
   }
   ...
   public void start(MouseEvent var1, mxCellState var2) {
      ...
      this.fireEvent(new mxEventObject(mxEvent.START, "event", var1, "state", this.startState));
   }
   ...
   public void update(MouseEvent var1, double var2, double var4, boolean var6) {
      ...
      if (this.placeholder != null) {
         ...
         for (mxCellState var11 : this.previewStates) {
      ...
      this.fireEvent(new mxEventObject(mxEvent.CONTINUE, "event", var1, "dx", var2, "dy", var4));
   }
   ...
   public Object[] stop(boolean var1, MouseEvent var2, double var3, double var5, boolean var7, Object var8) {
      ...
      try {
         ...
         this.fireEvent(new mxEventObject(mxEvent.STOP, "event", var2, "commit", var1));
      } finally {
   ...
   public void paint(Graphics var1) {
      if (this.placeholder != null) {
         mxSwingConstants.PREVIEW_BORDER
            .paintBorder(this.graphComponent, var1, this.placeholder.x, this.placeholder.y, this.placeholder.width, this.placeholder.height);
      }
