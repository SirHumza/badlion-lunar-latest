...
public class mxCellOverlay extends JComponent implements mxICellOverlay {
   ...
   public void setAlign(Object var1) {
      this.align = var1;
   }
   ...
   public void setVerticalAlign(Object var1) {
      this.verticalAlign = var1;
   }
   ...
   public mxRectangle getBounds(mxCellState var1) {
      ...
      return new mxRectangle(var5.getX() - var6 * this.defaultOverlap * var3, var5.getY() - var7 * this.defaultOverlap * var3, var6 * var3, var7 * var3);
   }
}
