...
public class mxGraphActions {
   static final Action deleteAction = new mxGraphActions.DeleteAction("delete");
   static final Action editAction = new mxGraphActions.EditAction("edit");
   static final Action groupAction = new mxGraphActions.GroupAction("group");
   static final Action ungroupAction = new mxGraphActions.UngroupAction("ungroup");
   static final Action removeFromParentAction = new mxGraphActions.RemoveFromParentAction("removeFromParent");
   static final Action updateGroupBoundsAction = new mxGraphActions.UpdateGroupBoundsAction("updateGroupBounds");
   static final Action selectAllAction = new mxGraphActions.SelectAction("selectAll");
   static final Action selectVerticesAction = new mxGraphActions.SelectAction("vertices");
   static final Action selectEdgesAction = new mxGraphActions.SelectAction("edges");
   static final Action selectNoneAction = new mxGraphActions.SelectAction("selectNone");
   static final Action selectNextAction = new mxGraphActions.SelectAction("selectNext");
   static final Action selectPreviousAction = new mxGraphActions.SelectAction("selectPrevious");
   static final Action selectParentAction = new mxGraphActions.SelectAction("selectParent");
   static final Action selectChildAction = new mxGraphActions.SelectAction("selectChild");
   static final Action collapseAction = new mxGraphActions.FoldAction("collapse");
   static final Action expandAction = new mxGraphActions.FoldAction("expand");
   static final Action enterGroupAction = new mxGraphActions.DrillAction("enterGroup");
   static final Action exitGroupAction = new mxGraphActions.DrillAction("exitGroup");
   static final Action homeAction = new mxGraphActions.DrillAction("home");
   static final Action zoomActualAction = new mxGraphActions.ZoomAction("actual");
   static final Action zoomInAction = new mxGraphActions.ZoomAction("zoomIn");
   static final Action zoomOutAction = new mxGraphActions.ZoomAction("zoomOut");
   static final Action toBackAction = new mxGraphActions.LayerAction("toBack");
   static final Action toFrontAction = new mxGraphActions.LayerAction("toFront");
   ...
   public static class GroupAction extends AbstractAction {
      ...
      public void actionPerformed(ActionEvent var1) {
         mxGraph var2 = mxGraphActions.getGraph(var1);
         if (var2 != null) {
            var2.setSelectionCell(var2.groupCells(null, this.getGroupBorder(var2)));
         }
      }
   }
   ...
   public static class UpdateGroupBoundsAction extends AbstractAction {
      ...
      public void actionPerformed(ActionEvent var1) {
         mxGraph var2 = mxGraphActions.getGraph(var1);
         if (var2 != null) {
            var2.updateGroupBounds(null, this.getGroupBorder(var2));
         }
      }
   }
