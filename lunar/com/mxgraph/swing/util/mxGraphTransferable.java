...
public class mxGraphTransferable implements Transferable, Serializable, UIResource {
   ...
   public DataFlavor[] getTransferDataFlavors() {
      ...
      int var6 = this.isImageSupported() ? imageFlavors.length : 0;
   ...
   public Object getTransferData(DataFlavor var1) {
      ...
      if (this.isImageFlavor(var1)) {
      ...
      } else if (this.isHtmlFlavor(var1)) {
         String var3 = this.getHtmlData();
         var3 = var3 == null ? "" : var3;
         ...
         if (Reader.class.equals(var1.getRepresentationClass())) {
            return new StringReader(var5);
         }

         if (InputStream.class.equals(var1.getRepresentationClass())) {
            return new ByteArrayInputStream(var5.getBytes());
         }
      } else if (this.isStringFlavor(var1)) {
         String var7 = this.getPlainData();
         return var7 == null ? "" : var7;
      }
   ...
   public Object getRicherData(DataFlavor var1) {
   ...
   public boolean isImageSupported() {
      return enableImageSupport && this.image != null;
   }
