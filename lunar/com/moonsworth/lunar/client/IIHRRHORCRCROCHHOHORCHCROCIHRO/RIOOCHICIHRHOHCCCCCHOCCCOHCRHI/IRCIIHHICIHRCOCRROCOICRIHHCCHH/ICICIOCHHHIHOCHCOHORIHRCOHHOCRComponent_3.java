...
public class RHOORRIIOCHIRRHOHOOHIROHCRICRO
   ...
   public void IRCIIHHICIHRCOCRROCOICRIHHCCHH(
      ...
      if (var4 + 10.0F > this.width - 20.0F) {
         com.moonsworth.lunar.client.HICRRICCHCCROOHHCHOCOCCHOIHHOC.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.CIOHHCORHRCCRICCCORIHCRHCCCRRR.IIICHRHOOCHCOROCHHOIIOCRCRIHOO()
            .RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(var1, this.option.getName(), this.x + 20.0F, this.y + 3.0F, -4079426);
      } else {
         com.moonsworth.lunar.client.HICRRICCHCCROOHHCHOCOCCHOIHHOC.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.CIOHHCORHRCCRICCCORIHCRHCCCRRR.OHOIIIRRIHCRIRRCHHIRIOROHIIHIO()
            .RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(var1, this.option.getName(), this.x + 20.0F, this.y + 1.5F, -4079426);
      }
      ...
      com.moonsworth.lunar.client.IIHRRHORCRCROCHHOHORCHCROCIHRO.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.IRCIIHHICIHRCOCRROCOICRIHHCCHH(
         var1, this.x, this.y + 2.0F, 10.0F, 10.0F, 5.0F, var3 && this.IRCIIHHICIHRCOCRROCOICRIHHCCHH(var2) ? -11561732 : -1437625092, true, true, true, true
      );
      com.moonsworth.lunar.client.IIHRRHORCRCROCHHOHORCHCROCIHRO.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(
         var1, this.x + 1.0F, this.y + 3.0F, 8.0F, 8.0F, 2.5F, 905969663, true, true, true, true
      );
      if (this.option.get()) {
         com.moonsworth.lunar.client.IIHRRHORCRCROCHHOHORCHCROCIHRO.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.RIOOCHICIHRHOHCCCCCHOCCCOHCRHI.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(
            var1,
