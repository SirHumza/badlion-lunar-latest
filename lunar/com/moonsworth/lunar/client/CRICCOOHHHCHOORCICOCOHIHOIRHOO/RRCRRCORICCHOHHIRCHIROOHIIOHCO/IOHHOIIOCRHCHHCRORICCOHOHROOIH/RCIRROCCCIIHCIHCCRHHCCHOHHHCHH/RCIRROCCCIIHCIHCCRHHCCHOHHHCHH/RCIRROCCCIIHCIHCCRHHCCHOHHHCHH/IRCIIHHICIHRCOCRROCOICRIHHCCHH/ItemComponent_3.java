...
public class HICRRICCHCCROOHHCHOCOCCHOIHHOC
   ...
   private final String CCROHIROCCHOCRHIOOHRHCIHCCRROO;

   @NotNull
   @Override
   public String RRIICCIOCHRHOHIRIHCHRHOCOROOCC() {
      return this.CCROHIROCCHOCRHIOOHRHCIHCCRROO;
   }
   ...
   public boolean HICRRICCHCCROOHHCHOCOCCHOIHHOC(@NotNull IIRHCHHOICHRICOOCRORCCIOOIHOIR var1) {
      ...
      return var2.endsWith("_" + this.CCROHIROCCHOCRHIOOHRHCIHCCRROO);
   }
   ...
   public CRRRICCRROCOHHOHIICIHORCOORRRH ORHIOICIOCRRHOOCOHRORIHICHRCRR(@NotNull IIRHCHHOICHRICOOCRORCCIOOIHOIR var1) {
      return com.moonsworth.lunar.client.CRICCOOHHHCHOORCICOCOHIHOIRHOO.RRCRRCORICCHOHHIRCHIROOHIIOHCO.IOHHOIIOCRHCHHCRORICCOHOHROOIH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.IRCIIHHICIHRCOCRROCOICRIHHCCHH.IHIRRIIORRHORHRORIHOROIRCORCOO(
         ...
         .map(
            var1x -> {
               var1x = var1x.replace("_" + this.CCROHIROCCHOCRHIOOHRHCIHCCRROO, "");
   ...
   public Optional<com.moonsworth.lunar.HHCCIRHCCCIIRHCROHIORHIRHHIORH.IHHCHHHCRIHOOCOIOOCRIIICIOROIR.IIRHCHHOICHRICOOCRORCCIOOIHOIR> RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(
      ...
      if (IICCOOCHCHROORHHIIHROHCCRHRCOR.MC_VERSION > 5) {
         Optional var4 = com.moonsworth.lunar.client.CRICCOOHHHCHOORCICOCOHIHOIRHOO.RRCRRCORICCHOHHIRCHIROOHIIOHCO.IOHHOIIOCRHCHHCRORICCOHOHROOIH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.IRCIIHHICIHRCOCRROCOICRIHHCCHH.ICHHRRHHCCCCIRHCORIHIRHHOCHIOO(
            "minecraft:" + var2 + "_" + this.CCROHIROCCHOCRHIOOHRHCIHCCRROO
         );
         return var4.isPresent()
            ...
            : com.moonsworth.lunar.client.CRICCOOHHHCHOORCICOCOHIHOIRHOO.RRCRRCORICCHOHHIRCHIROOHIIOHCO.IOHHOIIOCRHCHHCRORICCOHOHROOIH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.IRCIIHHICIHRCOCRROCOICRIHHCCHH.ICHHRRHHCCCCIRHCORIHIRHHOCHIOO(
               "minecraft:oak_" + this.CCROHIROCCHOCRHIOOHRHCIHCCRROO
            );
      }
      ...
      return var3.isPresent()
         ? var3
         : com.moonsworth.lunar.client.CRICCOOHHHCHOORCICOCOHIHOIRHOO.RRCRRCORICCHOHHIRCHIROOHIIOHCO.IOHHOIIOCRHCHHCRORICCOHOHROOIH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.IRCIIHHICIHRCOCRROCOICRIHHCCHH.ICHHRRHHCCCCIRHCORIHIRHHOCHIOO(
            "minecraft:wooden_" + this.CCROHIROCCHOCRHIOOHRHCIHCCRROO
         );
   }

   @Generated
   public HICRRICCHCCROOHHCHOCOCCHOIHHOC(String var1) {
      this.CCROHIROCCHOCRHIOOHRHCIHCCRROO = var1;
   }
}
