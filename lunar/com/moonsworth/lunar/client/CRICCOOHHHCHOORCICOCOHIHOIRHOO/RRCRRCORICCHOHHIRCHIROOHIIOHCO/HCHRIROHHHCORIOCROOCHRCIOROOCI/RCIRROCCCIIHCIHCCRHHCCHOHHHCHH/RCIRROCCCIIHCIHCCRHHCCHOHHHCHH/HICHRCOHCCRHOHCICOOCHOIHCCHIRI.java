...
public class HICHRCOHCCRHOHCICOOCHOIHCCHIRI
   ...
   public void RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(
      ...
      this.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(var4, 0.0F, 0.0F, var1.getWidth() / 2.0F * var2, var1.getHeight() / 2.0F, var3);
      this.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(var4, var1.getWidth() / 2.0F, 0.0F, var1.getWidth() / 2.0F, var1.getHeight() / 2.0F * var2, var3);
      float var5 = var1.getWidth() / 2.0F * var2;
      this.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(var4, var1.getWidth() - var5, var1.getHeight() / 2.0F, var5, var1.getHeight() / 2.0F, var3);
      float var6 = var1.getHeight() / 2.0F * var2;
      this.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(var4, 0.0F, var1.getHeight() - var6, var1.getWidth() / 2.0F, var6, var3);
   }
}
