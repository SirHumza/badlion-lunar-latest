...
final class HHRIICOIOORCHCOIICOOIHIRHHICRI extends HHCCIRHCCCIIRHCROHIORHIRHHIORH {
   ...
   long valueOfFloatLiteral(char[] var1, int var2, int var3, boolean var4, long var5, int var7, boolean var8, int var9) {
      ...
      return Float.isNaN(var10) ? Float.floatToRawIntBits(Float.parseFloat(new String(var1, var2, var3 - var2))) : Float.floatToRawIntBits(var10);
   }
   ...
   long valueOfHexLiteral(char[] var1, int var2, int var3, boolean var4, long var5, int var7, boolean var8, int var9) {
      ...
      return Float.floatToRawIntBits(Float.isNaN(var10) ? Float.parseFloat(new String(var1, var2, var3 - var2)) : var10);
   }
}
