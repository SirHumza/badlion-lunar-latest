...
abstract class CRRRICCRROCOHHOHIICIHORCOORRRH extends RCIRROCCCIIHCIHCCRHHCCHOHHHCHH {
   ...
   public final long RCIRROCCCIIHCIHCCRHHCCHOHHHCHH(CharSequence var1, int var2, int var3) {
      int var4 = var2 + var3;
   ...
   private long parseHexFloatLiteral(CharSequence var1, int var2, int var3, int var4, boolean var5) {
      ...
      while (var2 < var4) {
         ...
         if (var14 >= 0) {
            ...
            while (var2 < var4 - 8) {
               long var15 = OOROOCCIRCCRHOIOIORIHCHHOOCCOR.tryToParseEightHexDigits(var1, var2 + 1);
               if (var15 < 0L) {
                  break;
               }
