...
public class LerpRotate extends Function {
   ...
   public double _evaluate(Expr[] var1, ExecutionContext var2) {
      return Interpolations.lerpYaw(this.evaluateArgument(var1, var2, 0), this.evaluateArgument(var1, var2, 1), this.evaluateArgument(var1, var2, 2));
   }
}
