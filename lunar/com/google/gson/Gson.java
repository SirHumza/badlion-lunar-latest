...
public final class Gson {
   ...
   Gson(
      ...
      var22.add(TypeAdapters.newFactory(long.class, Long.class, var23));
      var22.add(TypeAdapters.newFactory(double.class, Double.class, this.doubleAdapter(var10)));
      var22.add(TypeAdapters.newFactory(float.class, Float.class, this.floatAdapter(var10)));
      ...
      return var1 ? TypeAdapters.FLOAT : new TypeAdapter<Number>() {
         ...
         public void write(JsonWriter var1, Number var2) {
            if (var2 == null) {
               ...
               Gson.checkValidFloatingPoint(var3);
               Number var4 = var2 instanceof Float ? var2 : var3;
               var1.value(var4);
            }
         }
      };
   ...
   public <T> TypeAdapter<T> getAdapter(TypeToken<T> var1) {
      ...
      Map var3 = this.threadLocalAdapterResults.get();
      boolean var4 = false;
      if (var3 == null) {
         var3 = new HashMap();
         ...
         TypeAdapter var5 = (TypeAdapter)var3.get(var1);
         if (var5 != null) {
            return var5;
         }
      }
      ...
      if (var4) {
         this.typeTokenCache.putAll(var3);
      }
   ...
   public <T> TypeAdapter<T> getDelegateAdapter(TypeAdapterFactory var1, TypeToken<T> var2) {
      ...
      if (this.jsonAdapterFactory.isClassJsonAdapterFactory(var2, var1)) {
   ...
   public JsonElement toJsonTree(Object var1) {
      return var1 == null ? JsonNull.INSTANCE : this.toJsonTree(var1, var1.getClass());
   }
   ...
   public String toJson(Object var1) {
      return var1 == null ? this.toJson(JsonNull.INSTANCE) : this.toJson(var1, var1.getClass());
   }
   ...
   public <T> T fromJson(String var1, TypeToken<T> var2) {
      ...
      return this.fromJson(var3, var2);
   }
   ...
   public <T> T fromJson(JsonReader var1, TypeToken<T> var2) {
      boolean var3 = true;
      ...
      try {
         ...
         var3 = false;
         TypeAdapter var6 = this.getAdapter(var2);
