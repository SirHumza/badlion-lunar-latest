...
public class TypeToken<T> {
   ...
   private TypeToken(Type var1) {
      this.type = $Gson$Types.canonicalize(Objects.requireNonNull(var1));
      this.rawType = (Class<? super T>)$Gson$Types.getRawType(this.type);
      this.hashCode = this.type.hashCode();
   }
   ...
   private static boolean isAssignableFrom(Type var0, GenericArrayType var1) {
      ...
      return isAssignableFrom(var3, (ParameterizedType)var2, new HashMap<>());
   }
   ...
   private static boolean isAssignableFrom(Type var0, ParameterizedType var1, Map<String, Type> var2) {
      ...
      if (var4 != null) {
         ...
         for (int var7 = 0; var7 < var5.length; var7++) {
            Type var8 = var5[var7];
            TypeVariable var9 = var6[var7];

            while (var8 instanceof TypeVariable) {
               TypeVariable var10 = (TypeVariable)var8;
               var8 = (Type)var2.get(var10.getName());
            }
   ...
   public static TypeToken<?> getParameterized(Type var0, Type... var1) {
      ...
      if ($Gson$Types.requiresOwnerType(var0)) {
      ...
      for (int var6 = 0; var6 < var4; var6++) {
         Type var7 = Objects.requireNonNull(var1[var6], "Type argument must not be null");
