...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
   ...
   private static JsonAdapter getAnnotation(Class<?> var0) {
      return var0.getAnnotation(JsonAdapter.class);
   }
   ...
   public <T> TypeAdapter<T> create(Gson var1, TypeToken<T> var2) {
      ...
      return (TypeAdapter<T>)(var4 == null ? null : this.getTypeAdapter(this.constructorConstructor, var1, var2, var4, true));
   }
   ...
   private TypeAdapterFactory putFactoryAndGetCurrent(Class<?> var1, TypeAdapterFactory var2) {
      TypeAdapterFactory var3 = this.adapterFactoryMap.putIfAbsent(var1, var2);
   ...
   public boolean isClassJsonAdapterFactory(TypeToken<?> var1, TypeAdapterFactory var2) {
      ...
      TypeAdapterFactory var4 = this.adapterFactoryMap.get(var3);
      if (var4 != null) {
         return var4 == var2;
      }
