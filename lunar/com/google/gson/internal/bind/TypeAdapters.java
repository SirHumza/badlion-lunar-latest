...
public final class TypeAdapters {
   ...
   public static final TypeAdapter<Number> FLOAT = new TypeAdapter<Number>() {
      ...
      public void write(JsonWriter var1, Number var2) {
         if (var2 == null) {
            ...
            Number var3 = var2 instanceof Float ? var2 : var2.floatValue();
            var1.value(var3);
         }
      }
   };
   ...
   public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> var0, final TypeAdapter<T1> var1) {
      return new TypeAdapterFactory() {
         ...
         public <T2> TypeAdapter<T2> create(Gson var1x, TypeToken<T2> var2) {
            ...
            return (TypeAdapter<T2>)(!var0.isAssignableFrom(var3)
               ? null
               : new TypeAdapter<T1>() {
                  @Override
                  public void write(JsonWriter var1x, T1 var2x) {
                     var1.write(var1x, var2x);
                  }

                  @Override
                  public T1 read(JsonReader var1x) {
                     Object var2x = var1.read(var1x);
                     if (var2x != null && !var3.isInstance(var2x)) {
                        throw new JsonSyntaxException(
                           "Expected a " + var3.getName() + " but was " + var2x.getClass().getName() + "; at path " + var1x.getPreviousPath()
                        );
                     } else {
                        return (T1)var2x;
                     }
   ...
   private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
      ...
      public EnumTypeAdapter(final Class<T> var1) {
         try {
            Field[] var2 = AccessController.doPrivileged(new PrivilegedAction<Field[]>() {
               public Field[] run() {
                  Field[] var1x = var1.getDeclaredFields();
                  ArrayList var2x = new ArrayList(var1x.length);
                  ...
                  Field[] var7 = var2x.toArray(new Field[0]);
            ...
            for (Field var6 : var2) {
               Enum var7 = (Enum)var6.get(null);
               String var8 = var7.name();
               String var9 = var7.toString();
               SerializedName var10 = var6.getAnnotation(SerializedName.class);
               if (var10 != null) {
                  var8 = var10.value();

                  for (String var14 : var10.alternate()) {
                     this.nameToConstant.put(var14, (T)var7);
                  }
               }

               this.nameToConstant.put(var8, (T)var7);
               this.stringToConstant.put(var9, (T)var7);
               this.constantToName.put((T)var7, var8);
            }
      ...
      public T read(JsonReader var1) {
         if (var1.peek() == JsonToken.NULL) {
            ...
            String var2 = var1.nextString();
            Enum var3 = this.nameToConstant.get(var2);
            return (T)(var3 == null ? this.stringToConstant.get(var2) : var3);
         }
      }
