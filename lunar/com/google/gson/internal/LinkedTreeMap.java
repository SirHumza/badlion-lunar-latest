...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
   ...
   LinkedTreeMap.Node<K, V> find(K var1, boolean var2) {
      ...
      if (var4 != null) {
         ...
         while (true) {
            var5 = (byte)(var6 != null ? var6.compareTo(var4.key) : var3.compare(var1, var4.key));
            if (var5 == 0) {
               return var4;
            }

            LinkedTreeMap.Node var7 = var5 < 0 ? var4.left : var4.right;
            if (var7 == null) {
               break;
            }
      ...
      if (var4 == null) {
         ...
         var9 = new LinkedTreeMap.Node<>(this.allowNullValues, var4, var1, var8, var8.prev);
         this.root = var9;
      } else {
         var9 = new LinkedTreeMap.Node<>(this.allowNullValues, var4, var1, var8, var8.prev);
         if (var5 < 0) {
   ...
   LinkedTreeMap.Node<K, V> findByObject(Object var1) {
      try {
         return var1 != null ? this.find((K)var1, false) : null;
   ...
   private void rebalance(LinkedTreeMap.Node<K, V> var1, boolean var2) {
      for (LinkedTreeMap.Node var3 = var1; var3 != null; var3 = var3.parent) {
         ...
         int var8 = var6 - var7;
         if (var8 == -2) {
            LinkedTreeMap.Node var9 = var5.left;
            LinkedTreeMap.Node var10 = var5.right;
            ...
            LinkedTreeMap.Node var14 = var4.left;
            LinkedTreeMap.Node var15 = var4.right;
   ...
   static final class Node<K, V> implements Entry<K, V> {
      ...
      Node(boolean var1, LinkedTreeMap.Node<K, V> var2, K var3, LinkedTreeMap.Node<K, V> var4, LinkedTreeMap.Node<K, V> var5) {
         this.parent = var2;
         this.key = (K)var3;
         this.allowNullValue = var1;
         this.height = 1;
      ...
      public boolean equals(Object var1) {
         ...
         return (this.key == null ? var2.getKey() == null : this.key.equals(var2.getKey()))
            && (this.value == null ? var2.getValue() == null : this.value.equals(var2.getValue()));
      }
      ...
      public LinkedTreeMap.Node<K, V> first() {
         ...
         for (LinkedTreeMap.Node var2 = var1.left; var2 != null; var2 = var1.left) {
            var1 = var2;
         }
      ...
      public LinkedTreeMap.Node<K, V> last() {
         ...
         for (LinkedTreeMap.Node var2 = var1.right; var2 != null; var2 = var1.right) {
            var1 = var2;
         }
