...
final class SchemaUtil {
   ...
   public static void writeDouble(int var0, double var1, Writer var3) {
      if (Double.doubleToRawLongBits(var1) != 0L) {
         var3.writeDouble(var0, var1);
      }
   }

   public static void writeFloat(int var0, float var1, Writer var2) {
      if (Float.floatToRawIntBits(var1) != 0) {
         var2.writeFloat(var0, var1);
      }
   }

   public static void writeInt64(int var0, long var1, Writer var3) {
      if (var1 != 0L) {
         var3.writeInt64(var0, var1);
      }
   }

   public static void writeUInt64(int var0, long var1, Writer var3) {
      if (var1 != 0L) {
         var3.writeUInt64(var0, var1);
      }
   }

   public static void writeSInt64(int var0, long var1, Writer var3) {
      if (var1 != 0L) {
         var3.writeSInt64(var0, var1);
      }
   }

   public static void writeFixed64(int var0, long var1, Writer var3) {
      if (var1 != 0L) {
         var3.writeFixed64(var0, var1);
      }
   }

   public static void writeSFixed64(int var0, long var1, Writer var3) {
      if (var1 != 0L) {
         var3.writeSFixed64(var0, var1);
      }
   }

   public static void writeInt32(int var0, int var1, Writer var2) {
      if (var1 != 0) {
         var2.writeInt32(var0, var1);
      }
   }

   public static void writeUInt32(int var0, int var1, Writer var2) {
      if (var1 != 0) {
         var2.writeUInt32(var0, var1);
      }
   }

   public static void writeSInt32(int var0, int var1, Writer var2) {
      if (var1 != 0) {
         var2.writeSInt32(var0, var1);
      }
   }

   public static void writeFixed32(int var0, int var1, Writer var2) {
      if (var1 != 0) {
         var2.writeFixed32(var0, var1);
      }
   }

   public static void writeSFixed32(int var0, int var1, Writer var2) {
      if (var1 != 0) {
         var2.writeSFixed32(var0, var1);
      }
   }

   public static void writeEnum(int var0, int var1, Writer var2) {
      if (var1 != 0) {
         var2.writeEnum(var0, var1);
      }
   }

   public static void writeBool(int var0, boolean var1, Writer var2) {
      if (var1) {
         var2.writeBool(var0, true);
      }
   }

   public static void writeString(int var0, Object var1, Writer var2) {
   ...
   private static void writeStringInternal(int var0, String var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeString(var0, var1);
      }
   }

   public static void writeBytes(int var0, ByteString var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeBytes(var0, var1);
      }
   }

   public static void writeMessage(int var0, Object var1, Writer var2) {
      if (var1 != null) {
         var2.writeMessage(var0, var1);
      }
   }

   public static void writeDoubleList(int var0, List<Double> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeDoubleList(var0, var1, var3);
      }
   }

   public static void writeFloatList(int var0, List<Float> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeFloatList(var0, var1, var3);
      }
   }

   public static void writeInt64List(int var0, List<Long> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeInt64List(var0, var1, var3);
      }
   }

   public static void writeUInt64List(int var0, List<Long> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeUInt64List(var0, var1, var3);
      }
   }

   public static void writeSInt64List(int var0, List<Long> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeSInt64List(var0, var1, var3);
      }
   }

   public static void writeFixed64List(int var0, List<Long> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeFixed64List(var0, var1, var3);
      }
   }

   public static void writeSFixed64List(int var0, List<Long> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeSFixed64List(var0, var1, var3);
      }
   }

   public static void writeInt32List(int var0, List<Integer> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeInt32List(var0, var1, var3);
      }
   }

   public static void writeUInt32List(int var0, List<Integer> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeUInt32List(var0, var1, var3);
      }
   }

   public static void writeSInt32List(int var0, List<Integer> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeSInt32List(var0, var1, var3);
      }
   }

   public static void writeFixed32List(int var0, List<Integer> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeFixed32List(var0, var1, var3);
      }
   }

   public static void writeSFixed32List(int var0, List<Integer> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeSFixed32List(var0, var1, var3);
      }
   }

   public static void writeEnumList(int var0, List<Integer> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeEnumList(var0, var1, var3);
      }
   }

   public static void writeBoolList(int var0, List<Boolean> var1, Writer var2, boolean var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeBoolList(var0, var1, var3);
      }
   }

   public static void writeStringList(int var0, List<String> var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeStringList(var0, var1);
      }
   }

   public static void writeBytesList(int var0, List<ByteString> var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeBytesList(var0, var1);
      }
   }

   public static void writeMessageList(int var0, List<?> var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeMessageList(var0, var1);
      }
   }

   public static void writeMessageList(int var0, List<?> var1, Writer var2, Schema var3) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeMessageList(var0, var1, var3);
      }
   }

   public static void writeLazyFieldList(int var0, List<?> var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
   ...
   public static void writeGroupList(int var0, List<?> var1, Writer var2) {
      if (var1 != null && !var1.isEmpty()) {
         var2.writeGroupList(var0, var1);
      }
   }

   public static void writeGroupList(int var0, List<?> var1, Writer var2, Schema var3) {
      if (var1 != null && !var1.isEmpty()) {
   ...
   static int computeSizeInt64List(int var0, List<Long> var1, boolean var2) {
      ...
      return var2
         ...
         : var4 + var1.size() * CodedOutputStream.computeTagSize(var0);
   }
   ...
   public static boolean shouldUseTableSwitch(int var0, int var1, int var2) {
      ...
      long var3 = (long)var1 - var0 + 1L;
      long var5 = 3L;
      long var7 = 3L + 2L * var2;
      long var9 = 3L + var2;
   ...
   private static UnknownFieldSchema<?, ?> getUnknownFieldSetSchema() {
      try {
         Class var0 = getUnknownFieldSetSchemaClass();
         return var0 == null ? null : (UnknownFieldSchema)var0.getConstructor().newInstance();
   ...
   static <UT, UB> UB filterUnknownEnumList(Object var0, int var1, List<Integer> var2, Internal.EnumLiteMap<?> var3, UB var4, UnknownFieldSchema<UT, UB> var5) {
      ...
      if (var2 instanceof RandomAccess) {
         ...
         while (var10.hasNext()) {
            ...
            if (var3.findValueByNumber(var11) == null) {
               var4 = storeUnknownEnum(var0, var1, var11, var4, var5);
               var10.remove();
            }
         }
      }
   ...
   static <UT, UB> UB storeUnknownEnum(Object var0, int var1, int var2, UB var3, UnknownFieldSchema<UT, UB> var4) {
      if (var3 == null) {
         var3 = var4.getBuilderFromMessage(var0);
      }

      var4.addVarint(var3, var1, var2);
      return (UB)var3;
   }
}
