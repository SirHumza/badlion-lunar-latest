...
abstract class ExtensionSchema<T extends FieldSet.FieldDescriptorLite<T>> {
   ...
   abstract <UT, UB> UB parseExtension(
      Object var1, Reader var2, Object var3, ExtensionRegistryLite var4, FieldSet<T> var5, UB var6, UnknownFieldSchema<UT, UB> var7
   );

   abstract int extensionNumber(Entry<?, ?> var1);

   abstract void serializeExtension(Writer var1, Entry<?, ?> var2);

   abstract Object findExtensionByNumber(ExtensionRegistryLite var1, MessageLite var2, int var3);

   abstract void parseLengthPrefixedMessageSetItem(Reader var1, Object var2, ExtensionRegistryLite var3, FieldSet<T> var4);

   abstract void parseMessageSetItem(ByteString var1, Object var2, ExtensionRegistryLite var3, FieldSet<T> var4);
}
