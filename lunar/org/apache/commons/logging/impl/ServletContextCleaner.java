...
public class ServletContextCleaner implements ServletContextListener {
   ...
   public ServletContextCleaner() {
      this.RELEASE_SIGNATURE = new Class[]{
         class$java$lang$ClassLoader == null ? (class$java$lang$ClassLoader = class$("java.lang.ClassLoader")) : class$java$lang$ClassLoader
      };
   }
   ...
   public void contextDestroyed(ServletContextEvent var1) {
      ...
      while (var4 != null) {
         try {
            ...
            Method var6 = var5.getMethod("release", this.RELEASE_SIGNATURE);
            var6.invoke(null, var3);
