...
public class SimpleLog implements Serializable, Log {
   ...
   protected void log(int var1, Object var2, Throwable var3) {
      ...
      if (showDateTime) {
         ...
         synchronized (dateFormatter) {
            var6 = dateFormatter.format(var5);
         }
   ...
   private static ClassLoader getContextClassLoader() {
      ...
      if (var0 == null) {
         var0 = (class$org$apache$commons$logging$impl$SimpleLog == null
               ? (class$org$apache$commons$logging$impl$SimpleLog = class$("org.apache.commons.logging.impl.SimpleLog"))
   ...
   private static InputStream getResourceAsStream(String var0) {
      return AccessController.doPrivileged(new SimpleLog$1(var0));
   }
