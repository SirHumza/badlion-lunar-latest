...
public class HelpFormatter {
   ...
   public void printHelp(String var1, Options var2) {
      this.printHelp(this.defaultWidth, var1, null, var2, null, false);
   }

   public void printHelp(String var1, Options var2, boolean var3) {
      this.printHelp(this.defaultWidth, var1, null, var2, null, var3);
   }
   ...
   protected StringBuffer renderOptions(StringBuffer var1, int var2, Options var3, int var4, int var5) {
      ...
      for (Option var13 : var11) {
         StringBuffer var9 = new StringBuffer(8);
         ...
         var10.add(var9);
         var8 = (byte)(var9.length() > var8 ? var9.length() : var8);
      }
      ...
      while (var18.hasNext()) {
         Option var14 = (Option)var18.next();
         StringBuffer var16 = new StringBuffer(var10.get(var17++).toString());
         if (var16.length() < var8) {
            var16.append(this.createPadding(var8 - var16.length()));
         }

         var16.append(var7);
         int var15 = var8 + var5;
         if (var14.getDescription() != null) {
            var16.append(var14.getDescription());
         }

         this.renderWrappedText(var1, var2, var15, var16.toString());
         if (var18.hasNext()) {
   ...
   protected int findWrapPos(String var1, int var2, int var3) {
      int var4 = -1;
      if (((var4 = var1.indexOf(10, var3)) == -1 || var4 > var2) && ((var4 = var1.indexOf(9, var3)) == -1 || var4 > var2)) {
         ...
         char var5;
         while (var4 >= var3 && (var5 = var1.charAt(var4)) != ' ' && var5 != '\n' && var5 != '\r') {
            var4--;
         }
         ...
         while (var4 <= var1.length() && (var5 = var1.charAt(var4)) != ' ' && var5 != '\n' && var5 != '\r') {
            var4++;
         }
   ...
   protected String rtrim(String var1) {
      if (var1 != null && var1.length() != 0) {
         ...
         while (var2 > 0 && Character.isWhitespace(var1.charAt(var2 - 1))) {
            var2--;
         }
   ...
   private static class OptionComparator implements Comparator {
      ...
      OptionComparator(<unrepresentable> var1) {
         this();
      }
   }
}
