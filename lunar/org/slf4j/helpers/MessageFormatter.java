...
public final class MessageFormatter {
   ...
   public static final String basicArrayFormat(String var0, Object[] var1) {
      FormattingTuple var2 = arrayFormat(var0, var1, null);
      return var2.getMessage();
   }

   public static String basicArrayFormat(NormalizedParameters var0) {
      return basicArrayFormat(var0.getMessage(), var0.getArguments());
   }
   ...
   private static void deeplyAppendParameter(StringBuilder var0, Object var1, Map<Object[], Object> var2) {
      if (var1 == null) {
         var0.append("null");
      } else {
   ...
   private static void safeObjectAppend(StringBuilder var0, Object var1) {
      try {
         ...
         Reporter.error("Failed toString() invocation on an object of type [" + var1.getClass().getName() + "]", var3);
         var0.append("[FAILED toString()]");
      }
   }

   private static void objectArrayAppend(StringBuilder var0, Object[] var1, Map<Object[], Object> var2) {
      var0.append('[');
   ...
   public static Throwable getThrowableCandidate(Object[] var0) {
      return NormalizedParameters.getThrowableCandidate(var0);
   }

   public static Object[] trimmedCopy(Object[] var0) {
      return NormalizedParameters.trimmedCopy(var0);
   }
}
