...
public class FastLookupDirectedSpecifics<V, E> extends DirectedSpecifics<V, E> {
   ...
   public FastLookupDirectedSpecifics(Graph<V, E> var1, Map<V, DirectedEdgeContainer<V, E>> var2, Map<Pair<V, V>, Set<E>> var3, EdgeSetFactory<V, E> var4) {
   ...
   public Set<E> getAllEdges(V var1, V var2) {
      if (this.graph.containsVertex((V)var1) && this.graph.containsVertex((V)var2)) {
         Set var3 = this.touchingVerticesToEdgeMap.get(new Pair<>(var1, var2));
         if (var3 == null) {
