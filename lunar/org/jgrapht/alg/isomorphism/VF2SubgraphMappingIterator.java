...
class VF2SubgraphMappingIterator<V, E> extends VF2MappingIterator<V, E> {
   public VF2SubgraphMappingIterator(GraphOrdering<V, E> var1, GraphOrdering<V, E> var2, Comparator<V> var3, Comparator<E> var4) {
   ...
   protected IsomorphicGraphMapping<V, E> match() {
      ...
      if (this.stateStack.isEmpty()) {
         ...
         var1 = new VF2SubgraphIsomorphismState<>(this.ordering1, this.ordering2, this.vertexComparator, this.edgeComparator);
      ...
      while (true) {
         ...
         if (var1.isFeasiblePair()) {
            ...
            var1 = new VF2SubgraphIsomorphismState(var1);
            var1.addPair();
            if (var1.isGoal()) {
               this.stateStack.push(var1);
