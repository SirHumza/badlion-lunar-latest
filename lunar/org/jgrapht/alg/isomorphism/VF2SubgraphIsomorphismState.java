...
class VF2SubgraphIsomorphismState<V, E> extends VF2State<V, E> {
   public VF2SubgraphIsomorphismState(GraphOrdering<V, E> var1, GraphOrdering<V, E> var2, Comparator<V> var3, Comparator<E> var4) {
      super(var1, var2, var3, var4);
   }

   public VF2SubgraphIsomorphismState(VF2State<V, E> var1) {
      super(var1);
   }
