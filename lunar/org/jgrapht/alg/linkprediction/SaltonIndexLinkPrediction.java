...
public class SaltonIndexLinkPrediction<V, E> implements LinkPredictionAlgorithm<V, E> {
   private Graph<V, E> graph;

   public SaltonIndexLinkPrediction(Graph<V, E> var1) {
   ...
   public double predict(V var1, V var2) {
      ...
      if (var3 != 0 && var4 != 0) {
         ...
         var7.retainAll(var6);
         return var7.size() / Math.sqrt(var3 * var4);
      } else {
         throw new LinkPredictionIndexNotWellDefinedException("Query vertex with zero neighbors", Pair.of(var1, var2));
      }
   }
}
