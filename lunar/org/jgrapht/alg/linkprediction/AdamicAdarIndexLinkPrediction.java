...
public class AdamicAdarIndexLinkPrediction<V, E> implements LinkPredictionAlgorithm<V, E> {
   private Graph<V, E> graph;

   public AdamicAdarIndexLinkPrediction(Graph<V, E> var1) {
   ...
   public double predict(V var1, V var2) {
      ...
      for (Object var9 : var5) {
         ...
         if (var10 < 2) {
            throw new LinkPredictionIndexNotWellDefinedException("Vertex has less than 2 degree", Pair.of(var1, var2));
         }

         var6 += 1.0 / Math.log(var10);
      }
