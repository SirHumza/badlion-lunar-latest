...
public class Base64Coder {
   ...
   public static String encodeLines(byte[] var0, int var1, int var2, int var3, String var4) {
      ...
      while (var9 < var2) {
         int var10 = Math.min(var2 - var9, var5);
   ...
   public static char[] encode(byte[] var0, int var1, int var2) {
      ...
      for (int var8 = 0; var6 < var7; var8++) {
         ...
         int var10 = var6 < var7 ? var0[var6++] & 0xFF : 0;
         int var11 = var6 < var7 ? var0[var6++] & 0xFF : 0;
         int var12 = var9 >>> 2;
         ...
         var5[var8] = var8 < var3 ? map1[var14] : '=';
         var5[++var8] = var8 < var3 ? map1[var15] : '=';
      }
   ...
   public static byte[] decode(char[] var0, int var1, int var2) {
      ...
      while (var5 < var6) {
         char var8 = var0[var5++];
         char var9 = var0[var5++];
         char var10 = var5 < var6 ? var0[var5++] : 'A';
         char var11 = var5 < var6 ? var0[var5++] : 'A';
   ...
   static {
      ...
      for (int var4 = 0; var4 < map2.length; var4++) {
         map2[var4] = -1;
      }

      for (int var5 = 0; var5 < 64; var5++) {
         map2[map1[var5]] = (byte)var5;
      }
   }
}
