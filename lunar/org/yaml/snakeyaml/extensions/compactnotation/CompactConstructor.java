...
public class CompactConstructor extends Constructor {
   ...
   public CompactConstructor(LoaderOptions var1) {
      super(var1);
   }
   ...
   protected Object createInstance(ScalarNode var1, CompactData var2) {
   ...
   protected void setProperties(Object var1, Map<String, Object> var2) {
      if (var2 == null) {
      ...
      for (Entry var4 : var2.entrySet()) {
         ...
         Property var6 = this.getPropertyUtils().getProperty((Class<? extends Object>)var1.getClass(), var5);
   ...
   protected void applySequence(Object var1, List<?> var2) {
      try {
         Property var3 = this.getPropertyUtils().getProperty((Class<? extends Object>)var1.getClass(), this.getSequencePropertyName(var1.getClass()));
         var3.set(var1, var2);
   ...
   public class ConstructCompactObject extends Constructor.ConstructMapping {
      ...
      public void construct2ndStep(Node var1, Object var2) {
         ...
         NodeTuple var4 = var3.getValue().iterator().next();
         Node var5 = var4.getValueNode();
         if (var5 instanceof MappingNode) {
            var5.setType((Class<? extends Object>)var2.getClass());
