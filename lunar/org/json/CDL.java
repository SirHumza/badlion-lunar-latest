...
public class CDL {
   private static String getValue(JSONTokener var0) {
      char var1;
      do {
         var1 = var0.next();
      } while (var1 == ' ' || var1 == '\t');
   ...
   public static JSONArray rowToJSONArray(JSONTokener var0) {
   ...
   public static JSONObject rowToJSONObject(JSONArray var0, JSONTokener var1) {
   ...
   public static JSONArray toJSONArray(JSONTokener var0) {
      return toJSONArray(rowToJSONArray(var0), var0);
   }

   public static JSONArray toJSONArray(JSONArray var0, String var1) {
      return toJSONArray(var0, new JSONTokener(var1));
   }

   public static JSONArray toJSONArray(JSONArray var0, JSONTokener var1) {
   ...
   public static String toString(JSONArray var0, JSONArray var1) {
      if (var0 != null && var0.length() != 0) {
