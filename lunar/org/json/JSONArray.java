...
public class JSONArray implements Iterable<Object> {
   ...
   public JSONArray(JSONTokener var1) {
      this();
      if (var1.nextClean() != '[') {
   ...
   public <E extends Enum<E>> E getEnum(Class<E> var1, int var2) {
   ...
   public JSONArray put(double var1) {
      return this.put(Double.valueOf(var1));
   }

   public JSONArray put(float var1) {
      return this.put(Float.valueOf(var1));
   }

   public JSONArray put(int var1) {
      return this.put(Integer.valueOf(var1));
   }

   public JSONArray put(long var1) {
      return this.put(Long.valueOf(var1));
   }
   ...
   public JSONArray put(int var1, boolean var2) {
      return this.put(var1, var2 ? Boolean.TRUE : Boolean.FALSE);
   }

   public JSONArray put(int var1, Collection<?> var2) {
      return this.put(var1, new JSONArray(var2));
   }

   public JSONArray put(int var1, double var2) {
      return this.put(var1, Double.valueOf(var2));
   }

   public JSONArray put(int var1, float var2) {
      return this.put(var1, Float.valueOf(var2));
   }

   public JSONArray put(int var1, int var2) {
      return this.put(var1, Integer.valueOf(var2));
   }

   public JSONArray put(int var1, long var2) {
      return this.put(var1, Long.valueOf(var2));
   }

   public JSONArray put(int var1, Map<?, ?> var2) {
      this.put(var1, new JSONObject(var2));
      return this;
   }

   public JSONArray put(int var1, Object var2) {
      if (var1 < 0) {
         throw new JSONException("JSONArray[" + var1 + "] not found.");
      }
   ...
   public JSONObject toJSONObject(JSONArray var1) {
