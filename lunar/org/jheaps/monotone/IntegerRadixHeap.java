...
public class IntegerRadixHeap extends AbstractRadixHeap<Integer> {
   ...
   public IntegerRadixHeap(int var1, int var2) {
      if (var1 < 0) {
      ...
      this.buckets = (List<Integer>[])Array.newInstance(List.class, var3);

      for (int var4 = 0; var4 < this.buckets.length; var4++) {
         this.buckets[var4] = new ArrayList<>();
      }
