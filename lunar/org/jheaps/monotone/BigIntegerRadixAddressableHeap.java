...
public class BigIntegerRadixAddressableHeap<V> extends AbstractRadixAddressableHeap<BigInteger, V> {
   ...
   public BigIntegerRadixAddressableHeap(BigInteger var1, BigInteger var2) {
      if (var1 == null) {
      ...
      this.buckets = (AbstractRadixAddressableHeap.Node[])Array.newInstance(AbstractRadixAddressableHeap.Node.class, var4);
      this.size = 0L;
