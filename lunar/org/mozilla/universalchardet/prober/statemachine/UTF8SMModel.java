...
public class UTF8SMModel extends SMModel {
   ...
   private static int[] utf8ClassTable = new int[]{
      ...
      PkgInt.pack4bits(12, 13, 13, 13, 14, 15, 0, 0)
   };
   private static int[] utf8StateTable = new int[]{
      PkgInt.pack4bits(1, 0, 1, 1, 1, 1, 12, 10),
      PkgInt.pack4bits(9, 11, 8, 7, 6, 5, 4, 3),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
      PkgInt.pack4bits(2, 2, 2, 2, 2, 2, 2, 2),
      PkgInt.pack4bits(1, 1, 5, 5, 5, 5, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 5, 5, 5, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 7, 7, 7, 7, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 7, 7, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 9, 9, 9, 9, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 9, 9, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 12, 12, 12, 12, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 12, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 12, 12, 12, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 0, 0, 0, 0, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 1, 1, 1)
   };
