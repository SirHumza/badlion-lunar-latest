...
public class ISO2022CNSMModel extends SMModel {
   ...
   private static int[] iso2022cnStateTable = new int[]{
      PkgInt.pack4bits(0, 3, 1, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 1, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 2, 2, 2, 2, 2, 2),
      PkgInt.pack4bits(2, 2, 2, 1, 1, 1, 4, 1),
      PkgInt.pack4bits(1, 1, 1, 2, 1, 1, 1, 1),
      PkgInt.pack4bits(5, 6, 1, 1, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 2, 1, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 1, 2, 1, 0)
   };
