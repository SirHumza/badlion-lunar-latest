...
public class ISO2022KRSMModel extends SMModel {
   ...
   private static int[] iso2022krClassTable = new int[]{
      ...
      PkgInt.pack4bits(0, 0, 0, 0, 3, 0, 0, 0),
      PkgInt.pack4bits(0, 4, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 5, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
      PkgInt.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),
   ...
   private static int[] iso2022krStateTable = new int[]{
      PkgInt.pack4bits(0, 3, 1, 0, 0, 0, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 2, 2, 2, 2),
      PkgInt.pack4bits(2, 2, 1, 1, 1, 4, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 1, 5, 1, 1, 1),
      PkgInt.pack4bits(1, 1, 1, 2, 0, 0, 0, 0)
   };
