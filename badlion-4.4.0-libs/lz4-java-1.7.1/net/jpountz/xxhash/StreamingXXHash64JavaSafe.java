...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
   ...
   public long getValue() {
      ...
      if (off <= this.memSize - 4) {
         h64 ^= (SafeUtils.readIntLE(this.memory, off) & 4294967295L) * -7046029288634856825L;
   ...
   public void update(byte[] buf, int off, int len) {
      ...
      if (this.memSize + len < 32) {
         ...
         if (this.memSize > 0) {
            ...
            this.v1 = this.v1 + SafeUtils.readLongLE(this.memory, 0) * -4417276706812531889L;
            this.v1 = Long.rotateLeft(this.v1, 31);
            this.v1 *= -7046029288634856825L;
            this.v2 = this.v2 + SafeUtils.readLongLE(this.memory, 8) * -4417276706812531889L;
            this.v2 = Long.rotateLeft(this.v2, 31);
            this.v2 *= -7046029288634856825L;
            this.v3 = this.v3 + SafeUtils.readLongLE(this.memory, 16) * -4417276706812531889L;
            this.v3 = Long.rotateLeft(this.v3, 31);
            this.v3 *= -7046029288634856825L;
            this.v4 = this.v4 + SafeUtils.readLongLE(this.memory, 24) * -4417276706812531889L;
