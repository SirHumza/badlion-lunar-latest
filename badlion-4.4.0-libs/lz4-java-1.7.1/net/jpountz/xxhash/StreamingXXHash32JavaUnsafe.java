   ...
   public void update(byte[] buf, int off, int len) {
      ...
      if (this.memSize + len < 16) {
         ...
         if (this.memSize > 0) {
            ...
            this.v1 = this.v1 + UnsafeUtils.readIntLE(this.memory, 0) * -2048144777;
            this.v1 = Integer.rotateLeft(this.v1, 13);
            this.v1 *= -1640531535;
            this.v2 = this.v2 + UnsafeUtils.readIntLE(this.memory, 4) * -2048144777;
            this.v2 = Integer.rotateLeft(this.v2, 13);
            this.v2 *= -1640531535;
            this.v3 = this.v3 + UnsafeUtils.readIntLE(this.memory, 8) * -2048144777;
            this.v3 = Integer.rotateLeft(this.v3, 13);
            this.v3 *= -1640531535;
            this.v4 = this.v4 + UnsafeUtils.readIntLE(this.memory, 12) * -2048144777;
