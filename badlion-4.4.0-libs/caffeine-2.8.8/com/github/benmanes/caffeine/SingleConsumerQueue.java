...
public final class SingleConsumerQueue<E> extends SCQHeader.HeadAndTailRef<E> implements Queue<E>, Serializable {
   ...
   private SingleConsumerQueue(Function<E, SingleConsumerQueue.Node<E>> factory) {
      ...
      SingleConsumerQueue.Node<E> node = new SingleConsumerQueue.Node<>(null);
   ...
   public static <E> SingleConsumerQueue<E> optimistic() {
      Function<E, SingleConsumerQueue.Node<E>> factory = (Function<E, SingleConsumerQueue.Node<E>>)OPTIMISIC;
   ...
   public boolean offer(E e) {
      ...
      SingleConsumerQueue.Node<E> node = this.factory.apply(e);
   ...
   void append(SingleConsumerQueue.@NonNull Node<E> first, SingleConsumerQueue.@NonNull Node<E> last) {
      while (true) {
         SingleConsumerQueue.Node<E> t = this.tail;
   ...
   SingleConsumerQueue.@Nullable Node<E> transferOrCombine(SingleConsumerQueue.@NonNull Node<E> first, SingleConsumerQueue.Node<E> last) {
      int index = index();
      AtomicReference<SingleConsumerQueue.Node<E>> slot = this.arena[index];

      while (true) {
         SingleConsumerQueue.Node<E> found = slot.get();
         if (found == null) {
   ...
   static <E> SingleConsumerQueue.@NonNull Node<E> findLast(SingleConsumerQueue.@NonNull Node<E> node) {
   ...
   static class Node<E> {
      ...
      @Nullable E value;
      volatile SingleConsumerQueue.@Nullable Node<E> next;

      Node(@Nullable E value) {
         this.value = value;
      }

      SingleConsumerQueue.@Nullable Node<E> getNextRelaxed() {
         return (SingleConsumerQueue.Node<E>)UnsafeAccess.UNSAFE.getObject(this, NEXT_OFFSET);
      }

      void lazySetNext(SingleConsumerQueue.@Nullable Node<E> newNext) {
