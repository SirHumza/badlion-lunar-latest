...
public class Matrix4f implements Externalizable, Matrix4fc {
   ...
   public Matrix4f invertPerspective(Matrix4f dest) {
      ...
      return dest.set(this.m11 * a, 0.0F, 0.0F, 0.0F, 0.0F, this.m00 * a, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -this.m23 * l, 0.0F, 0.0F, -this.m32 * l, this.m22 * l)
         ._properties(0);
   }
   ...
   public Matrix4f invertOrtho(Matrix4f dest) {
      ...
      return dest.set(
            invM00, 0.0F, 0.0F, 0.0F, 0.0F, invM11, 0.0F, 0.0F, 0.0F, 0.0F, invM22, 0.0F, -this.m30 * invM00, -this.m31 * invM11, -this.m32 * invM22, 1.0F
         )
   ...
   public Matrix4f scaleAround(float sx, float sy, float sz, float ox, float oy, float oz, Matrix4f dest) {
      ...
      return dest._m00(this.m00 * sx)
         ...
         ._m22(this.m22 * sz)
         ._m23(this.m23 * sz)
         ._m30(-this.m00 * ox - this.m10 * oy - this.m20 * oz + nm30)
         ._m31(-this.m01 * ox - this.m11 * oy - this.m21 * oz + nm31)
         ._m32(-this.m02 * ox - this.m12 * oy - this.m22 * oz + nm32)
         ._m33(-this.m03 * ox - this.m13 * oy - this.m23 * oz + nm33)
         ._properties(this.properties & ~(13 | (one ? 0 : 16)));
   }
   ...
   private Matrix4f rotateXInternal(float ang, Matrix4f dest) {
      ...
      float lm22 = this.m22;
      float lm23 = this.m23;
      return dest._m20(lm10 * -sin + lm20 * cos)
   ...
   private Matrix4f rotateYInternal(float ang, Matrix4f dest) {
      ...
      return dest._m20(this.m00 * sin + this.m20 * cos)
         ._m21(this.m01 * sin + this.m21 * cos)
         ._m22(this.m02 * sin + this.m22 * cos)
         ._m23(this.m03 * sin + this.m23 * cos)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4f rotateTowardsXY(float dirX, float dirY, Matrix4f dest) {
      ...
      return dest._m10(this.m00 * -dirX + this.m10 * dirY)
         ._m11(this.m01 * -dirX + this.m11 * dirY)
         ._m12(this.m02 * -dirX + this.m12 * dirY)
         ._m13(this.m03 * -dirX + this.m13 * dirY)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   private Matrix4f rotateXYZInternal(float angleX, float angleY, float angleZ, Matrix4f dest) {
      ...
      return dest._m20(this.m00 * sinY + nm20 * cosY)
