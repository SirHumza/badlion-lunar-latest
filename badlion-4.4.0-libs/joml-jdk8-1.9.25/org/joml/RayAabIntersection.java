...
public class RayAabIntersection {
   ...
   private static int signum(float f) {
      return f != 0.0F && !Float.isNaN(f) ? (1 - Float.floatToIntBits(f) >>> 31 << 1) - 1 : 0;
   }
   ...
   private void precomputeSlope() {
      ...
      int sgnX = signum(this.dirX);
      int sgnY = signum(this.dirY);
      int sgnZ = signum(this.dirZ);
   ...
   private boolean MMM(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX >= minX
         && this.originY >= minY
         && this.originZ >= minZ
         && this.s_xy * minX - maxY + this.c_xy <= 0.0F
         && this.s_yx * minY - maxX + this.c_yx <= 0.0F
         && this.s_zy * minZ - maxY + this.c_zy <= 0.0F
         && this.s_yz * minY - maxZ + this.c_yz <= 0.0F
         && this.s_xz * minX - maxZ + this.c_xz <= 0.0F
         && this.s_zx * minZ - maxX + this.c_zx <= 0.0F;
   }
   ...
   private boolean PMM(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX <= maxX
         && this.originY >= minY
         && this.originZ >= minZ
         && this.s_xy * maxX - maxY + this.c_xy <= 0.0F
         && this.s_yx * minY - minX + this.c_yx >= 0.0F
         && this.s_zy * minZ - maxY + this.c_zy <= 0.0F
         && this.s_yz * minY - maxZ + this.c_yz <= 0.0F
         && this.s_xz * maxX - maxZ + this.c_xz <= 0.0F
         && this.s_zx * minZ - minX + this.c_zx >= 0.0F;
   }

   private boolean MOM(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originY >= minY
         && this.originY <= maxY
         && this.originX >= minX
         && this.originZ >= minZ
         && this.s_xz * minX - maxZ + this.c_xz <= 0.0F
   ...
   private boolean MPM(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX >= minX
         && this.originY <= maxY
         && this.originZ >= minZ
         && this.s_xy * minX - minY + this.c_xy >= 0.0F
         && this.s_yx * maxY - maxX + this.c_yx <= 0.0F
         && this.s_zy * minZ - minY + this.c_zy >= 0.0F
         && this.s_yz * maxY - maxZ + this.c_yz <= 0.0F
         && this.s_xz * minX - maxZ + this.c_xz <= 0.0F
         && this.s_zx * minZ - maxX + this.c_zx <= 0.0F;
   }
   ...
   private boolean PPM(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX <= maxX
         && this.originY <= maxY
         && this.originZ >= minZ
         && this.s_xy * maxX - minY + this.c_xy >= 0.0F
         && this.s_yx * maxY - minX + this.c_yx >= 0.0F
         && this.s_zy * minZ - minY + this.c_zy >= 0.0F
         && this.s_yz * maxY - maxZ + this.c_yz <= 0.0F
         && this.s_xz * maxX - maxZ + this.c_xz <= 0.0F
         && this.s_zx * minZ - minX + this.c_zx >= 0.0F;
   ...
   private boolean MMP(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX >= minX
         ...
         && this.s_xy * minX - maxY + this.c_xy <= 0.0F
         && this.s_yx * minY - maxX + this.c_yx <= 0.0F
         && this.s_zy * maxZ - maxY + this.c_zy <= 0.0F
         && this.s_yz * minY - minZ + this.c_yz >= 0.0F
         && this.s_xz * minX - minZ + this.c_xz >= 0.0F
         && this.s_zx * maxZ - maxX + this.c_zx <= 0.0F;
   }
   ...
   private boolean PMP(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX <= maxX
         ...
         && this.s_zy * maxZ - maxY + this.c_zy <= 0.0F
         && this.s_yz * minY - minZ + this.c_yz >= 0.0F
         && this.s_xz * maxX - minZ + this.c_xz >= 0.0F
         && this.s_zx * maxZ - minX + this.c_zx >= 0.0F;
   }
   ...
   private boolean MPP(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.originX >= minX
         ...
         && this.s_xy * minX - minY + this.c_xy >= 0.0F
         && this.s_yx * maxY - maxX + this.c_yx <= 0.0F
         && this.s_zy * maxZ - minY + this.c_zy >= 0.0F
         && this.s_yz * maxY - minZ + this.c_yz >= 0.0F
         && this.s_xz * minX - minZ + this.c_xz >= 0.0F
         && this.s_zx * maxZ - maxX + this.c_zx <= 0.0F;
   }
