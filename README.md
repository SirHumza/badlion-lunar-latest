...
| `batmod-installer/` | Decompiled installer (230 `.java`, entry `com.batmod.installer.Main`) + version manifest `version.json` (`id: BatMod`, vanilla 1.8 manifest shape, mainClass `net.minecraft.client.main.Main`). | `static.batmod.com/BatMod_Installer.jar` (798K) via `dl.batmod.com/go/download.php`, `dl.batmod.com/json/` | 239 |
