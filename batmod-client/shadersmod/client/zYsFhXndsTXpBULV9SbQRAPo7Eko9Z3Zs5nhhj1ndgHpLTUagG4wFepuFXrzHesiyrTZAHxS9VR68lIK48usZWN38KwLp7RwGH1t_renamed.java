...
public class InstallationLogger {
   static void BatModClient(float[] var0, float[] var1, float[] var2) {
   ...
   static void Button(float[] var0, float[] var1, float[] var2) {
   ...
   static void BatModClient(float[] var0, float[] var1) {
