...
public class Elbw9xBVk4Qxfnd5Ur6Zq208KqGbhYVgIsF1954bvR36rKWyYNdpF0uhBOp0dTgjtNPJHO7cYBEQhP16R1fUOFDQnHZxyvHxvKrH extends ByteToMessageDecoder {
   private final Inflater Vv68OIsnGeRqNfkWrhZ5USpiBlL6J6vQzYtytK46tvCioEQQMZcScI0HTaPI2crSli4YOR7j9Ki8oHHVOSkyhwKiCE22LhzzQg9I;
   ...
   public Elbw9xBVk4Qxfnd5Ur6Zq208KqGbhYVgIsF1954bvR36rKWyYNdpF0uhBOp0dTgjtNPJHO7cYBEQhP16R1fUOFDQnHZxyvHxvKrH(int var1) {
      ...
      this.Vv68OIsnGeRqNfkWrhZ5USpiBlL6J6vQzYtytK46tvCioEQQMZcScI0HTaPI2crSli4YOR7j9Ki8oHHVOSkyhwKiCE22LhzzQg9I = new Inflater();
   }
   ...
   protected void decode(ChannelHandlerContext var1, ByteBuf var2, List var3) {
      if (var2.readableBytes() != 0) {
         ...
         int var5 = var4.PMXj5cVzikOoAj6rXar9iuqRUvVsGZW5QkewwwasFBwKChzIbRifUEsJ1VyOgk4IaXktI6jr1braKR7tmjxMnghfQfQ7P5LNjT4u();
         if (var5 == 0) {
            var3.add(var4.readBytes(var4.readableBytes()));
         } else {
            if (var5 < this.BCAr50JktY88bne3gKpPhCi2ojs9Qz9CtuZ5qY1yf6DHnlHQpJN8xerjZR0doZLmrPDpizrnL5MVJWMiFh9rjXh2hU5qvQF1gSfW) {
            ...
            var4.readBytes(var6);
            this.Vv68OIsnGeRqNfkWrhZ5USpiBlL6J6vQzYtytK46tvCioEQQMZcScI0HTaPI2crSli4YOR7j9Ki8oHHVOSkyhwKiCE22LhzzQg9I.setInput(var6);
            byte[] var7 = new byte[var5];
            this.Vv68OIsnGeRqNfkWrhZ5USpiBlL6J6vQzYtytK46tvCioEQQMZcScI0HTaPI2crSli4YOR7j9Ki8oHHVOSkyhwKiCE22LhzzQg9I.inflate(var7);
            var3.add(Unpooled.wrappedBuffer(var7));
            this.Vv68OIsnGeRqNfkWrhZ5USpiBlL6J6vQzYtytK46tvCioEQQMZcScI0HTaPI2crSli4YOR7j9Ki8oHHVOSkyhwKiCE22LhzzQg9I.reset();
         }
      }
   }
