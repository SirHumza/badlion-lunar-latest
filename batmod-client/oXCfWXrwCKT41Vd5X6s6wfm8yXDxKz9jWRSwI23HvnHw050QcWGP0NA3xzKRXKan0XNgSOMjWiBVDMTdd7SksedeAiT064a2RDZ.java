...
public class oXCfWXrwCKT41Vd5X6s6wfm8yXDxKz9jWRSwI23HvnHw050QcWGP0NA3xzKRXKan0XNgSOMjWiBVDMTdd7SksedeAiT064a2RDZ
   ...
   public void BatModClient(
      ...
      if (var2.length == 1 && var2[0].length() > 0) {
         ...
         GameProfile var4 = var3.AFZqwomB5IiIT5JcKtpFSLwJ0DUWrsDs2kcs3HqwmJXrB1Q2GCH2a6QYnXWLNJMRsyseQaZzgaog9wGINziifkVRBArINmlyLYF()
            .BatModProgressBar()
            .BatModClient(var2[0]);
         if (var4 == null) {
            throw new idU6cKQRpAnHtyqFJvIb8hgPBjjUUYm6Ct9OSY6MQwB6XkEuP0uiQvo9DXNj2Csz9ZA9mb0z6YBVCZ72LpS1AOo81K4Sr2SCh9XO("commands.unban.failed", var2[0]);
         }

         var3.AFZqwomB5IiIT5JcKtpFSLwJ0DUWrsDs2kcs3HqwmJXrB1Q2GCH2a6QYnXWLNJMRsyseQaZzgaog9wGINziifkVRBArINmlyLYF()
            .BatModProgressBar()
            .Button(var4);
         BatModClient(var1, this, "commands.unban.success", var2[0]);
      } else {
         throw new m3HVDEgP6dYA382GFteMKpaMG7yUVYEpeBIGa3zbEv4DkMX3EussLqDIoVRAWefGOelpwaGnFy2F6oVItpSoWKX268BmmDfUP35k("commands.unban.usage");
      }
   }
