...
public class vphUrnh98xLudN5HSO36Mg1NeLo6iMGHXeBJODlR0dXu1Iy4QBCNdQaRBKdgHi8eTPXzkTfx7fGnqf94Zku3AAWUqmNv6ZIg8pgJ {
   ...
   public static YuzfeXjeTK1T00vprZ5Ne0pbh8PiCRpNIxWseM8J5H635vwMw61pRxBVyA583AeqHHKDCmFTPf52sWq6aX7W62BMh6dFjmyF3IUm BatModClient(
      ...
      } else if (Button(var0) != 1) {
         throw new HZtPxJrE3tKmOInnCUZK402OcWQWFuA0NZ7h8121Fc28S0nohPsJXwnJCBUuu5KLWL0pZY44OdjiThLKL4KVW3fY32YFUApRcZ7a(
            "Encountered multiple top tags, only one expected"
         );
      } else {
         return (YuzfeXjeTK1T00vprZ5Ne0pbh8PiCRpNIxWseM8J5H635vwMw61pRxBVyA583AeqHHKDCmFTPf52sWq6aX7W62BMh6dFjmyF3IUm)BatModClient(
               "tag", var0
            )
            .BatModClient();
      }
   ...
   static h591mukmiLr0vJDKnnXtNoDvOBDLG8uMU7FdnK6kMpQ2SvXfMCHeD5FbacfP3NzAtSAQvZlMSmIl5E7OLWgKHmpMSplYTcSbD1uk BatModClient(
      String... var0
   ) {
      return BatModClient(var0[0], var0[1]);
   }
   ...
   static h591mukmiLr0vJDKnnXtNoDvOBDLG8uMU7FdnK6kMpQ2SvXfMCHeD5FbacfP3NzAtSAQvZlMSmIl5E7OLWgKHmpMSplYTcSbD1uk BatModClient(
      ...
      if (var1.startsWith("{")) {
         ...
         while (var1.length() > 0) {
            String var9 = Button(var1, true);
            if (var9.length() > 0) {
               boolean var11 = false;
               var8.Button
                  .add(BatModClient(var9, var11));
            }
         ...
         while (var1.length() > 0) {
            String var3 = Button(var1, false);
            if (var3.length() > 0) {
               boolean var4 = true;
               var2.Button
                  .add(BatModClient(var3, var4));
            }
   ...
   private static h591mukmiLr0vJDKnnXtNoDvOBDLG8uMU7FdnK6kMpQ2SvXfMCHeD5FbacfP3NzAtSAQvZlMSmIl5E7OLWgKHmpMSplYTcSbD1uk BatModClient(
      String var0, boolean var1
   ) {
      String var2 = CustomSpinner(var0, var1);
      String var3 = ButtonAction(var0, var1);
      return BatModClient(var2, var3);
   }

   private static String Button(String var0, boolean var1) {
      int var2 = BatModClient(var0, ':');
      int var3 = BatModClient(var0, ',');
      if (var1) {
         if (var2 == -1) {
            throw new HZtPxJrE3tKmOInnCUZK402OcWQWFuA0NZ7h8121Fc28S0nohPsJXwnJCBUuu5KLWL0pZY44OdjiThLKL4KVW3fY32YFUApRcZ7a(
   ...
   private static String CustomSpinner(String var0, boolean var1) {
      if (var1) {
         var0 = var0.trim();
   ...
   private static String ButtonAction(String var0, boolean var1) {
      if (var1) {
         var0 = var0.trim();
         if (var0.startsWith("{") || var0.startsWith("[")) {
            return var0;
   ...
   private static int BatModClient(String var0, char var1) {
      int var2 = 0;
      boolean var3 = true;
   ...
   private static boolean Button(String var0, int var1) {
      return var1 > 0
         && var0.charAt(var1 - 1) == '\\'
         && !Button(var0, var1 - 1);
   }
