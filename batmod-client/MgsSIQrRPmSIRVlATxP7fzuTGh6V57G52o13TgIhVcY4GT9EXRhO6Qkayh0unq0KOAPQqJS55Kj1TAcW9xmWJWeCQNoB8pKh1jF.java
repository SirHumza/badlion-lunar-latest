...
public class MgsSIQrRPmSIRVlATxP7fzuTGh6V57G52o13TgIhVcY4GT9EXRhO6Qkayh0unq0KOAPQqJS55Kj1TAcW9xmWJWeCQNoB8pKh1jF
   ...
   public void BatModClient(
      ...
      iL9DMubSJAcTZxqaOwpybtlSRVLtmD9ZvxkTuVp126kpYWECDLGjfieR0jHXh8lhKYz1pOKOXVv54oy1hzwdxFmcVWt5UJgpSRT var3 = this.ButtonAction();
      if (var2[0].equals("set")) {
         ...
         double var4 = var3.IntegerSpinner();
         double var6 = BatModClient(var2[1], (double)1.0, (double)6.0E7);
         long var8 = var2.length > 2
            ? BatModClient(var2[2], (long)0L, (long)9223372036854775L)
               * 1000L
            : 0L;
         if (var8 > 0L) {
            var3.BatModClient(var4, var6, var8);
            if (var4 > var6) {
               BatModClient(
                  var1,
                  this,
         ...
         double var10 = var3.BatModProgressBar();
         double var18 = var10
            + BatModClient(
               var2[1], (double)(-var10), (double)(6.0E7 - var10)
            );
         long var21 = var3.ColorChooser()
            + (
               var2.length > 2
                  ? BatModClient(
         ...
         if (var21 > 0L) {
            var3.BatModClient(var10, var18, var21);
            if (var10 > var18) {
               BatModClient(
                  var1,
                  this,
         ...
         double var5 = Button(
            var11.BatModProgressBar() + 0.5, var2[1], true
         );
         double var7 = Button(
            var11.IntegerSpinner() + 0.5, var2[2], true
         );
         var3.Button(var5, var7);
         BatModClient(
         ...
         if (var2[1].equals("buffer")) {
            ...
            double var12 = BatModClient(var2[2], (double)0.0);
            double var19 = var3.BatModInstallerMain();
            var3.Button(var12);
            BatModClient(
         ...
         int var14 = BatModClient(var2[2], 0);
   ...
   protected iL9DMubSJAcTZxqaOwpybtlSRVLtmD9ZvxkTuVp126kpYWECDLGjfieR0jHXh8lhKYz1pOKOXVv54oy1hzwdxFmcVWt5UJgpSRT ButtonAction() {
