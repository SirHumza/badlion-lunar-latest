...
public class qet9KQdnuVvtah1lMA9kEuVDtbGwXWauLJ70OBmknIYuQk5da96aUg1XY1Z64Epkq27H2fALbpXgE6h3iSB9ccwMg1l28L7zvCn0 extends ChannelInboundHandlerAdapter {
   ...
   private H7AwzqscESAKgDPLoVx0nkIjZF3utHvtFMaN5NJuEsFBjPwsCVwjgisF7D13E4SIBOejWLIDgi6DohTnZia8mONR2im7Mh55kzY Button;
   ...
   public void channelRead(ChannelHandlerContext var1, Object var2) {
      ...
      try {
         if (var3.readUnsignedByte() == 254) {
            ...
            TDI1rwhE6ftgpT0jnIkLxDzDc0kfx23fe5G5xeWfGWo1r95rLIJvkBpIvia4qynITY7zhShMOxrj3sgpclCo8KBYm5raxCQbPjtD var6 = this.Button
               .ButtonAction();
            ...
            switch (var7) {
               ...
               default:
                  ...
                  ByteBuf var13 = this.BatModClient(var12);

                  try {
                     this.BatModClient(var1, var13);
                  } finally {
                     var13.release();
                  }
            }
   ...
   private void BatModClient(ChannelHandlerContext var1, ByteBuf var2) {
      var1.pipeline().firstContext().writeAndFlush(var2).addListener(ChannelFutureListener.CLOSE);
   }

   private ByteBuf BatModClient(String var1) {
