...
public enum CountryCode {
   UNDEFINED("Undefined", null, -1, CountryCode.Assignment.USER_ASSIGNED) {
      @Override
   ...
   EA("Ceuta, Melilla", null, -1, CountryCode.Assignment.EXCEPTIONALLY_RESERVED),
   ...
   EU("European Union", null, -1, CountryCode.Assignment.EXCEPTIONALLY_RESERVED),
   EZ("Eurozone", null, -1, CountryCode.Assignment.EXCEPTIONALLY_RESERVED),
   ...
   IC("Canary Islands", null, -1, CountryCode.Assignment.EXCEPTIONALLY_RESERVED),
   ...
   UK("United Kingdom", null, 826, CountryCode.Assignment.EXCEPTIONALLY_RESERVED) {
      @Override
      public Locale toLocale() {
         return Locale.UK;
      }
   ...
   CountryCode(String name, String alpha3, int numeric, CountryCode.Assignment assignment) {
      this.name = name;
      this.alpha3 = alpha3;
   ...
   public static CountryCode getByCode(int code) {
      return code <= 0 ? null : numericMap.get(code);
   }
