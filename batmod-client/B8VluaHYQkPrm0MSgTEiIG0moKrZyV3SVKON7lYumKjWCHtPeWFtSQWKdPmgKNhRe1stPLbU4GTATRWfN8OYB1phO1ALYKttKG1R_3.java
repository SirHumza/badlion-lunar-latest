public class Qm1z4YztGtx5vcQIuZAWMovPR6QjI3WgLMPGFjaaWgAhnPRtlgZWAkczYjwkMx5TCa8iybFby6UDIDiZU8nHbxmcurgwVJ92oN98
   extends lLtIdTHPn95IaShFmaMaUWBmhkYF5cU0Rl39AfGh1zkuInd4yKtwlUfYMlpiQGjbxwqFvM1JXedDGKbjoKKmsetbespzSvjOrMB4 {
   private B8VluaHYQkPrm0MSgTEiIG0moKrZyV3SVKON7lYumKjWCHtPeWFtSQWKdPmgKNhRe1stPLbU4GTATRWfN8OYB1phO1ALYKttKG1R BatModClient;

   protected Qm1z4YztGtx5vcQIuZAWMovPR6QjI3WgLMPGFjaaWgAhnPRtlgZWAkczYjwkMx5TCa8iybFby6UDIDiZU8nHbxmcurgwVJ92oN98(
   ...
   public void aHV8Pc8fKaYoTFVjg5nNPReU6wuKOE57VLPQA1JDXf6oEySyuPy65TWgIpLNrB3svE7ygGUPECsf6pZWPobt6CeAnVJt70ekjPGA() {
      ...
      if (this.BatModClient == null) {
         ZtyM8qo9IZpZIVkcj0FAny1WT8jpiZ6oXSvx5U2ex48ZOwaVCiixFwuKSJWN3XJyiKYTaMnvvxdh6ZMCsHgByvXMbZ3gbg5F0ePF var1 = new ZtyM8qo9IZpZIVkcj0FAny1WT8jpiZ6oXSvx5U2ex48ZOwaVCiixFwuKSJWN3XJyiKYTaMnvvxdh6ZMCsHgByvXMbZ3gbg5F0ePF(
   ...
   public void BatModClient(
      ...
      if (this.BatModClient != null) {
         fDy4F0oyD7SbTL7tPfQwCtq7gvYpu4JMtNRgYVmbHJh4WxX1qytXhVuNou0SaGcmQzdRXEfSFUmX4jmJTtlRqj1eUh9RwGtGQBKa var9 = AKnHvCEvff0plRZMvivJHI1Y16hUOHf1ple94i52Q2QOBbkkTa9CdhlfxOJQmuqBGcGc4Btt3nXUKX1ypstf7VYEhFEpOcflQPhB.BatModJson()
         ...
         float var11 = (this.Checkbox + var3)
            / this.ProgressBar;
         ...
         net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.CustomSpinner(
            1.0F, 1.0F, 1.0F, var13
         );
         net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
            0.0F, 1.8F, 0.0F
         );
         net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
            180.0F - var2.OVft42XaDrpCid053XFq1EPZ8CkxDYortlwtRX4zTf4L5KT5wFCJrMIQs1I0or0K1OcKP82y3PpnybjZEMRPyyEezZIs1zuJDGFF, 0.0F, 1.0F, 0.0F
         );
         net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
            60.0F - 150.0F * var11 - var2.f4NjjuH3UAaMkYDKg4JjKVIV1PiNsOM4T4HUFyWQ5CaEXleTtHn67zbCvMaD8qyMLvZeLv4QkzyMQOIJpmOQimLZV283D81hMfb, 1.0F, 0.0F, 0.0F
         );
         net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
            0.0F, -0.4F, -1.5F
         );
         ...
         this.BatModClient.OVft42XaDrpCid053XFq1EPZ8CkxDYortlwtRX4zTf4L5KT5wFCJrMIQs1I0or0K1OcKP82y3PpnybjZEMRPyyEezZIs1zuJDGFF = this.BatModClient
            .fDoAJ9W9bXAT89550qV528PlQ3xBSnLnpyVbFpWqc5e8BN9pOqCYta3tS7TuKU1dJl7tt01b3fzVmBCmYvz5SizTFbmamdEnbpee = 0.0F;
         this.BatModClient.wX3R7BkV4rlSinjJGAkKzn2yEOJbq8aj8GAK5ELavlGRCoE6oBVtZlLxNm4q45YujY9xSJNINuti8I7BNZobS1sk7Ejc0kAcjA68 = this.BatModClient
            .hSMlYe7503LeA7CbbVALz1jC9M8HB8zgNQY4LHkAnfyLgjvXzBsumpLcUY5Rcsl1recYw4lCY6oIVOA5xVfKlGQzbM1m6WJ9Zuae = 0.0F;
         var9.BatModClient(
            this.BatModClient, 0.0, 0.0, 0.0, 0.0F, var3
         );
