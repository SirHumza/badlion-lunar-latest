public class dt07SENgVRvaPktkICvskOFunX0tIr9XQB0hQ3E0BIQHMSvng8hk1uQBWaCdJn9tpvTQVhsrGIzHIDjj4ATqcz082JkxdWR9IgR6
   extends OSCLZ4VlBH73tntWvn8TXEpuSyAOLl5TQjdinuZ0QQF3cveA3uU83FawVq1n6eca50SpgAdgtXbxnKkjl6MF6vQNbeY84pnGUFD {
   private boolean BatModClient = false;

   public dt07SENgVRvaPktkICvskOFunX0tIr9XQB0hQ3E0BIQHMSvng8hk1uQBWaCdJn9tpvTQVhsrGIzHIDjj4ATqcz082JkxdWR9IgR6(
      AKnHvCEvff0plRZMvivJHI1Y16hUOHf1ple94i52Q2QOBbkkTa9CdhlfxOJQmuqBGcGc4Btt3nXUKX1ypstf7VYEhFEpOcflQPhB var1,
      sYESI7x8PrBOF8pwN0WBJg1JhCvRljufbvVxDX5I3tc9M9KZgVQC1Afn4IlG8PRFnSra0FuIn16DivLeZEZE76Zi62xWREluDJYu var2
   ) {
      super(var1, var2);
   }
   ...
   public boolean Button(
      ...
      boolean var3 = super.Button(var1, var2);
   ...
   public boolean CustomSpinner(
      ...
      this.BatModClient = true;
      boolean var3 = super.CustomSpinner(var1, var2);
      this.BatModClient = false;
      return var3;
   }
   ...
   public boolean BatModClient(
      ...
      this.BatModClient = true;
      boolean var4 = super.BatModClient(var1, var2, var3);
      this.BatModClient = false;
      return var4;
   }
   ...
   @Override
   public boolean BatModClient(
      jBb4iOy4W9C3gprH1KDK0WJXBox5IsCBRN7MdvIFV8k37cgHtwqw5spPpwei9zItAyFEbxftKtQCumw2TcwnhdJUQU1XGYqff3xm var1,
      NteFd9HVJdwzXTrwPP9DzZdYpirUKP5pYzkC03lPx8N7W97p10Vq9iIcaWkKXAqVMB9lsyaG8A1eVjg3qfvn4o4eKR9hXeM56nBP var2,
      k33yhS54VsUaLK6nSB7INIBmgwLgC1mJf55Nusrui954a0w74ZkYHHNokvenOdo4c65vY3YxmJit097jtJ6TFLqqeS5AarwF7q65 var3,
      ...
      qBIxC0AeCV9CVk1xko5Fd3619M30uxk84gK7ODtvoVZLg61w7Dg9edsCfVS3NGSZ1H2yJqQahNe93sMnJ3IwzcwzWHm14IwRhSuD var6
   ) {
      this.BatModClient = true;
      boolean var7 = super.BatModClient(
