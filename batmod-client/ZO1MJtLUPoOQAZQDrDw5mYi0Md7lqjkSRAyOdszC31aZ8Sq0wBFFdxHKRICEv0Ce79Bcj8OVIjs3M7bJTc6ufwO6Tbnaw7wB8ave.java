...
public class ZO1MJtLUPoOQAZQDrDw5mYi0Md7lqjkSRAyOdszC31aZ8Sq0wBFFdxHKRICEv0Ce79Bcj8OVIjs3M7bJTc6ufwO6Tbnaw7wB8ave
   ...
   public void BatModClient(
      ...
      if (var2.length > 0 && var2[0].length() > 1) {
         egrlsF9YBDE494kTMhcXRiqL0F080ROxFyXFfM4tZeSuBymTYidxgV9U46ETOgmOl6o7fcTjvJJZYFHDlzMo8NBn47mncTnDrmRS var3 = TDI1rwhE6ftgpT0jnIkLxDzDc0kfx23fe5G5xeWfGWo1r95rLIJvkBpIvia4qynITY7zhShMOxrj3sgpclCo8KBYm5raxCQbPjtD.KJBpBZrx7SYvQE6hwF79jvgDw9Qlz9lGaNqke5SLNyatfks2bDEP2RzrTdcCxGBVUCKpMn0F6Yj3QA8UgwBq9umx3CDU4lw8R1rQ()
         ...
         if (var5) {
            BatModClient(
               var1, this, "commands.kick.success.reason", var3.C_(), var4
            );
         } else {
            BatModClient(var1, this, "commands.kick.success", var3.C_());
         }
      } else {
         throw new m3HVDEgP6dYA382GFteMKpaMG7yUVYEpeBIGa3zbEv4DkMX3EussLqDIoVRAWefGOelpwaGnFy2F6oVItpSoWKX268BmmDfUP35k("commands.kick.usage");
      }
   }
