...
public class BatModProgressBar
   ...
   public void BatModClient(
      GSr3Jw5qpb7VmQBoXXlVZ9gFJna7gGZ3fKMS6oCfh90ptW53xZYrHvhTttRO6x0t6uGUBrSurSAosk0xWErg4YSWIsUkFEYFZQiS var1,
      float var2,
      float var3,
      float var4,
      float var5,
      ...
      if (var1.D1k6enCWuCdM0dAQzAzkA1PTH11O24d6G8TJ5jSTut4YCRhe9fq7Oszp7PTxWgby8VG8RFG58cvpXHH5b5XYwPgwuYOrM1E5UlKt > 0) {
         ...
         float var11 = (var1.D1k6enCWuCdM0dAQzAzkA1PTH11O24d6G8TJ5jSTut4YCRhe9fq7Oszp7PTxWgby8VG8RFG58cvpXHH5b5XYwPgwuYOrM1E5UlKt + var4) / 200.0F;
         float var12 = 0.0F;
         if (var11 > 0.8F) {
         ...
         for (int var14 = 0; var14 < (var11 + var11 * var11) / 2.0F * 60.0F; var14++) {
            net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
               var13.nextFloat() * 360.0F, 1.0F, 0.0F, 0.0F
            );
            net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
               var13.nextFloat() * 360.0F, 0.0F, 1.0F, 0.0F
            );
            net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
               var13.nextFloat() * 360.0F, 0.0F, 0.0F, 1.0F
            );
            net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
               var13.nextFloat() * 360.0F, 1.0F, 0.0F, 0.0F
            );
            ...
            net.minecraft.client.renderer.z9XArWABEqRRKMkN8RxcNAPyZ3rqye0J7ObmPJZOV3a3QxwGkekbC4XPNvly0sMMXUMhsGrJQsUrRONf93Yw0SNKiIme3EpGeO2m.Button(
               var13.nextFloat() * 360.0F + var11 * 90.0F, 0.0F, 0.0F, 1.0F
            );
            ...
            var10.Button(0.0, 0.0, 0.0)
               .Button(
                  255, 255, 255, (int)(255.0F * (1.0F - var12))
               )
               .Spinner();
            var10.Button(-0.866 * var16, var15, -0.5F * var16)
               .Button(255, 0, 255, 0)
               .Spinner();
            var10.Button(0.866 * var16, var15, -0.5F * var16)
               .Button(255, 0, 255, 0)
               .Spinner();
            var10.Button(0.0, var15, 1.0F * var16)
               .Button(255, 0, 255, 0)
               .Spinner();
            var10.Button(-0.866 * var16, var15, -0.5F * var16)
               .Button(255, 0, 255, 0)
