...
public class h42cN9gxl5HmyOrNTMH0Jfku6tvZTVo1gCTT9hCH1cinuv3ulGBs837d69fWywLa5NXF2ynvmX9gXprO9C9fE2nO6TtDHxgbKHuR
   ...
   public void BatModClient(
      ...
      if (var2.length >= 1 && var2[0].length() > 0) {
         ...
         GameProfile var4 = var3.H5AfuPi6A5dR1CMugDXgAoLQyJOF06VOkDTd7xZhA4PQTQa65SGEWInSjIFDT4he5MqClJs80ceNMzYDIqSK0srjcdqq9co84vr()
            .BatModClient(var2[0]);
         if (var4 == null) {
            throw new idU6cKQRpAnHtyqFJvIb8hgPBjjUUYm6Ct9OSY6MQwB6XkEuP0uiQvo9DXNj2Csz9ZA9mb0z6YBVCZ72LpS1AOo81K4Sr2SCh9XO("commands.ban.failed", var2[0]);
         }

         String var5 = null;
         if (var2.length >= 2) {
            var5 = BatModClient(var1, var2, 1)
               .BatModProgressBar();
         }

         hDM28ZquUeShDo4n4jcDPlQKOS0yKGD9MMxyswNxXaV7MMCWIkqFu3u4xkCPbRCqdTMVFYUogqgEK20vrtUpCDCqCBGFSAym6Nde var6 = new hDM28ZquUeShDo4n4jcDPlQKOS0yKGD9MMxyswNxXaV7MMCWIkqFu3u4xkCPbRCqdTMVFYUogqgEK20vrtUpCDCqCBGFSAym6Nde(
            var4, (Date)null, var1.C_(), (Date)null, var5
         );
         var3.AFZqwomB5IiIT5JcKtpFSLwJ0DUWrsDs2kcs3HqwmJXrB1Q2GCH2a6QYnXWLNJMRsyseQaZzgaog9wGINziifkVRBArINmlyLYF()
            .BatModProgressBar()
            .BatModClient(var6);
         egrlsF9YBDE494kTMhcXRiqL0F080ROxFyXFfM4tZeSuBymTYidxgV9U46ETOgmOl6o7fcTjvJJZYFHDlzMo8NBn47mncTnDrmRS var7 = var3.AFZqwomB5IiIT5JcKtpFSLwJ0DUWrsDs2kcs3HqwmJXrB1Q2GCH2a6QYnXWLNJMRsyseQaZzgaog9wGINziifkVRBArINmlyLYF()
            .BatModClient(var2[0]);
         if (var7 != null) {
            var7.BatModClient
               .BatModClient("You are banned from this server.");
         }

         BatModClient(var1, this, "commands.ban.success", var2[0]);
      } else {
         throw new m3HVDEgP6dYA382GFteMKpaMG7yUVYEpeBIGa3zbEv4DkMX3EussLqDIoVRAWefGOelpwaGnFy2F6oVItpSoWKX268BmmDfUP35k("commands.ban.usage");
      }
   }
