...
public class MappingWriterSrg extends MappingWriter {
   ...
   public void write(String var1, ObfuscationType var2, IMappingConsumer.MappingSet<MappingField> var3, IMappingConsumer.MappingSet<MappingMethod> var4) {
      if (var1 != null) {
         ...
         try {
            var5 = this.openFileWriter(var1, var2);
            this.writeHeader(var5);
   ...
   protected PrintWriter openFileWriter(String var1, ObfuscationType var2) {
      return this.openFileWriter(var1, var2 + " output SRGs");
   }
   ...
   protected void writeFieldMappings(PrintWriter var1, IMappingConsumer.MappingSet<MappingField> var2) {
      for (IMappingConsumer.MappingSet.Pair var4 : var2) {
   ...
   protected String formatFieldMapping(IMappingConsumer.MappingSet.Pair<MappingField> var1) {
      return String.format(
         "FD: %s/%s %s/%s",
         ((MappingField)var1.from).getOwner(),
         ((MappingField)var1.from).getName(),
         ((MappingField)var1.to).getOwner(),
         ((MappingField)var1.to).getName()
      );
   }
   ...
   protected String formatMethodMapping(IMappingConsumer.MappingSet.Pair<MappingMethod> var1) {
      return String.format(
         "MD: %s %s %s %s",
         ((MappingMethod)var1.from).getName(),
         ((MappingMethod)var1.from).getDesc(),
         ((MappingMethod)var1.to).getName(),
         ((MappingMethod)var1.to).getDesc()
      );
   }
}
