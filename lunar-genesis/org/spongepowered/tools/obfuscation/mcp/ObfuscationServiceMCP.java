...
public class ObfuscationServiceMCP implements IObfuscationService {
   ...
   public Set<String> getSupportedOptions() {
      return ImmutableSet.of("reobfSrgFile", "reobfSrgFiles", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outSrgFile", "outNotchSrgFile");
   }

   @Override
   public Collection<ObfuscationTypeDescriptor> getObfuscationTypes(IMixinAnnotationProcessor var1) {
      ImmutableList.Builder var2 = ImmutableList.builder();
      if (!var1.getOptions("mappingTypes").contains("tsrg")) {
         var2.add(new ObfuscationTypeDescriptor("searge", "reobfSrgFile", "reobfSrgFiles", "outSrgFile", ObfuscationEnvironmentMCP.class));
      }

      var2.add(new ObfuscationTypeDescriptor("notch", "reobfNotchSrgFile", "reobfNotchSrgFiles", "outNotchSrgFile", ObfuscationEnvironmentMCP.class));
      return var2.build();
   }
}
