...
public class MixinObfuscationProcessorTargets extends MixinObfuscationProcessor {
   ...
   private void processShadows(RoundEnvironment var1) {
      for (Element var3 : var1.getElementsAnnotatedWith(Shadow.class)) {
         Element var4 = var3.getEnclosingElement();
         if (!(var4 instanceof TypeElement)) {
            this.mixins.printMessage(IMessagerEx.MessageType.ERROR, "Unexpected parent with type " + TypeUtils.getElementType(var4), var3);
         } else {
            ...
            } else if (var3.getKind() != ElementKind.METHOD && var3.getKind() != ElementKind.CONSTRUCTOR) {
               this.mixins.printMessage(IMessagerEx.MessageType.SHADOW_ON_INVALID_ELEMENT, "Element is not a method or field", var3);
            } else {
   ...
   private void processOverwrites(RoundEnvironment var1) {
      for (Element var3 : var1.getElementsAnnotatedWith(Overwrite.class)) {
         Element var4 = var3.getEnclosingElement();
         if (!(var4 instanceof TypeElement)) {
            this.mixins.printMessage(IMessagerEx.MessageType.ERROR, "Unexpected parent with type " + TypeUtils.getElementType(var4), var3);
            ...
            this.mixins.printMessage(IMessagerEx.MessageType.OVERWRITE_ON_NON_METHOD_ELEMENT, "Element is not a method", var3);
         }
      }
   }

   private void processAccessors(RoundEnvironment var1) {
      for (Element var3 : var1.getElementsAnnotatedWith(Accessor.class)) {
         Element var4 = var3.getEnclosingElement();
         if (!(var4 instanceof TypeElement)) {
            this.mixins.printMessage(IMessagerEx.MessageType.ERROR, "Unexpected parent with type " + TypeUtils.getElementType(var4), var3);
         } else if (var3.getKind() == ElementKind.METHOD) {
            ...
            this.mixins.printMessage(IMessagerEx.MessageType.ACCESSOR_ON_NON_METHOD_ELEMENT, "Element is not a method", var3);
         }
      }
   }

   private void processInvokers(RoundEnvironment var1) {
      for (Element var3 : var1.getElementsAnnotatedWith(Invoker.class)) {
         Element var4 = var3.getEnclosingElement();
         if (!(var4 instanceof TypeElement)) {
            this.mixins.printMessage(IMessagerEx.MessageType.ERROR, "Unexpected parent with type " + TypeUtils.getElementType(var4), var3);
         } else if (var3.getKind() == ElementKind.METHOD) {
   ...
   private void processImplements(RoundEnvironment var1) {
      for (Element var3 : var1.getElementsAnnotatedWith(Implements.class)) {
         if (var3.getKind() != ElementKind.CLASS && var3.getKind() != ElementKind.INTERFACE) {
            this.mixins
               .printMessage(
                  IMessagerEx.MessageType.SOFT_IMPLEMENTS_ON_INVALID_TYPE,
                  "Found an @Implements annotation on an element which is not a class or interface",
                  var3
               );
         } else {
