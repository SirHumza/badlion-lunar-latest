...
final class DefaultDateTypeAdapter implements JsonDeserializer<Date>, JsonSerializer<Date> {
   ...
   public Date deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) {
   ...
   private Date deserializeToDate(JsonElement var1) {
      synchronized (this.localFormat) {
         Date var10;
         try {
            var10 = this.localFormat.parse(var1.getAsString());
         } catch (ParseException var7) {
            try {
               var10 = this.enUsFormat.parse(var1.getAsString());
            } catch (ParseException var6) {
               try {
                  var10 = this.iso8601Format.parse(var1.getAsString());
