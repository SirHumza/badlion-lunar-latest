...
public final class $Gson$Types {
   ...
   public static Type resolve(Type var0, Class<?> var1, Type var2) {
      ...
      if (var2 instanceof Class && ((Class)var2).isArray()) {
         ...
         Class var17 = var13.getComponentType();
         Type var20 = resolve(var0, var1, var17);
         return var17 == var20 ? var13 : arrayOf(var20);
      }

      if (var2 instanceof GenericArrayType) {
         GenericArrayType var12 = (GenericArrayType)var2;
         Type var16 = var12.getGenericComponentType();
         Type var19 = resolve(var0, var1, var16);
         return var16 == var19 ? var12 : arrayOf(var19);
      }

      if (var2 instanceof ParameterizedType) {
         ParameterizedType var11 = (ParameterizedType)var2;
         Type var15 = var11.getOwnerType();
         Type var18 = resolve(var0, var1, var15);
         boolean var22 = var18 != var15;
         ...
         return var22 ? newParameterizedTypeWithOwner(var18, var11.getRawType(), var7) : var11;
         ...
         if (var4.length == 1) {
            Type var6 = resolve(var0, var1, var4[0]);
            if (var6 != var4[0]) {
               return supertypeOf(var6);
            }
         } else if (var5.length == 1) {
            Type var21 = resolve(var0, var1, var5[0]);
            if (var21 != var5[0]) {
               return subtypeOf(var21);
            }
         }
   ...
   private static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
      ...
      public ParameterizedTypeImpl(Type var1, Type var2, Type... var3) {
         if (var2 instanceof Class) {
            ...
            $Gson$Preconditions.checkArgument(var1 != null || var4.getEnclosingClass() == null);
            $Gson$Preconditions.checkArgument(var1 == null || var4.getEnclosingClass() != null);
         }
