...
public class JsonReader implements Closeable {
   ...
   public void beginArray() {
      ...
      if (var1 == 3) {
         ...
         throw new IllegalStateException(
            "Expected BEGIN_ARRAY but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
         );
      }
   }
   ...
   public void beginObject() {
      ...
      if (var1 == 1) {
         ...
         throw new IllegalStateException(
            "Expected BEGIN_OBJECT but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
         );
      }
   }
   ...
   public void endObject() {
      ...
      if (var1 == 2) {
         ...
         throw new IllegalStateException(
            "Expected END_OBJECT but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
         );
      }
   }
   ...
   public String nextString() {
      ...
      if (var1 == 10) {
         ...
         if (var1 != 16) {
            throw new IllegalStateException(
               "Expected a string but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
            );
         }
   ...
   public double nextDouble() {
      ...
      if (this.lenient || !Double.isNaN(var2) && !Double.isInfinite(var2)) {
         ...
         throw new MalformedJsonException("JSON forbids NaN and infinities: " + var2 + " at line " + this.getLineNumber() + " column " + this.getColumnNumber());
      }
   }
   ...
   public long nextLong() {
      ...
      if (var4 != var2) {
         throw new NumberFormatException(
            "Expected a long but was " + this.peekedString + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
         );
      }
   ...
   public int nextInt() {
      ...
      if (var1 == 15) {
         ...
         if (this.peekedLong != var7) {
            throw new NumberFormatException(
               "Expected an int but was " + this.peekedLong + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
            );
         }
         ...
         if (var1 == 16) {
            ...
            if (var1 != 8 && var1 != 9) {
               throw new IllegalStateException(
                  "Expected an int but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
               );
            }
         ...
         if (var2 != var3) {
            throw new NumberFormatException(
               "Expected an int but was " + this.peekedString + " at line " + this.getLineNumber() + " column " + this.getColumnNumber()
            );
         }
   ...
   private boolean skipTo(String var1) {
      while (this.pos + var1.length() <= this.limit || this.fillBuffer(var1.length())) {
   ...
   private IOException syntaxError(String var1) {
      throw new MalformedJsonException(var1 + " at line " + this.getLineNumber() + " column " + this.getColumnNumber());
   }
         ...
         public void promoteNameToValue(JsonReader var1) {
            if (var1 instanceof JsonTreeReader) {
               ...
               if (var2 == 13) {
                  ...
                  if (var2 != 14) {
                     throw new IllegalStateException(
                        "Expected a name but was " + var1.peek() + " " + " at line " + var1.getLineNumber() + " column " + var1.getColumnNumber()
                     );
                  }
