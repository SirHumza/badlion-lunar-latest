...
public class InjectorGroupInfo {
   ...
   public void setMinRequired(int var1) {
      ...
      if (this.minCallbackCount > 0 && this.minCallbackCount != var1) {
         MixinService.getService()
            .getLogger("mixin")
            .warn("Conflicting min value '{}' on @Group({}), previously specified {}", var1, this.name, this.minCallbackCount);
      }
   ...
   public void setMaxAllowed(int var1) {
      ...
      if (this.maxCallbackCount < Integer.MAX_VALUE && this.maxCallbackCount != var1) {
         MixinService.getService()
            .getLogger("mixin")
            .warn("Conflicting max value '{}' on @Group({}), previously specified {}", var1, this.name, this.maxCallbackCount);
      }
   ...
   public InjectorGroupInfo validate() {
      ...
      for (InjectionInfo var3 : this.members) {
         var1 += var3.getInjectedCallbackCount();
      }

      int var5 = this.getMinRequired();
      int var6 = this.getMaxAllowed();
      if (var1 < var5) {
         String var4 = var1 > 0 ? "only " : "";
         throw new InjectionValidationException(this, String.format("expected %d invocation(s) but %s%d succeeded", var5, var4, var1));
      } else if (var1 > var6) {
         throw new InjectionValidationException(this, String.format("maximum of %d invocation(s) allowed but %d succeeded", var6, var1));
      } else {
         return this;
      }
   }
   ...
   public static final class Map extends HashMap<String, InjectorGroupInfo> {
      ...
      public InjectorGroupInfo parseGroup(AnnotationNode var1, String var2) {
         ...
         String var3 = Annotations.getValue(var1, "name");
         if (var3 == null || var3.isEmpty()) {
            var3 = var2;
         }

         InjectorGroupInfo var4 = this.forName(var3);
         Integer var5 = Annotations.getValue(var1, "min");
         if (var5 != null && var5 != -1) {
            var4.setMinRequired(var5);
         }

         Integer var6 = Annotations.getValue(var1, "max");
         if (var6 != null && var6 != -1) {
      ...
      public void validateAll() {
         for (InjectorGroupInfo var2 : this.values()) {
            var2.validate();
         }
      }
   }
