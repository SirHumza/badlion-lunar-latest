...
public final class ConstraintParser {
   ...
   public static ConstraintParser.Constraint parse(String var0) {
      if (var0 != null && var0.length() != 0) {
         String[] var1 = var0.replaceAll("\\s", "").toUpperCase(Locale.ROOT).split(";");
   ...
   public static ConstraintParser.Constraint parse(AnnotationNode var0) {
      String var1 = Annotations.getValue(var0, "constraints", "");
      return parse(var1);
   }
   ...
   public static class Constraint {
      ...
      public void check(ITokenProvider var1) {
         if (this != NONE) {
            ...
            if (var2 < this.min) {
               throw new ConstraintViolationException(
                  "Token '" + this.token + "' has a value (" + var2 + ") which is less than the minimum value " + this.min + " in " + var1, this, var2
               );
            }

            if (var2 > this.max) {
               throw new ConstraintViolationException(
                  "Token '" + this.token + "' has a value (" + var2 + ") which is greater than the maximum value " + this.max + " in " + var1, this, var2
               );
            }
         }
