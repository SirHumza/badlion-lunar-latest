...
public final class VersionNumber implements Serializable, Comparable<VersionNumber> {
   ...
   public short getMinor() {
      return (short)(this.value >> 32 & 32767L);
   }

   public short getPatch() {
      return (short)(this.value >> 16 & 32767L);
   }

   public short getRevision() {
      return (short)(this.value & 32767L);
   }
   ...
   public String toString() {
      ...
      return String.format(
         ...
         var1[0],
         var1[1],
         (this.value & 2147483647L) > 0L ? String.format(".%d", var1[2]) : "",
         (this.value & 32767L) > 0L ? String.format(".%d", var1[3]) : "",
         this.suffix
      );
   }

   public int compareTo(VersionNumber var1) {
      return var1 == null ? 1 : Long.compare(this.value, var1.value);
   }

   @Override
   public boolean equals(Object var1) {
      return !(var1 instanceof VersionNumber) ? false : ((VersionNumber)var1).value == this.value;
   }
   ...
   private static long pack(short... var0) {
      return (long)var0[0] << 48 | (long)var0[1] << 32 | var0[2] << 16 | var0[3];
   }

   private static short[] unpack(long var0) {
      return new short[]{(short)(var0 >> 48), (short)(var0 >> 32 & 32767L), (short)(var0 >> 16 & 32767L), (short)(var0 & 32767L)};
   }
