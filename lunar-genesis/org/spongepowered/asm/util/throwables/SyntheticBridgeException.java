...
public class SyntheticBridgeException extends MixinException {
   ...
   public void printAnalysis(IMixinContext var1, MethodNode var2, MethodNode var3) {
      ...
      String var5 = Annotations.getValue(Annotations.getVisible(var2, MixinMerged.class), "mixin");
      String var6 = var5 != null ? var5 : var1.getTargetClassRef().replace('/', '.');
      this.printMethod(var4.add("Existing method").add().kv("Owner", var6).add(), var2, this.a).hr();
      this.printMethod(var4.add("Incoming method").add().kv("Owner", var1.getClassRef().replace('/', '.')).add(), var3, this.b).hr();
      this.printProblem(var4, var1, var2, var3).print(System.err);
   }

   private PrettyPrinter printMethod(PrettyPrinter var1, MethodNode var2, AbstractInsnNode var3) {
      for (AbstractInsnNode var5 : var2.instructions) {
         var1.kv(var5 == var3 ? ">>>>" : "", Bytecode.describeNode(var5));
      }
      ...
      switch (this.problem) {
         ...
         case BAD_LOAD:
            ...
            for (int var19 = 0; var6.hasNext() && var7.hasNext(); var19++) {
               ...
               if (var20 instanceof VarInsnNode && var21 instanceof VarInsnNode) {
                  ...
                  Type var26 = var23.var > 0 ? var9[var23.var - 1] : var5;
                  var1.kv("Target " + var19, "%8s %-2d %s", Bytecode.getOpcodeName(var22), var22.var, var24);
                  var1.kv("Incoming " + var19, "%8s %-2d %s", Bytecode.getOpcodeName(var23), var23.var, var26);
                  if (var24.equals(var26)) {
                     var1.kv("", "Types match: %s", var24);
                  } else if (var24.getSort() != var26.getSort()) {
                     var1.kv("", "Types are incompatible");
                  } else if (var24.getSort() == 10) {
                     ClassInfo var28 = ClassInfo.getCommonSuperClassOrInterface(var24, var26);
                     var1.kv("", "Common supertype: %s", var28);
                  }
         ...
         case BAD_INVOKE_DESC:
            ...
            if (var14.length != var15.length) {
               ...
               Type var25 = Type.getReturnType(var12.desc);
               Type var27 = Type.getReturnType(var13.desc);
               ...
               this.printTypeComparison(var1, "return type", var25, var27);
