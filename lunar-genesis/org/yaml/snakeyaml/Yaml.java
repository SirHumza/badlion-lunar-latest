...
public class Yaml {
   ...
   public Yaml(DumperOptions var1) {
      this(new Constructor(new LoaderOptions()), new Representer(var1), var1);
   }

   public Yaml(LoaderOptions var1) {
      this(new Constructor(var1), new Representer(new DumperOptions()), new DumperOptions(), var1);
   }

   public Yaml(Representer var1) {
      this(new Constructor(new LoaderOptions()), var1);
   }

   public Yaml(BaseConstructor var1) {
      this(var1, new Representer(new DumperOptions()));
   }
   ...
   public Yaml(Representer var1, DumperOptions var2) {
      this(new Constructor(new LoaderOptions()), var1, var2);
   }

   public Yaml(BaseConstructor var1, Representer var2, DumperOptions var3) {
      this(var1, var2, var3, var1.getLoadingConfig(), new Resolver());
   }
   ...
   public Yaml(BaseConstructor var1, Representer var2, DumperOptions var3, LoaderOptions var4, Resolver var5) {
      ...
      this.constructor.setWrappedToRootException(var4.isWrappedToRootException());
      if (!var3.getIndentWithIndicator() && var3.getIndent() <= var3.getIndicatorIndent()) {
   ...
   public void dump(Object var1, Writer var2) {
      ...
      var3.add(var1);
      this.dumpAll(var3.iterator(), var2, null);
   }
   ...
   public void serialize(Node var1, Writer var2) {
      Serializer var3 = new Serializer(new Emitter(var2, this.dumperOptions), this.resolver, this.dumperOptions, null);
   ...
   public List<Event> serialize(Node var1) {
      ...
      Serializer var3 = new Serializer(var2, this.resolver, this.dumperOptions, null);
   ...
   public <T> T load(String var1) {
      return (T)this.loadFromReader(new StreamReader(var1), Object.class);
   }

   public <T> T load(InputStream var1) {
      return (T)this.loadFromReader(new StreamReader(new UnicodeReader(var1)), Object.class);
   }
   ...
   public <T> T loadAs(Reader var1, Class<? super T> var2) {
      return (T)this.loadFromReader(new StreamReader(var1), var2);
   }

   public <T> T loadAs(String var1, Class<? super T> var2) {
      return (T)this.loadFromReader(new StreamReader(var1), var2);
   }

   public <T> T loadAs(InputStream var1, Class<? super T> var2) {
      return (T)this.loadFromReader(new StreamReader(new UnicodeReader(var1)), var2);
   }

   private Object loadFromReader(StreamReader var1, Class<?> var2) {
      Composer var3 = new Composer(new ParserImpl(var1, this.loadingConfig), this.resolver, this.loadingConfig);
      this.constructor.setComposer(var3);
      return this.constructor.getSingleData(var2);
   }

   public Iterable<Object> loadAll(Reader var1) {
      Composer var2 = new Composer(new ParserImpl(new StreamReader(var1), this.loadingConfig), this.resolver, this.loadingConfig);
   ...
   public Iterable<Object> loadAll(String var1) {
      return this.loadAll(new StringReader(var1));
   }

   public Iterable<Object> loadAll(InputStream var1) {
      return this.loadAll(new UnicodeReader(var1));
   }
   ...
   public Iterable<Node> composeAll(Reader var1) {
      final Composer var2 = new Composer(new ParserImpl(new StreamReader(var1), this.loadingConfig), this.resolver, this.loadingConfig);
   ...
   public void addImplicitResolver(Tag var1, Pattern var2, String var3, int var4) {
      this.resolver.addImplicitResolver(var1, var2, var3, var4);
   }
   ...
   public Iterable<Event> parse(Reader var1) {
      final ParserImpl var2 = new ParserImpl(new StreamReader(var1), this.loadingConfig);
