...
public class SrgReader extends TextMappingsReader {
   public SrgReader(Reader var1) {
      super(var1, SrgReader.Processor::new);
   }
   ...
   public static class Processor extends TextMappingsReader.Processor {
      ...
      public void accept(String var1) {
         ...
         if (!var2.isEmpty()) {
            if (var2.length() < 4) {
               throw new IllegalArgumentException("Faulty SRG mapping encountered: `" + var2 + "`!");
            }
            ...
            } else if (var5.equals("FD:") && var4 == 3) {
               String var14 = var3[1];
               String var16 = var3[2];
               int var18 = var14.lastIndexOf(47);
               String var19 = var14.substring(0, var18);
               String var20 = var14.substring(var18 + 1);
               String var21 = var16.substring(var16.lastIndexOf(47) + 1);
               this.mappings.getOrCreateClassMapping(var19).getOrCreateFieldMapping(var20).setDeobfuscatedName(var21);
