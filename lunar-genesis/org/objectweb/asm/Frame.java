...
class Frame {
   ...
   static int getAbstractTypeFromApiFormat(SymbolTable var0, Object var1) {
      if (var1 instanceof Integer) {
         ...
         String var3 = Type.getObjectType((String)var1).getDescriptor();
         return getAbstractTypeFromDescriptor(var0, var3, 0);
      } else {
         Label var2 = (Label)var1;
         return (var2.flags & 4) != 0 ? 12582912 | var0.addUninitializedType("", var2.bytecodeOffset) : 16777216 | var0.addForwardUninitializedType("", var2);
      }
   }
   ...
   private static int getAbstractTypeFromDescriptor(SymbolTable var0, String var1, int var2) {
      switch (var1.charAt(var2)) {
         ...
         case 'Y':
         default:
            throw new IllegalArgumentException(stringConcat$1(var1.substring(var2)));
         case 'F':
            return 4194306;
         case 'J':
            return 4194308;
         case 'L':
            String var6 = var1.substring(var2 + 1, var1.length() - 1);
            return 8388608 | var0.addType(var6);
         case 'V':
            return 0;
         case '[':
            int var4 = var2 + 1;
            ...
            switch (var1.charAt(var4)) {
               ...
               case 'Y':
               default:
                  throw new IllegalArgumentException(stringConcat$0(var1.substring(var4)));
               case 'F':
                  var5 = 4194306;
                  break;
               case 'I':
               ...
               case 'J':
                  ...
                  break;
               case 'L':
                  String var3 = var1.substring(var4 + 1, var1.length() - 1);
   ...
   final void setInputFrameFromDescriptor(SymbolTable var1, int var2, String var3, int var4) {
      ...
      for (Type var9 : Type.getArgumentTypes(var3)) {
   ...
   final void setInputFrameFromApiFormat(SymbolTable var1, int var2, Object[] var3, int var4, Object[] var5) {
      ...
      this.inputStack = new int[var4 + var10];
      int var11 = 0;

      for (int var9 = 0; var9 < var4; var9++) {
         this.inputStack[var11++] = getAbstractTypeFromApiFormat(var1, var5[var9]);
         if (var5[var9] == Opcodes.LONG || var5[var9] == Opcodes.DOUBLE) {
            this.inputStack[var11++] = 4194304;
         }
      }
   ...
   private int getLocal(int var1) {
      if (this.outputLocals != null && var1 < this.outputLocals.length) {
         ...
         if (var2 == 0) {
            var2 = this.outputLocals[var1] = 20971520 | var1;
         }

         return var2;
      } else {
         return 20971520 | var1;
      }
   }
   ...
   private int pop() {
      ...
      this.outputStackStart--;
      return 25165824 | -this.outputStackStart;
   }
   ...
   private int getInitializedType(SymbolTable var1, int var2) {
      if (var2 == 4194310 || (var2 & -4194304) == 12582912 || (var2 & -4194304) == 16777216) {
   ...
   void execute(int var1, int var2, Symbol var3, SymbolTable var4) {
      switch (var1) {
         ...
         case 50:
            this.pop(1);
            int var20 = this.pop();
            this.push(var20 == 4194309 ? var20 : -67108864 + var20);
            break;
         case 54:
         case 56:
         case 58:
            int var19 = this.pop();
            this.setLocal(var2, var19);
            if (var2 > 0) {
               int var29 = this.getLocal(var2 - 1);
               if (var29 != 4194308 && var29 != 4194307) {
                  if ((var29 & 62914560) == 20971520 || (var29 & 62914560) == 25165824) {
                     this.setLocal(var2 - 1, var29 | 1048576);
                  }
               } else {
         ...
         case 57:
            this.pop(1);
            int var18 = this.pop();
            this.setLocal(var2, var18);
            this.setLocal(var2 + 1, 4194304);
            if (var2 > 0) {
               int var28 = this.getLocal(var2 - 1);
               if (var28 != 4194308 && var28 != 4194307) {
                  if ((var28 & 62914560) == 20971520 || (var28 & 62914560) == 25165824) {
                     this.setLocal(var2 - 1, var28 | 1048576);
                  }
               } else {
                  this.setLocal(var2 - 1, 4194304);
               }
         ...
         case 189:
            ...
            this.pop();
            if (var9.charAt(0) == '[') {
               this.push(var4, stringConcat$2(var9));
            } else {
   ...
   private int getConcreteOutputType(int var1, int var2) {
      ...
      if (var4 == 20971520) {
         int var6 = var3 + this.inputLocals[var1 & 1048575];
         if ((var1 & 1048576) != 0 && (var6 == 4194308 || var6 == 4194307)) {
            var6 = 4194304;
         }
         ...
         int var5 = var3 + this.inputStack[var2 - (var1 & 1048575)];
   ...
   final boolean merge(SymbolTable var1, Frame var2, int var3) {
      ...
      for (int var7 = 0; var7 < var5; var7++) {
         ...
         if (this.outputLocals != null && var7 < this.outputLocals.length) {
            int var9 = this.outputLocals[var7];
            if (var9 == 0) {
      ...
      if (var3 <= 0) {
         int var12 = this.inputStack.length + this.outputStackStart;
         ...
         for (int var13 = 0; var13 < var12; var13++) {
            int var15 = this.inputStack[var13];
            if (this.initializations != null) {
               var15 = this.getInitializedType(var1, var15);
            }

            var4 |= merge(var1, var15, var2.inputStack, var13);
         }

         for (int var14 = 0; var14 < this.outputStackTop; var14++) {
            int var16 = this.outputStack[var14];
            int var10 = this.getConcreteOutputType(var16, var6);
            if (this.initializations != null) {
               var10 = this.getInitializedType(var1, var10);
            }

            var4 |= merge(var1, var10, var2.inputStack, var12 + var14);
         }

         return var4;
      } else {
         for (int var11 = 0; var11 < var5; var11++) {
            var4 |= merge(var1, this.inputLocals[var11], var2.inputLocals, var11);
         }
         ...
         return var4 | merge(var1, var3, var2.inputStack, 0);
      }
   }
   ...
   private static boolean merge(SymbolTable var0, int var1, int[] var2, int var3) {
      ...
      if ((var4 & -67108864) == 0 && (var4 & 62914560) != 8388608) {
         ...
         if ((var5 & -4194304) == (var4 & -4194304)) {
            ...
            var6 = Math.min(var9, var8) | 8388608 | var0.addType("java/lang/Object");
         }
      }
   ...
   final void accept(MethodWriter var1) {
      ...
      int[] var13 = this.inputStack;
      int var7 = 0;

      for (byte var10 = 0; var10 < var13.length; var7++) {
         int var8 = var13[var10];
         var10 += var8 != 4194308 && var8 != 4194307 ? 1 : 2;
      }

      int var14 = var1.visitFrameStart(this.owner.bytecodeOffset, var3, var7);
      var5 = 0;

      while (var3-- > 0) {
         int var9 = var2[var5];
         var5 += var9 != 4194308 && var9 != 4194307 ? 1 : 2;
         var1.visitAbstractType(var14++, var9);
      }
      ...
      while (var7-- > 0) {
         ...
         var5 += var15 != 4194308 && var15 != 4194307 ? 1 : 2;
         var1.visitAbstractType(var14++, var15);
      }
   ...
   static void putAbstractType(SymbolTable var0, int var1, ByteVector var2) {
      ...
      if (var3 == 0) {
         ...
         switch (var1 & 62914560) {
            ...
            case 16777216:
               var2.putByte(8);
               var0.getForwardUninitializedLabel(var4).put(var2);
               break;
            default:
               throw new AssertionError();
         }
