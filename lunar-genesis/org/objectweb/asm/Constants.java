...
final class Constants {
   ...
   static void checkAsmExperimental(Object var0) {
      Class var1 = var0.getClass();
      String var2 = var1.getName().replace('.', '/');
      if (!isWhitelisted(var2)) {
         checkIsPreview(var1.getClassLoader().getResourceAsStream(stringConcat$0(var2)));
      }
   }

   static boolean isWhitelisted(String var0) {
      if (!var0.startsWith("org/objectweb/asm/")) {
         return false;
      }

      String var1 = "(Annotation|Class|Field|Method|Module|RecordComponent|Signature)";
      return var0.contains("Test$") || Pattern.matches(stringConcat$1(var1), var0) || Pattern.matches(stringConcat$2(var1), var0);
   }

   static void checkIsPreview(InputStream var0) {
      if (var0 == null) {
