...
public class ByteVector {
   ...
   final ByteVector encodeUtf8(String var1, int var2, int var3) {
      ...
      int var10 = this.length - var2 - 2;
      if (var10 >= 0) {
         this.data[var10] = (byte)(var5 >>> 8);
         this.data[var10 + 1] = (byte)var5;
      }
      ...
      for (int var8 = var2; var8 < var4; var8++) {
         ...
         if (var9 >= 1 && var9 <= 127) {
            this.data[var11++] = (byte)var9;
         } else if (var9 <= 2047) {
            this.data[var11++] = (byte)(192 | var9 >> 6 & 31);
            this.data[var11++] = (byte)(128 | var9 & 63);
         } else {
            this.data[var11++] = (byte)(224 | var9 >> '\f' & 15);
            this.data[var11++] = (byte)(128 | var9 >> 6 & 63);
            this.data[var11++] = (byte)(128 | var9 & 63);
         }
      }
