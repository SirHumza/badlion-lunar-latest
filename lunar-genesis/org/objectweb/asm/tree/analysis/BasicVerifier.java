...
public class BasicVerifier extends BasicInterpreter {
   ...
   public BasicValue copyOperation(AbstractInsnNode var1, BasicValue var2) {
      ...
      switch (var1.getOpcode()) {
         ...
         case 25:
            if (!var2.isReference()) {
               throw new AnalyzerException(var1, null, "an object reference", var2);
            }
         ...
         case 58:
            if (!var2.isReference() && !BasicValue.RETURNADDRESS_VALUE.equals(var2)) {
               throw new AnalyzerException(var1, null, "an object reference or a return address", var2);
            }
      ...
      if (!var3.equals(var2)) {
         throw new AnalyzerException(var1, null, var3, var2);
      } else {
         return var2;
      }
   }
      ...
      switch (var1.getOpcode()) {
         ...
         case 190:
            if (!this.isArrayValue(var2)) {
               throw new AnalyzerException(var1, null, "an array reference", var2);
            }
   ...
   public BasicValue ternaryOperation(AbstractInsnNode var1, BasicValue var2, BasicValue var3, BasicValue var4) {
      ...
      if (!this.isSubTypeOf(var2, var5)) {
         throw new AnalyzerException(var1, "First argument", stringConcat$0(String.valueOf(var5)), var2);
   ...
   public BasicValue naryOperation(AbstractInsnNode var1, List<? extends BasicValue> var2) {
      ...
      if (var3 == 197) {
         for (BasicValue var5 : var2) {
            if (!BasicValue.INT_VALUE.equals(var5)) {
               throw new AnalyzerException(var1, null, BasicValue.INT_VALUE, var5);
            }
         }
      } else {
         int var10 = 0;
         ...
         while (var10 < var2.size()) {
            ...
            if (!this.isSubTypeOf(var9, var8)) {
               throw new AnalyzerException(var1, stringConcat$1(var11), var8, var9);
            }
         }
      }
