...
public class BasicInterpreter extends Interpreter<BasicValue> implements Opcodes {
         ...
         case 18:
            ...
            if (var2 instanceof Integer) {
               ...
               if (var3 != 10 && var3 != 9) {
                  ...
                  throw new AnalyzerException(var1, stringConcat$0(String.valueOf(var2)));
               }
               ...
               throw new AnalyzerException(var1, stringConcat$1(String.valueOf(var2)));
            }
         case 168:
   ...
   public BasicValue unaryOperation(AbstractInsnNode var1, BasicValue var2) {
      switch (var1.getOpcode()) {
         ...
         case 189:
            return this.newValue(Type.getType(stringConcat$2(String.valueOf(Type.getObjectType(((TypeInsnNode)var1).desc)))));
         case 190:
            return BasicValue.INT_VALUE;
         case 191:
            return null;
   ...
   public BasicValue naryOperation(AbstractInsnNode var1, List<? extends BasicValue> var2) {
      ...
      if (var3 == 197) {
         ...
         return var3 == 186
            ? this.newValue(Type.getReturnType(((InvokeDynamicInsnNode)var1).desc))
            : this.newValue(Type.getReturnType(((MethodInsnNode)var1).desc));
      }
   }
