...
public class InstructionAdapter extends MethodVisitor {
   ...
   public void visitLdcInsn(Object var1) {
      if (this.api >= 327680 || !(var1 instanceof Handle) && (!(var1 instanceof Type) || ((Type)var1).getSort() != 11)) {
         if (this.api < 458752 && var1 instanceof ConstantDynamic) {
            throw new UnsupportedOperationException("This feature requires ASM7");
         }

         if (var1 instanceof Integer) {
            this.iconst((Integer)var1);
         } else if (var1 instanceof Byte) {
            this.iconst(((Byte)var1).intValue());
         } else if (var1 instanceof Character) {
            this.iconst((Character)var1);
         } else if (var1 instanceof Short) {
            this.iconst(((Short)var1).intValue());
         } else if (var1 instanceof Boolean) {
            this.iconst((Boolean)var1 ? 1 : 0);
         } else if (var1 instanceof Float) {
            this.fconst((Float)var1);
         } else if (var1 instanceof Long) {
            this.lconst((Long)var1);
         } else if (var1 instanceof Double) {
            this.dconst((Double)var1);
            ...
            this.cconst((ConstantDynamic)var1);
         }
      } else {
         throw new UnsupportedOperationException("This feature requires ASM5");
      }
   ...
   public void fconst(float var1) {
      ...
      if (var2 != 0L && var2 != 1065353216 && var2 != 1073741824) {
         this.mv.visitLdcInsn(var1);
      } else {
   ...
   public void cconst(ConstantDynamic var1) {
      this.mv.visitLdcInsn(var1);
   }
   ...
   public void cast(Type var1, Type var2) {
      cast(this.mv, var1, var2);
   }

   static void cast(MethodVisitor var0, Type var1, Type var2) {
      if (var1 != var2) {
   ...
   public void newarray(Type var1) {
      newarray(this.mv, var1);
   }

   static void newarray(MethodVisitor var0, Type var1) {
      byte var2;
      switch (var1.getSort()) {
         case 1:
            var2 = 4;
         ...
         case 8:
            ...
            break;
         default:
            var0.visitTypeInsn(189, var1.getInternalName());
            return;
      }

      var0.visitIntInsn(188, var2);
   }
