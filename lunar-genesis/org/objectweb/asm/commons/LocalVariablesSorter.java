...
public class LocalVariablesSorter extends MethodVisitor {
   ...
   protected LocalVariablesSorter(int var1, int var2, String var3, MethodVisitor var4) {
      ...
      for (Type var8 : Type.getArgumentTypes(var3)) {
         this.nextLocal = this.nextLocal + var8.getSize();
      }
   ...
   public void visitFrame(int var1, int var2, Object[] var3, int var4, Object[] var5) {
      ...
      while (var7 < this.remappedLocalTypes.length) {
         Object var14 = this.remappedLocalTypes[var7];
         var7 += var14 != Opcodes.LONG && var14 != Opcodes.DOUBLE ? 1 : 2;
         if (var14 != null && var14 != Opcodes.TOP) {
            this.remappedLocalTypes[var12++] = var14;
            var13 = var12;
         } else {
            this.remappedLocalTypes[var12++] = Opcodes.TOP;
         }
      }

      super.visitFrame(var1, var13, this.remappedLocalTypes, var4, var5);
   ...
   protected int newLocalMapping(Type var1) {
      ...
      this.nextLocal = this.nextLocal + var1.getSize();
      return var2;
   }
}
