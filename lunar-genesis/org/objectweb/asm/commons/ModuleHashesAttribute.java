...
public final class ModuleHashesAttribute extends Attribute {
   ...
   public ModuleHashesAttribute(String var1, List<String> var2, List<byte[]> var3) {
      super("ModuleHashes");
      this.algorithm = var1;
      this.modules = var2;
      this.hashes = var3;
   ...
   protected Attribute read(ClassReader var1, int var2, int var3, char[] var4, int var5, Label[] var6) {
      int var7 = var2;
      String var8 = var1.readUTF8(var7, var4);
      var7 += 2;
      ...
      for (int var12 = 0; var12 < var9; var12++) {
         ...
         for (int var16 = 0; var16 < var14; var16++) {
            var15[var16] = (byte)var1.readByte(var7);
            var7++;
         }
   ...
   protected ByteVector write(ClassWriter var1, byte[] var2, int var3, int var4, int var5) {
      ...
      if (this.modules == null) {
         ...
         for (int var8 = 0; var8 < var7; var8++) {
            String var9 = this.modules.get(var8);
            byte[] var10 = this.hashes.get(var8);
