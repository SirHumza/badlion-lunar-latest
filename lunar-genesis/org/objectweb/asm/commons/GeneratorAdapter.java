...
public class GeneratorAdapter extends LocalVariablesSorter {
   ...
   public Type getLocalType(int var1) {
      return this.localTypes.get(var1 - this.firstLocal);
   }
   ...
   public void cast(Type var1, Type var2) {
      if (var1 != var2) {
         if (var1.getSort() < 1 || var1.getSort() > 8 || var2.getSort() < 1 || var2.getSort() > 8) {
            throw new IllegalArgumentException(stringConcat$0(String.valueOf(var1), String.valueOf(var2)));
         }

         InstructionAdapter.cast(this.mv, var1, var2);
      }
   }
   ...
   public void ifCmp(Type var1, int var2, Label var3) {
      switch (var1.getSort()) {
         ...
         case 10:
            ...
            throw new IllegalArgumentException(stringConcat$1(String.valueOf(var1)));
         default:
            short var4 = -1;
            switch (var2) {
               case 153:
            ...
            this.mv.visitJumpInsn(var4, var3);
            return;
      }
   ...
   public void tableSwitch(int[] var1, TableSwitchGenerator var2) {
      ...
      if (var1.length == 0) {
         ...
         var3 = (float)var1.length / (var1[var1.length - 1] - var1[0] + 1);
      }
      ...
      if (var1.length > 0) {
         ...
         if (var3) {
            ...
            for (int var17 = 0; var17 < var9; var17++) {
               Label var12 = var10[var17];
               if (var12 != var13) {
                  this.mark(var12);
                  var2.generateCase(var17 + var7, var5);
               }
            }
         } else {
            ...
            for (int var15 = 0; var15 < var6; var15++) {
               var14[var15] = this.newLabel();
            }

            this.mv.visitLookupSwitchInsn(var13, var1, var14);

            for (int var16 = 0; var16 < var6; var16++) {
               this.mark(var14[var16]);
               var2.generateCase(var1[var16], var5);
            }
         }
      }
   ...
   public void newArray(Type var1) {
      InstructionAdapter.newarray(this.mv, var1);
   }
   ...
   public void catchException(Label var1, Label var2, Type var3) {
      ...
      if (var3 == null) {
         this.mv.visitTryCatchBlock(var1, var2, var4, null);
      } else {
