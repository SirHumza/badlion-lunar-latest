...
public class NonBlockingHashMap<TypeK, TypeV> extends AbstractMap<TypeK, TypeV> implements Serializable, Cloneable, ConcurrentMap<TypeK, TypeV> {
   ...
   private static final NonBlockingHashMap.Prime TOMBPRIME = new NonBlockingHashMap.Prime(TOMBSTONE);
   ...
   private final void initialize(int var1) {
      ...
      this._kvs[0] = new NonBlockingHashMap.CHM(new ConcurrentAutoTable());
   ...
   public final TypeV putIfMatchAllowNull(Object var1, Object var2, Object var3) {
      if (var3 == null) {
         var3 = TOMBSTONE;
      }
   ...
   public final TypeV putIfMatch(Object var1, Object var2, Object var3) {
   ...
   public TypeV get(Object var1) {
      ...
      assert !(var2 instanceof NonBlockingHashMap.Prime);
      assert var2 != TOMBSTONE;
      return (TypeV)var2;
   }

   private static final Object get_impl(NonBlockingHashMap var0, Object[] var1, Object var2) {
      int var3 = hash(var2);
      int var4 = len(var1);
      ...
      while (true) {
         ...
         if (keyeq(var9, var2, var6, var7, var3)) {
            ...
            return get_impl(var0, var5.copy_slot_and_check(var0, var1, var7, var2), var2);
         }

         if (++var8 >= reprobe_limit(var4) || var9 == TOMBSTONE) {
            return var11 == null ? null : get_impl(var0, var0.help_copy(var11), var2);
         }
   ...
   public TypeK getk(TypeK var1) {
      return (TypeK)getk_impl(this, this._kvs, var1);
   }

   private static final Object getk_impl(NonBlockingHashMap var0, Object[] var1, Object var2) {
      int var3 = hash(var2);
      int var4 = len(var1);
      NonBlockingHashMap.CHM var5 = chm(var1);
      int[] var6 = hashes(var1);
      ...
      while (true) {
         ...
         if (++var8 >= reprobe_limit(var4) || var9 == TOMBSTONE) {
            return var10 == null ? null : getk_impl(var0, var0.help_copy(var10), var2);
         }
   ...
   private static final Object putIfMatch0(NonBlockingHashMap var0, Object[] var1, Object var2, Object var3, Object var4) {
      assert var3 != null;
      ...
      while (true) {
         ...
         if (var11 == null) {
            ...
            if (!keyeq(var11, var2, var8, var9, var5)) {
               if (++var10 < reprobe_limit(var6) && var11 != TOMBSTONE) {
                  var9 = var9 + 1 & var6 - 1;
                  continue;
               }
               ...
               return putIfMatch0(var0, var13, var2, var3, var4);
            }
         }
         ...
         while (var3 != var12) {
            ...
            if (var13 != null) {
               return putIfMatch0(var0, var7.copy_slot_and_check(var0, var1, var9, var4), var2, var3, var4);
            }
            ...
            if (var4 != NO_MATCH_OLD
               ...
               return var12 == null ? TOMBSTONE : var12;
            }
            ...
            var12 = val(var1, var9);
            if (var12 instanceof NonBlockingHashMap.Prime) {
               return putIfMatch0(var0, var7.copy_slot_and_check(var0, var1, var9, var4), var2, var3, var4);
            }

            int var18 = DUMMY_VOLATILE;
         }
   ...
   public Object[] raw_array() {
      return (new NonBlockingHashMap.SnapshotV())._sskvs;
   }
   ...
   public Set<TypeK> keySet() {
      return new AbstractSet<TypeK>() {
         ...
         public <T> T[] toArray(T[] var1) {
            Object[] var2 = NonBlockingHashMap.this.raw_array();
            int var3 = this.size();
            Object[] var4 = var1.length >= var3 ? var1 : (Object[])Array.newInstance(var1.getClass().getComponentType(), var3);
            int var5 = 0;

            for (int var6 = 0; var6 < NonBlockingHashMap.len(var2); var6++) {
               Object var7 = NonBlockingHashMap.key(var2, var6);
               Object var8 = NonBlockingHashMap.Prime.unbox(NonBlockingHashMap.val(var2, var6));
               if (var7 != null && var7 != NonBlockingHashMap.TOMBSTONE && var8 != null && var8 != NonBlockingHashMap.TOMBSTONE) {
                  if (var5 >= var4.length) {
                     int var9 = (int)Math.min(2147483639L, (long)var5 << 1);
                     if (var9 <= var4.length) {
                        throw new OutOfMemoryError("Required array size too large");
                     }

                     var4 = Arrays.copyOf(var4, var9);
                  }
            ...
            if (var5 <= var1.length) {
               ...
               return (T[])Arrays.copyOf(var4, var5);
            }
         }
      };
   }
   ...
   private static final class CHM<TypeK, TypeV> {
      ...
      private static final AtomicReferenceFieldUpdater<NonBlockingHashMap.CHM, Object[]> _newkvsUpdater = AtomicReferenceFieldUpdater.newUpdater(
      ...
      private final boolean tableFull(int var1, int var2) {
         return var1 >= 10 && (var1 >= NonBlockingHashMap.reprobe_limit(var2) || this._slots.estimate_get() >= var2 >> 1);
      }
      ...
      private final Object[] resize(NonBlockingHashMap var1, Object[] var2) {
         ...
         if (var5 >= var4 >> 2) {
            var6 = var4 << 1;
            if (4L * var5 >= (var4 >> 20 != 0 ? 3L : 2L) * var4) {
               var6 = var4 << 2;
            }
         }

         long var7 = System.currentTimeMillis();
         if (var6 <= var4 && var7 <= var1._last_resize_milli + 10000L) {
            var6 = var4 << 1;
         }
         ...
         long var10 = (1L << var9 << 1) + 2L;
         if ((int)var10 != var10) {
            var9 = 30;
            var10 = (1L << var9) + 2L;
            if (var5 > (var10 >> 2) + (var10 >> 1)) {
         ...
         long var14 = (1L << var9 << 1) + 8L << 3 >> 20;
         if (var12 >= 2L && var14 > 0L) {
            var3 = this._newkvs;
            if (var3 != null) {
               return var3;
            }
         ...
         var3 = new Object[(int)var10];
         var3[0] = new NonBlockingHashMap.CHM(this._size);
         var3[1] = new int[1 << var9];
      ...
      private final void help_copy_impl(NonBlockingHashMap var1, Object[] var2, boolean var3) {
         ...
         while (this._copyDone < var5) {
            if (var7 == -1) {
               ...
               while (!_copyIdxUpdater.compareAndSet(this, var8, var8 + var6)) {
                  var8 = (int)this._copyIdx;
               }
      ...
      private boolean copy_slot(NonBlockingHashMap var1, int var2, Object[] var3, Object[] var4) {
         ...
         while ((var5 = NonBlockingHashMap.key(var3, var2)) == null) {
            NonBlockingHashMap.CAS_key(var3, var2, null, NonBlockingHashMap.TOMBSTONE);
         }

         Object var6;
         for (var6 = NonBlockingHashMap.val(var3, var2); !(var6 instanceof NonBlockingHashMap.Prime); var6 = NonBlockingHashMap.val(var3, var2)) {
            NonBlockingHashMap.Prime var7 = var6 != null && var6 != NonBlockingHashMap.TOMBSTONE
               ? new NonBlockingHashMap.Prime(var6)
         ...
         Object var8 = ((NonBlockingHashMap.Prime)var6)._V;
         assert var8 != NonBlockingHashMap.TOMBSTONE;
         NonBlockingHashMap.putIfMatch0(var1, var4, var5, var8, null);

         while (var6 != NonBlockingHashMap.TOMBPRIME && !NonBlockingHashMap.CAS_val(var3, var2, var6, NonBlockingHashMap.TOMBPRIME)) {
            var6 = NonBlockingHashMap.val(var3, var2);
         }

         return var6 != NonBlockingHashMap.TOMBPRIME;
      }
   }
   ...
   private class NBHMEntry extends AbstractEntry<TypeK, TypeV> {
      ...
      public TypeV setValue(TypeV var1) {
         ...
         return NonBlockingHashMap.this.put(this._key, (TypeV)var1);
      }
   }
