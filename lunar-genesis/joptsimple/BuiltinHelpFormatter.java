...
public class BuiltinHelpFormatter implements HelpFormatter {
   ...
   public String format(Map<String, ? extends OptionDescriptor> var1) {
      ...
      Comparator var2 = new Comparator<OptionDescriptor>() {
         public int compare(OptionDescriptor var1, OptionDescriptor var2x) {
            return var1.options().iterator().next().compareTo(var2x.options().iterator().next());
         }
      };
   ...
   protected boolean shouldShowNonOptionArgumentDisplay(OptionDescriptor var1) {
      return !Strings.isNullOrEmpty(var1.description())
         || !Strings.isNullOrEmpty(var1.argumentTypeIndicator())
         || !Strings.isNullOrEmpty(var1.argumentDescription());
   }
   ...
   protected final boolean hasRequiredOption(Collection<? extends OptionDescriptor> var1) {
      for (OptionDescriptor var3 : var1) {
         if (var3.isRequired()) {
            return true;
         }
      }
