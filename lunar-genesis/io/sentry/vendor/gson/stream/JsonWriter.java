...
public class JsonWriter implements Closeable, Flushable {
   ...
   public JsonWriter value(@Nullable String var1) {
      if (var1 == null) {
   ...
   public JsonWriter jsonValue(@Nullable String var1) {
      if (var1 == null) {
         return this.nullValue();
      }
   ...
   public JsonWriter value(@Nullable Boolean var1) {
      if (var1 == null) {
         return this.nullValue();
      }
   ...
   public JsonWriter value(@Nullable Number var1) {
      if (var1 == null) {
         return this.nullValue();
      } else {
         this.writeDeferredName();
