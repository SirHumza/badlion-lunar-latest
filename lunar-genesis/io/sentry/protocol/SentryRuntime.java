...
public final class SentryRuntime implements JsonSerializable, JsonUnknown {
   ...
   SentryRuntime(@NotNull SentryRuntime var1) {
      this.name = var1.name;
   ...
   public static final class Deserializer implements JsonDeserializer<SentryRuntime> {
      @NotNull
      public SentryRuntime deserialize(@NotNull ObjectReader var1, @NotNull ILogger var2) {
         var1.beginObject();
         SentryRuntime var3 = new SentryRuntime();
