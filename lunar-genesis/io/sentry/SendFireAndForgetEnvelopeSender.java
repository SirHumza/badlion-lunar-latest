...
public final class SendFireAndForgetEnvelopeSender implements SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForgetFactory {
   ...
   public SendFireAndForgetEnvelopeSender(@NotNull SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForgetDirPath var1) {
   ...
   public SendCachedEnvelopeFireAndForgetIntegration.SendFireAndForget create(@NotNull IHub var1, @NotNull SentryOptions var2) {
      ...
      if (var3 != null && this.hasValidPath(var3, var2.getLogger())) {
         EnvelopeSender var4 = new EnvelopeSender(var1, var2.getSerializer(), var2.getLogger(), var2.getFlushTimeoutMillis(), var2.getMaxQueueSize());
