...
public interface ISerializer {
   ...
   <T> void serialize(@NotNull T var1, @NotNull Writer var2);

   void serialize(@NotNull SentryEnvelope var1, @NotNull OutputStream var2);

   @NotNull
   String serialize(@NotNull Map<String, Object> var1);
}
