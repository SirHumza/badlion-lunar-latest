...
class FastIntegerMath {
   ...
   static BigInteger computePowerOfTen(NavigableMap<Integer, BigInteger> var0, int var1) {
      if (var1 < SMALL_POWERS_OF_TEN.length) {
         return SMALL_POWERS_OF_TEN[var1];
      } else if (var0 != null) {
         Entry var2 = var0.floorEntry(var1);
         Integer var3 = (Integer)var2.getKey();
         return var3 == var1 ? (BigInteger)var2.getValue() : FftMultiplier.multiply((BigInteger)var2.getValue(), computePowerOfTen(var0, var1 - var3));
      } else {
         return FIVE.pow(var1).shiftLeft(var1);
      }
   }
   ...
   static FastIntegerMath.UInt128 fullMultiplication(long var0, long var2) {
      ...
      return new FastIntegerMath.UInt128(var12 + (var20 >>> 32) + (var14 >>> 32), var20 << 32 | var18 & 4294967295L);
   }
   ...
   static class UInt128 {
      ...
      private UInt128(long var1, long var3) {
         this.high = var1;
         this.low = var3;
      }
   }
