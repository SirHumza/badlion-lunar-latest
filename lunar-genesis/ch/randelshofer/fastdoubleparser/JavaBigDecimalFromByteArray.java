   ...
   private BigDecimal valueOfBigDecimalString(byte[] var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
      ...
      if (var10 > 0) {
         if (var10 > 400) {
            ...
            var13 = ParseDigitsTaskByteArray.parseDigitsRecursive(var1, var2, var3, var11);
         } else {
            var13 = ParseDigitsTaskByteArray.parseDigitsRecursive(var1, var2, var3, null);
         }
      } else {
      ...
      if (var8 > 0) {
         ...
         if (var9 > 400) {
            ...
            var14 = ParseDigitsTaskByteArray.parseDigitsRecursive(var1, var4, var5, var11);
         } else {
            var14 = ParseDigitsTaskByteArray.parseDigitsRecursive(var1, var4, var5, null);
         }
