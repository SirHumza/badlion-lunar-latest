...
abstract class AbstractJsonFloatingPointBitsFromCharArray extends AbstractFloatValueParser {
   public final long parseNumber(char[] var1, int var2, int var3) {
      int var4 = var2 + var3;
      if (var2 >= 0 && var4 >= var2 && var4 <= var1.length && var3 <= 2147483643) {
         ...
         while (var5 < var4) {
            ...
            if (FastDoubleSwar.isDigit(var6)) {
               ...
               while (var5 < var4 - 8) {
                  int var14 = this.tryToParseEightDigits(var1, var5 + 1);
                  if (var14 < 0) {
                     break;
                  }

                  var9 = 100000000L * var9 + var14;
                  var5 += 8;
               }
            }
   ...
   private int tryToParseEightDigits(char[] var1, int var2) {
      return FastDoubleSwar.tryToParseEightDigits(var1, var2);
   }
