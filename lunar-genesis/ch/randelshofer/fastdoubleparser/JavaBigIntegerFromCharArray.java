...
class JavaBigIntegerFromCharArray extends AbstractNumberParser {
   ...
   private BigInteger parseHexDigits(char[] var1, int var2, int var3, boolean var4) {
      ...
      if ((var5 & 1) != 0) {
         char var9 = var1[var2++];
         byte var10 = AbstractFloatValueParser.CHAR_TO_HEX_MAP[var9];
      ...
      for (int var15 = var2 + (var3 - var2 & 7); var2 < var15; var2 += 2) {
         ...
         byte var12 = var16 >= 128 ? -1 : AbstractFloatValueParser.CHAR_TO_HEX_MAP[var16];
         byte var13 = var11 >= 128 ? -1 : AbstractFloatValueParser.CHAR_TO_HEX_MAP[var11];
   ...
   private BigInteger parseManyDecDigits(char[] var1, int var2, int var3, boolean var4) {
      ...
      BigInteger var7 = ParseDigitsTaskCharArray.parseDigitsRecursive(var1, var2, var3, var6);
