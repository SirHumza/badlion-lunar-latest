...
final class JavaBigDecimalFromCharSequence extends AbstractNumberParser {
   ...
   BigDecimal parseBigDecimalStringWithManyDigits(CharSequence var1, int var2, int var3) {
      ...
      while (var10 < var9 - 8 && FastDoubleSwar.isEightZeroes(var1, var10)) {
         var10 += 8;
      }
      ...
      while (var10 < var9 - 8 && FastDoubleSwar.isEightDigits(var1, var10)) {
         var10 += 8;
      }

      while (var10 < var9 && FastDoubleSwar.isDigit(var11 = var1.charAt(var10))) {
         var10++;
      }
   ...
   private BigDecimal valueOfBigDecimalString(CharSequence var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
      ...
      if (var10 > 0) {
         if (var10 > 400) {
            ...
            var13 = ParseDigitsTaskCharSequence.parseDigitsRecursive(var1, var2, var3, var11);
         } else {
            var13 = ParseDigitsTaskCharSequence.parseDigitsRecursive(var1, var2, var3, null);
         }
      } else {
      ...
      if (var8 > 0) {
         ...
         if (var9 > 400) {
            ...
            FastIntegerMath.fillPowersOfNFloor16Recursive(var11, var4, var5);
            var14 = ParseDigitsTaskCharSequence.parseDigitsRecursive(var1, var4, var5, var11);
         } else {
            var14 = ParseDigitsTaskCharSequence.parseDigitsRecursive(var1, var4, var5, null);
         }
