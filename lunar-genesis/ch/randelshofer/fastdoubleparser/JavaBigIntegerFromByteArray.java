...
class JavaBigIntegerFromByteArray extends AbstractNumberParser {
   ...
   private BigInteger parseDecDigits(byte[] var1, int var2, int var3, boolean var4) {
      ...
      for (int var11 = var6; var11 < var3; var11 += 8) {
         int var10 = FastDoubleSwar.tryToParseEightDigitsUtf8(var1, var11);
         var9 &= var10 >= 0;
   ...
   private BigInteger parseHexDigits(byte[] var1, int var2, int var3, boolean var4) {
      ...
      if ((var5 & 1) != 0) {
         byte var9 = var1[var2++];
         byte var10 = var9 < 0 ? -1 : AbstractFloatValueParser.CHAR_TO_HEX_MAP[var9];
      ...
      for (int var15 = var2 + (var3 - var2 & 7); var2 < var15; var2 += 2) {
         ...
         byte var12 = var16 < 0 ? -1 : AbstractFloatValueParser.CHAR_TO_HEX_MAP[var16];
         byte var13 = var11 < 0 ? -1 : AbstractFloatValueParser.CHAR_TO_HEX_MAP[var11];
   ...
   private BigInteger parseManyDecDigits(byte[] var1, int var2, int var3, boolean var4) {
      ...
      BigInteger var7 = ParseDigitsTaskByteArray.parseDigitsRecursive(var1, var2, var3, var6);
      return var4 ? var7.negate() : var7;
   }

   private int skipZeroes(byte[] var1, int var2, int var3) {
      while (var2 < var3 - 8 && FastDoubleSwar.isEightZeroes(var1, var2)) {
         var2 += 8;
      }
