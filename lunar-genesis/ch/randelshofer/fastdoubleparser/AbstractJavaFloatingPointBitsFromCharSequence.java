...
abstract class AbstractJavaFloatingPointBitsFromCharSequence extends AbstractFloatValueParser {
   private static int skipWhitespace(CharSequence var0, int var1, int var2) {
   ...
   private long parseDecFloatLiteral(CharSequence var1, int var2, int var3, int var4, boolean var5, boolean var6) {
      long var7 = 0L;
      int var9 = var2;
      int var10 = -1;
      boolean var11 = false;
      ...
      while (var2 < var4) {
         var12 = var1.charAt(var2);
         if (FastDoubleSwar.isDigit(var12)) {
      ...
      if ((var12 | ' ') == 101) {
         ...
         var11 |= !FastDoubleSwar.isDigit(var12);
         ...
         do {
            ...
            var12 = charAt(var1, ++var2, var4);
         } while (FastDoubleSwar.isDigit(var12));
      ...
      if (!var11 && var2 >= var4 && (var6 || var13 != 0)) {
         int var18 = 0;
         int var19;
         boolean var23;
         if (var13 > 19) {
         ...
         return this.valueOfFloatLiteral(var1, var3, var4, var5, var7, var15, var23, var19);
      } else {
         throw new NumberFormatException("illegal syntax");
      }
   }

   public final long parseFloatingPointLiteral(CharSequence var1, int var2, int var3) {
      int var4 = var2 + var3;
   ...
   private long parseHexFloatLiteral(CharSequence var1, int var2, int var3, int var4, boolean var5) {
      long var6 = 0L;
      int var8 = 0;
      int var9 = var2;
      int var10 = -1;
      ...
      while (var2 < var4) {
         ...
         if (var14 >= 0) {
            ...
            while (var2 < var4 - 8) {
               long var15 = FastDoubleSwar.tryToParseEightHexDigits(var1, var2 + 1);
               if (var15 < 0L) {
                  break;
               }
      ...
      if (var16) {
         ...
         var12 |= !FastDoubleSwar.isDigit(var13);
         ...
         do {
            ...
            var13 = charAt(var1, ++var2, var4);
         } while (FastDoubleSwar.isDigit(var13));
   ...
   private long parseNaNOrInfinity(CharSequence var1, int var2, int var3, boolean var4) {
      if (var1.charAt(var2) == 'N') {
         if (var2 + 2 < var3 && var1.charAt(var2 + 1) == 'a' && var1.charAt(var2 + 2) == 'N') {
         ...
         && var1.charAt(var2) == 'I'
         && var1.charAt(var2 + 1) == 'n'
         && var1.charAt(var2 + 2) == 'f'
         && var1.charAt(var2 + 3) == 'i'
         && var1.charAt(var2 + 4) == 'n'
         && var1.charAt(var2 + 5) == 'i'
         && var1.charAt(var2 + 6) == 't'
         && var1.charAt(var2 + 7) == 'y') {
