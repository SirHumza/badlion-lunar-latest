...
public final class IOHCCIRCCICICHHHIOIOHCICICROIO {
   private IOHCCIRCCICICHHHIOIOHCICICROIO() {
   }
   ...
   public static <T> T[] newArray(T[] var0, int var1) {
      return (T[])IHHRRRRCOCHIIOIOHORHCIRRRCHCCR.newArray(var0, var1);
   }
