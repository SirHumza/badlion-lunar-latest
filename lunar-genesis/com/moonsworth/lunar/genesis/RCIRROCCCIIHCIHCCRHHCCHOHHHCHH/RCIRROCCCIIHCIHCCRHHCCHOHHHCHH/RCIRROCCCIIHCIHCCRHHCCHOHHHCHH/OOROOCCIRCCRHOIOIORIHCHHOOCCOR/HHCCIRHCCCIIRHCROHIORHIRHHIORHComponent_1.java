...
@Immutable
final class CRICCOOHHHCHOORCICOCOHIHOIRHOO extends HHCCIRHCCCIIRHCROHIORHIRHHIORH {
   static final IHHCHHHCRIHOOCOIOOCRIIICIOROIR OIRRRRCHRCRIORCHHCCCICIOCICOIO = new CRICCOOHHHCHOORCICOCOHIHOIRHOO();
   ...
   static final class RCIRROCCCIIHCIHCCRHHCCHOHHHCHH
      ...
      static final int[] IHCHHCIHHOOOIHIOCOHCHRCORHOICO = new int[]{
         0,
         -227835133,
         -516198153,
         324072436,
      ...
      public void update(byte var1) {
         this.crc = ~this.crc;
         this.crc = ~(this.crc >>> 8 ^ IHCHHCIHHOOOIHIOCOHCHRCORHOICO[(this.crc ^ var1) & 0xFF]);
      }

      @Override
      public CIOHHCORHRCCRICCCORIHCRHCCCRRR CIRIIOORHHIHICORIOIIRIIHHCOCCI() {
         return CIOHHCORHRCCRICCCORIHCRHCCCRRR.IORHOHORRHRRRHRRHIROIOHHIORORH(this.crc);
      }
   }
}
