...
class IHCRORHRORIICHRHRCHRRIRRHHOCOO {
   public static final int CHIRRCOCORCICHHOOHCCHHIICIROHR = 400;

   private IHCRORHRORIICHRHRCHRRIRRHHOCOO() {
   }

   static BigInteger parseDigitsIterative(byte[] var0, int var1, int var2) {
      int var3 = var2 - var1;
   ...
   static BigInteger parseDigitsRecursive(byte[] var0, int var1, int var2, Map<Integer, BigInteger> var3) {
      int var4 = var2 - var1;
      if (var4 <= 400) {
