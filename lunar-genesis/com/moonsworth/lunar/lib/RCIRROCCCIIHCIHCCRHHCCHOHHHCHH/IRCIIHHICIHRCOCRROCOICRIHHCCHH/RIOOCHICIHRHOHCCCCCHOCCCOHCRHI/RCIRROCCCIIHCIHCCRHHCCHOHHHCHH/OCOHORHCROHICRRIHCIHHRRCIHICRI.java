...
final class OCOHORHCROHICRRIHCIHHRRCIHICRI extends RRCRRCORICCHOHHIRCHIROOHIIOHCO {
   public static final int CROCRICIIIHOCCOCOROOHIIHHIIOIO = 1292782635;
   private static final int ORRICHHRRHHRRRRRCIOHHHCCCRIIOR = 32;
   private static final int CHCCCHOCCHIROOIOOCOCRIHICIHHOR = 1292782621;
   private static final long IRCRHHRROCOCCCHCHHHIHOIOICOICH = 2147483647L;
   ...
   BigDecimal parseBigDecimalStringWithManyDigits(char[] var1, int var2, int var3) {
      ...
      while (var10 < var14 && OOROOCCIRCCRHOIOIORIHCHHOOCCOR.isEightZeroes(var1, var10)) {
         var10 += 8;
      }
      ...
      while (var10 < var14 && OOROOCCIRCCRHOIOIORIHCHHOOCCOR.isEightDigits(var1, var10)) {
         var10 += 8;
      }
   ...
   private BigDecimal valueOfBigDecimalString(char[] var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
      ...
      if (var10 > 0) {
         if (var10 > 400) {
            ...
            var13 = ICICIOCHHHIHOCHCOHORIHRCOHHOCR.parseDigitsRecursive(var1, var2, var3, var11);
         } else {
            var13 = ICICIOCHHHIHOCHCOHORIHRCOHHOCR.parseDigitsRecursive(var1, var2, var3, null);
         }
      } else {
      ...
      if (var9 > 0) {
         ...
         if (var9 > 400) {
            ...
            CRICCOOHHHCHOORCICOCOHIHOIRHOO.fillPowersOfNFloor16Recursive(var11, var3 + 1, var5);
            var14 = ICICIOCHHHIHOCHCOHORIHRCOHHOCR.parseDigitsRecursive(var1, var3 + 1, var5, var11);
         } else {
            var14 = ICICIOCHHHIHOCHCOHORIHRCOHHOCR.parseDigitsRecursive(var1, var3 + 1, var5, null);
         }
