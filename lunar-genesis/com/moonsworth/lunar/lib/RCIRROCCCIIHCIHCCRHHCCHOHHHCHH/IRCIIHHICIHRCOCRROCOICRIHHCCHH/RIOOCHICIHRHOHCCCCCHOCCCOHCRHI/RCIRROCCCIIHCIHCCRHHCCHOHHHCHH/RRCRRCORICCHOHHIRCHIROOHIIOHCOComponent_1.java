...
final class CIOHHCORHRCCRICCCORIHCRHCCCRRR extends RRCRRCORICCHOHHIRCHIROOHIIOHCO {
   public static final int OCRRIOOOOCORRICHICCCROCRRIHCII = 1292782635;
   private static final int IOCCRHHHHOIRRRHHIICOHOOHOHRCRH = 32;
   private static final int ORROIHHCIHIIRRIIOHROOIOIOOOCHO = 1292782621;
   private static final long OOIIIORCRIIOIRHOCIROCIIIIORHCH = 2147483647L;

   public CIOHHCORHRCCRICCCORIHCRHCCCRRR() {
   }

   public BigDecimal parseBigDecimalString(CharSequence var1, int var2, int var3) {
      try {
         if (var3 >= 32) {
   ...
   BigDecimal parseBigDecimalStringWithManyDigits(CharSequence var1, int var2, int var3) {
      if (var3 > 1292782635) {
         throw new NumberFormatException("illegal syntax");
      }
      ...
      while (var10 < var9 && var1.charAt(var10) == '0') {
         var10++;
      }
      ...
      while (var10 < var9 && OOROOCCIRCCRHOIOIORIHCHHOOCCOR.isDigit(var11 = var1.charAt(var10))) {
         var10++;
      }
   ...
   private BigDecimal valueOfBigDecimalString(CharSequence var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
      ...
      if (var10 > 0) {
         if (var10 > 400) {
            ...
            var13 = IRCRRHRCIRHIHIHROHCRRHIIHHHHCH.parseDigitsRecursive(var1, var2, var3, var11);
         } else {
            var13 = IRCRRHRCIRHIHIHROHCRRHIIHHHHCH.parseDigitsRecursive(var1, var2, var3, null);
         }
      } else {
      ...
      if (var8 > 0) {
         ...
         if (var9 > 400) {
            ...
            var14 = IRCRRHRCIRHIHIHROHCRRHIIHHHHCH.parseDigitsRecursive(var1, var4, var5, var11);
         } else {
            var14 = IRCRRHRCIRHIHIHROHCRRHIIHHHHCH.parseDigitsRecursive(var1, var4, var5, null);
         }
