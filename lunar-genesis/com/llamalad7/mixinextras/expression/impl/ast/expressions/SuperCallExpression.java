...
public class SuperCallExpression extends SimpleExpression {
   ...
   public SuperCallExpression(ExpressionSource var1, MemberIdentifier var2, List<Expression> var3) {
      super(var1);
      this.name = var2;
      this.arguments = var3;
   }
   ...
   protected boolean matchesImpl(FlowValue var1, ExpressionContext var2) {
      if (!MethodCallType.SUPER.matches(var1)) {
         return false;
      } else {
         return !this.name.matches(var2.pool, var1)
            ? false
