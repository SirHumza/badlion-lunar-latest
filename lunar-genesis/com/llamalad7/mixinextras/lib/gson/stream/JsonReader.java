...
import com.llamalad7.mixinextras.lib.gson.internal.JsonReaderInternalAccess;
import com.llamalad7.mixinextras.lib.gson.internal.TroubleshootingGuide;
...
public class JsonReader implements Closeable {
   ...
   public JsonReader(Reader var1) {
      ...
      this.in = Objects.requireNonNull(var1, "in == null");
   }
   ...
   private MalformedJsonException syntaxError(String var1) {
      throw new MalformedJsonException(var1 + this.locationString() + "\nSee " + TroubleshootingGuide.createUrl("malformed-json"));
   }

   private IllegalStateException unexpectedTokenError(String var1) {
