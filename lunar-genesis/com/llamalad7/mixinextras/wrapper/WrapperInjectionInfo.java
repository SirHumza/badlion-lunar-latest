...
public abstract class WrapperInjectionInfo extends MixinExtrasInjectionInfo implements LateApplyingInjectorInfo {
   ...
   protected WrapperInjectionInfo(InjectorWrapperImpl.Factory var1, MixinTargetContext var2, MethodNode var3, AnnotationNode var4) {
      super(var2, var3, var4);
      this.impl = var1.create(this, var2, var3, var4);
      this.delegate = this.impl.getDelegate();
      boolean var5 = LateApplyingInjectorInfo.wrap(this.delegate, this);
      if (this.delegate instanceof WrapperInjectionInfo) {
         WrapperInjectionInfo var6 = (WrapperInjectionInfo)this.delegate;
         var5 = var6.lateApply;
      } else if (!var5 && this.impl.usesGranularInject()) {
         this.checkDelegate();
      }
   ...
   public void addCallbackInvocation(MethodNode var1) {
      this.impl.addCallbackInvocation(var1);
   }
   ...
   public void wrap(LateApplyingInjectorInfo var1) {
      LateApplyingInjectorInfo.wrap(this.delegate, var1);
   }
