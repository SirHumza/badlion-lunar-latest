...
public final class JsonPrimitive extends JsonElement {
   ...
   public JsonPrimitive(Character var1) {
      this.value = Objects.requireNonNull(var1).toString();
   }
   ...
   public boolean equals(Object var1) {
      ...
      if (var1 != null && this.getClass() == var1.getClass()) {
         ...
         if (isIntegral(this) && isIntegral(var2)) {
            return !(this.value instanceof BigInteger) && !(var2.value instanceof BigInteger)
               ? this.getAsNumber().longValue() == var2.getAsNumber().longValue()
               : this.getAsBigInteger().equals(var2.getAsBigInteger());
         }
