...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
   ...
   public <T> TypeAdapter<T> create(Gson var1, TypeToken<T> var2) {
      ...
      Type[] var5 = $Gson$Types.getMapKeyAndValueTypes(var3, var4);
      TypeAdapter var6 = this.getKeyAdapter(var1, var5[0]);
      TypeAdapter var7 = var1.getAdapter(TypeToken.get(var5[1]));
      ObjectConstructor var8 = this.constructorConstructor.get(var2);
      return new MapTypeAdapterFactory.Adapter(var1, var5[0], var6, var5[1], var7, var8);
   }
         ...
         if (var2 == null) {
            ...
            if (var3) {
               ...
               for (int var14 = var4.size(); var12 < var14; var12++) {
                  JsonElement var15 = (JsonElement)var4.get(var12);
                  var1.name(this.keyToString(var15));
