...
public class ReflectionHelper {
      ...
      try {
         ...
         throw new JsonIOException(
            "Failed making "
               ...
               + getInaccessibleTroubleshootingSuffix(var3),
            var3
         );
      }
   }
   ...
   public static RuntimeException createExceptionForUnexpectedIllegalAccess(IllegalAccessException var0) {
      throw new RuntimeException(
         "Unexpected IllegalAccessException occurred (Gson 2.11.0). Certain ReflectionAccessFilter features require Java >= 9 to work correctly. If you are not using ReflectionAccessFilter, report this to the Gson maintainers.",
         var0
      );
   }
   ...
   private static RuntimeException createExceptionForRecordReflectionException(ReflectiveOperationException var0) {
      throw new RuntimeException(
         "Unexpected ReflectiveOperationException occurred (Gson 2.11.0). To support Java records, reflection is utilized to read out information about records. All these invocations happens after it is established that records exist in the JVM. This exception is unexpected behavior.",
         var0
      );
   }

   static {
      ReflectionHelper.RecordHelper var0;
      try {
   ...
   private static class RecordSupportedHelper extends ReflectionHelper.RecordHelper {
      ...
      String[] getRecordComponentNames(Class<?> var1) {
         try {
            Object[] var2 = (Object[])this.getRecordComponents.invoke(var1);
