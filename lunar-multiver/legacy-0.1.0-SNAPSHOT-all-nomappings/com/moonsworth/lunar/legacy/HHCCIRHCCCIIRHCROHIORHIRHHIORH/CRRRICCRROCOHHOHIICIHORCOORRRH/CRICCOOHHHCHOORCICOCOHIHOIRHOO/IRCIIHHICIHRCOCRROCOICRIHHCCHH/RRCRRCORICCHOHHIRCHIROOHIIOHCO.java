...
public interface RRCRRCORICCHOHHIRCHIROOHIIOHCO
   extends com.moonsworth.lunar.HHCCIRHCCCIIRHCROHIORHIRHHIORH.RRCRRCORICCHOHHIRCHIROOHIIOHCO.CORCOCICIRIOHROHROIIOOHICCHCRR.IRCIIHHICIHRCOCRROCOICRIHHCCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH {
   @Shadow
   boolean isGui3d();
   ...
   default com.moonsworth.lunar.HHCCIRHCCCIIRHCROHIORHIRHHIORH.RRCRRCORICCHOHHIRCHIROOHIIOHCO.OOROOCCIRCCRHOIOIORIHCHHOOCCOR.IRCIIHHICIHRCOCRROCOICRIHHCCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH.RCIRROCCCIIHCIHCCRHHCCHOHHHCHH bridge$getItemCameraTransforms() {
   ...
   default Optional<RHOCHHIRRCHHHOHOIRROIROHHHIHIO> bridge$getParticleTexture() {
      TextureAtlasSprite var1 = this.getParticleTexture();
      return var1 == null ? Optional.empty() : Optional.of((RHOCHHIRRCHHHOHOIRROIROHHHIHIO)var1);
   }
}
