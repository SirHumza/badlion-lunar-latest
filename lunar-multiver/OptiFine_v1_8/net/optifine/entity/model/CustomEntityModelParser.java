...
public class CustomEntityModelParser {
   ...
   private static void processExternalModel(JsonObject elem, Map mapModelJsons, String basePath) {
      ...
      if (modelPath != null) {
         jy locJson = getResourceLocation(basePath, modelPath, ".jpm");
   ...
   public static jy getResourceLocation(String basePath, String path, String extension) {
   ...
   public static CustomModelRenderer parseCustomModelRenderer(JsonObject elem, int[] textureSize, String basePath) {
      ...
      bbo modelBase = new CustomEntityModel();
      if (textureSize != null) {
         modelBase.t = textureSize[0];
         modelBase.u = textureSize[1];
      }
      ...
      bct mr = PlayerItemParser.parseModelRenderer(elem, modelBase, textureSize, basePath);
   ...
   public static JsonObject loadJson(jy location) throws IOException, JsonParseException {
