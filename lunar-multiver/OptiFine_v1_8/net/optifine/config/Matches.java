...
public class Matches {
   public static boolean block(aly blockStateBase, MatchBlock[] matchBlocks) {
      if (matchBlocks == null) {
         return true;
      }
   ...
   public static boolean sprite(bmi sprite, bmi[] sprites) {
      if (sprites == null) {
         return true;
      }
   ...
   public static boolean biome(ady biome, ady[] biomes) {
      if (biomes == null) {
         return true;
      }
