   ...
   public float evalFloat(IExpression[] args) {
      switch (this) {
         ...
         case PI:
            return ns.PI;
         case SIN:
            return ns.a(evalFloat(args, 0));
         case COS:
            return ns.b(evalFloat(args, 0));
         case ASIN:
         ...
         case ATAN2:
            return (float)ns.b(evalFloat(args, 0), evalFloat(args, 1));
         case TORAD:
         ...
         case CLAMP:
            return ns.a(evalFloat(args, 0), evalFloat(args, 1), evalFloat(args, 2));
         case ABS:
            return ns.e(evalFloat(args, 0));
         case EXP:
            return (float)Math.exp(evalFloat(args, 0));
         case FLOOR:
            return ns.d(evalFloat(args, 0));
         case CEIL:
            return ns.f(evalFloat(args, 0));
         case FRAC:
            return (float)ns.h(evalFloat(args, 0));
         case LOG:
         ...
         case SQRT:
            return ns.c(evalFloat(args, 0));
         case FMOD:
            float fmodX = evalFloat(args, 0);
            float fmodY = evalFloat(args, 1);
            return fmodX - fmodY * ns.d(fmodX / fmodY);
         case TIME:
            ave mc = ave.A();
            adm world = mc.f;
            if (world == null) {
            ...
            return (float)(world.K() % 24000L) + Config.renderPartialTicks;
         case IF:
