...
public class GuiShaders extends GuiScreenOF {
   ...
   public void b() {
      this.screenTitle = bnq.a("of.options.shadersTitle", new Object[0]);
      ...
      this.n.add(new avs(201, xFolder, yFolder, btnFolderWidth - 22 + 1, btnHeight, Lang.get("of.options.shaders.shadersFolder")));
      this.n.add(new GuiButtonDownloadShaders(210, xFolder + btnFolderWidth - 22 - 1, yFolder));
      this.n.add(new avs(202, shaderListWidth / 4 * 3 - btnFolderWidth / 2, this.m - 25, btnFolderWidth, btnHeight, bnq.a("gui.done", new Object[0])));
      this.n.add(new avs(203, btnX, this.m - 25, btnWidth, btnHeight, Lang.get("of.options.shaders.shaderOptions")));
      this.updateButtons();
   }
   ...
   @Override
   protected void actionPerformedRightClick(avs button) {
      this.actionPerformed(button, true);
   }

   private void actionPerformed(avs button, boolean rightClick) {
      if (button.l) {
               ...
               switch (button.k) {
                  case 201:
                     ...
                     try {
                        ...
                        var3.getMethod("browse", URI.class).invoke(var4, new File(this.j.v, "shaderpacks").toURI());
