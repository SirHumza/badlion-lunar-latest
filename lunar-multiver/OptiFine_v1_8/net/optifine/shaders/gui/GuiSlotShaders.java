...
class GuiSlotShaders extends awi {
   ...
   private boolean checkCompatible(IShaderPack sp, int index) {
      ...
      String msg1 = bnq.a("of.message.shaders.nv1", new Object[]{verMin});
      String msg2 = bnq.a("of.message.shaders.nv2", new Object[0]);
      final int theIndex = index;
      awx callback = new awx() {
      ...
      awy guiYesNo = new awy(callback, msg1, msg2, 0);
      this.a.a(guiYesNo);
      return false;
   }
