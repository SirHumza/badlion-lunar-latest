...
public class Shaders {
   ...
   public static final File shaderPacksDir = new File(ave.A().v, "shaderpacks");
   static File configFile = new File(ave.A().v, "optionsshaders.txt");
   ...
   public static void loadShaderPack() {
      ...
      if (mc.g != null) {
         mc.g.resumeChunkUpdates();
      }

      if ((formatChanged || oldLightingChanged) && mc.Q() != null) {
         mc.B();
      }
   }
   ...
   private static ICustomTexture loadCustomTextureRaw(
      ...
      try {
         ...
         if (in == null) {
            ...
            ByteBuffer bb = avd.c(bytes.length);
            bb.put(bytes);
            ((Buffer)bb).flip();
            bon tms = SimpleShaderTexture.loadTextureMetadataSection(pathFull, new bon(true, true, new ArrayList()));
            return new CustomTextureRaw(type, internalFormat, width, height, depth, pixelFormat, pixelType, bb, textureUnit, tms.a(), tms.b());
         }
      } catch (IOException e) {
   ...
   public static int checkGLError(String location) {
      ...
      if (errorCode != 0 && GlErrors.isEnabled(errorCode)) {
         ...
         if (Config.isShowGlErrors() && TimedEvent.isActive("ShowGlErrorShaders", 10000L)) {
            String messageChat = bnq.a("of.message.openglError", new Object[]{errorCode, errorText});
   ...
   public static void useProgram(Program program) {
      ...
      if (activeProgram != program) {
         ...
         if (programID != 0) {
            ...
            zx stack = mc.h != null ? mc.h.bA() : null;
            ...
            setProgramUniform1f(uniform_far, mc.t.c * 16);
            ...
            setProgramUniform1f(uniform_screenBrightness, mc.t.aJ);
            setProgramUniform1i(uniform_hideGUI, mc.t.aA ? 1 : 0);
   ...
   private static void setupFrameBuffer() {
      ...
      for (int i = 0; i < usedColorBuffers; i++) {
         bfl.i(dfbColorTexturesFlip.getA(i));
         GL11.glTexParameteri(3553, 10242, 33071);
         GL11.glTexParameteri(3553, 10243, 33071);
      ...
      for (int i = 0; i < usedColorBuffers; i++) {
         bfl.i(dfbColorTexturesFlip.getB(i));
         GL11.glTexParameteri(3553, 10242, 33071);
         GL11.glTexParameteri(3553, 10243, 33071);
         GL11.glTexParameteri(3553, 10241, 9729);
         GL11.glTexParameteri(3553, 10240, 9729);
   ...
   public static void beginRender(ave minecraft, float partialTicks, long finishTimeNano) {
      ...
      if (renderViewEntity != null) {
         ...
         afh cameraBlock = auz.a(mc.f, renderViewEntity, partialTicks);
         arm cameraPosMaterial = cameraBlock.t();
         if (cameraPosMaterial == arm.h) {
            isEyeInWater = 1;
         } else if (cameraPosMaterial == arm.i) {
            isEyeInWater = 2;
         } else {
            isEyeInWater = 0;
         }
         ...
         if (mc.h != null) {
            ...
            blindness = 0.0F;
            if (mc.h.a(pe.q)) {
               int blindnessTicks = mc.h.b(pe.q).b();
               blindness = Config.limit(blindnessTicks / 20.0F, 0.0F, 1.0F);
            }
         }

         aui skyColorV = mc.f.a(renderViewEntity, partialTicks);
   ...
   private static void bindGbuffersTextures() {
      ...
      for (int i = 0; i < 4 && 4 + i < usedColorBuffers; i++) {
         bfl.g(33991 + i);
         bfl.i(dfbColorTexturesFlip.getA(4 + i));
      }
      ...
      if (noiseTextureEnabled) {
         bfl.g(33984 + noiseTexture.getTextureUnit());
         bfl.i(noiseTexture.getTextureId());
      }
   ...
   public static void checkWorldChanged(adm world) {
      if (currentWorld != world) {
         adm oldWorld = currentWorld;
         currentWorld = world;
         setCameraOffset(mc.ac());
   ...
   private static int getDimensionId(adm world) {
      return world == null ? Integer.MIN_VALUE : world.t.q();
   }
   ...
   public static void clearRenderBuffer() {
      if (isShadowPass) {
         ...
         if (gbuffersClear[1]) {
            GL11.glClearColor(1.0F, 1.0F, 1.0F, 1.0F);
            Vector4f col = gbuffersClearColor[1];
            if (col != null) {
               GL11.glClearColor(col.getX(), col.getY(), col.getZ(), col.getW());
            }
   ...
   private static void updateCameraOffset(pk viewEntity) {
   ...
   private static void setCameraOffset(pk viewEntity) {
      if (viewEntity == null) {
         cameraOffsetX = 0;
         cameraOffsetZ = 0;
      } else {
         cameraOffsetX = (int)viewEntity.s / 1000 * 1000;
         cameraOffsetZ = (int)viewEntity.u / 1000 * 1000;
      }
   }
      ...
      if (hasGlGenMipmap) {
         for (int i = 0; i < usedColorBuffers; i++) {
            if ((activeCompositeMipmapSetting & 1 << i) != 0) {
               bfl.g(33984 + colorTextureImageUnit[i]);
   ...
   private static void preDrawComposite() {
      ...
      if (rs != null) {
         int x = (int)(renderWidth * rs.getOffsetX());
         int y = (int)(renderHeight * rs.getOffsetY());
         int w = (int)(renderWidth * rs.getScale());
         int h = (int)(renderHeight * rs.getScale());
   ...
   public static void drawHorizon() {
      ...
      tess.b(xzn, top, xzm).d();
      tess.b(xzn, bot, xzm).d();
      tess.b(xzm, bot, xzm).d();
      tess.b(xzm, bot, xzq).d();
      tess.b(xzq, bot, xzq).d();
      tess.b(xzq, bot, xzm).d();
      bfx.a().b();
   }
   ...
   private static int getBlockEntityId(akw tileEntity) {
      if (tileEntity == null) {
         return -1;
      }
   ...
   public static void pushEntity(afh block) {
      entityDataIndex++;
      int blockRenderType = block.b();
      entityData[entityDataIndex * 2] = afh.c.b(block) & 65535 | blockRenderType << 16;
      entityData[entityDataIndex * 2 + 1] = 0;
   }
   ...
   public static void setItemToRenderOff(zx itemToRenderOff) {
