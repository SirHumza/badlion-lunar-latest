   ...
   public float eval(int index1, int index2) {
      if (this.indexNames1 == null || index1 >= 0 && index1 <= this.indexNames1.length) {
         if (this.indexNames2 == null || index2 >= 0 && index2 <= this.indexNames2.length) {
            switch (this) {
               case BIOME: {
                  cj pos = Shaders.getCameraPosition();
                  ady biome = Shaders.getCurrentWorld().b(pos);
                  return biome.az;
               }
               case TEMPERATURE:
                  cj var5 = Shaders.getCameraPosition();
                  ady var7 = Shaders.getCurrentWorld().b(var5);
                  return var7 != null ? var7.a(var5) : 0.0F;
               case RAINFALL: {
                  cj pos = Shaders.getCameraPosition();
                  ady biome = Shaders.getCurrentWorld().b(pos);
                  return biome != null ? biome.i() : 0.0F;
               }
               default:
