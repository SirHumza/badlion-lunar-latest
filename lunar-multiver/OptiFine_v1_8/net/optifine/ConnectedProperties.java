...
public class ConnectedProperties {
   ...
   public bmi[] connectTileIcons = null;
   public int tintIndex = -1;
   public alz tintBlockState = afi.a.Q();
   public adf layer = null;
   ...
   public ConnectedProperties(Properties props, String path) {
      ...
      this.tintBlockState = cp.parseBlockState(props.getProperty("tintBlock"), afi.a.Q());
      this.layer = cp.parseBlockRenderLayer(props.getProperty("layer"), adf.b);
   }
   ...
   private static bmi getIcon(String iconName) {
      ...
      return icon != null ? icon : textureMapBlocks.getSpriteSafe("blocks/" + iconName);
   }
   ...
   private boolean isValidOverlay(String path) {
      ...
      if (this.layer != null && this.layer != adf.a) {
         return true;
      }
   ...
   private static bmi[] registerIcons(String[] tileNames, bmh textureMap, boolean skipTiles, boolean defaultTiles) {
      if (tileNames == null) {
         return null;
      }
      ...
      return iconList.toArray(new bmi[iconList.size()]);
   }
   ...
   public boolean matchesBiome(ady biome) {
