...
public class CustomColormap implements CustomColors.IColorizer {
   ...
   public int getColorSmooth(adq blockAccess, double x, double y, double z, int radius) {
      if (this.format == 2) {
         return this.color;
      }
   ...
   private int getColorVanilla(ady biome, cj blockPos) {
      ...
      int cx = (int)((1.0 - temperature) * (this.width - 1));
      int cy = (int)((1.0 - rainfall) * (this.height - 1));
