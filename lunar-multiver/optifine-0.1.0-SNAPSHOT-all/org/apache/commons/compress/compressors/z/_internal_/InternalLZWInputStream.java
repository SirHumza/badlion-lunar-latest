...
public abstract class InternalLZWInputStream extends CompressorInputStream {
   ...
   public int read() {
      ...
      return var1 < 0 ? var1 : 0xFF & this.oneByte[0];
   }
   ...
   protected int readNextCode() {
      while (this.bitsCachedSize < this.codeSize) {
         ...
         this.bitsCached = this.bitsCached | var1 << this.bitsCachedSize;
         this.bitsCachedSize += 8;
      }

      int var3 = (1 << this.codeSize) - 1;
      int var2 = this.bitsCached & var3;
      this.bitsCached = this.bitsCached >>> this.codeSize;
      this.bitsCachedSize = this.bitsCachedSize - this.codeSize;
      return var2;
   }
   ...
   protected int expandCodeToOutputStack(int var1, boolean var2) {
      int var3 = var1;

      while (var3 >= 0) {
         this.outputStack[--this.outputStackLocation] = this.characters[var3];
         var3 = this.prefixes[var3];
      }
