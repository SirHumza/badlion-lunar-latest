...
public class GzipCompressorOutputStream extends CompressorOutputStream {
   ...
   public GzipCompressorOutputStream(OutputStream var1) {
      this(var1, new GzipParameters());
   }

   public GzipCompressorOutputStream(OutputStream var1, GzipParameters var2) {
      this.out = var1;
      this.deflater = new Deflater(var2.getCompressionLevel(), true);
      this.writeHeader(var2);
   }

   private void writeHeader(GzipParameters var1) {
