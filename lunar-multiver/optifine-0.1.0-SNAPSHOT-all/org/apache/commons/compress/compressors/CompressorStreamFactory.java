...
public class CompressorStreamFactory {
   ...
   public CompressorInputStream createCompressorInputStream(InputStream var1) {
      if (var1 == null) {
      ...
      try {
         ...
         if (XZUtils.matches(var2, var3) && XZUtils.isXZCompressionAvailable()) {
   ...
   public CompressorInputStream createCompressorInputStream(String var1, InputStream var2) {
      if (var1 != null && var2 != null) {
         try {
            ...
            if ("deflate".equalsIgnoreCase(var1)) {
               return new DeflateCompressorInputStream(var2);
            }
         } catch (IOException var4) {
   ...
   public CompressorOutputStream createCompressorOutputStream(String var1, OutputStream var2) {
      if (var1 != null && var2 != null) {
         try {
            if ("gz".equalsIgnoreCase(var1)) {
            ...
            if ("deflate".equalsIgnoreCase(var1)) {
               return new DeflateCompressorOutputStream(var2);
            }
         } catch (IOException var4) {
