...
public class DumpArchiveInputStream extends ArchiveInputStream {
   ...
   public DumpArchiveInputStream(InputStream var1) {
      this(var1, null);
   }

   public DumpArchiveInputStream(InputStream var1, String var2) {
      ...
      this.queue = new PriorityQueue<>(
         ...
         new Comparator<DumpArchiveEntry>() {
            public int compare(DumpArchiveEntry var1, DumpArchiveEntry var2x) {
               return var1.getOriginalName() != null && var2x.getOriginalName() != null
                  ? var1.getOriginalName().compareTo(var2x.getOriginalName())
                  : Integer.MAX_VALUE;
            }
         }
      );
   ...
   public DumpArchiveEntry getNextEntry() {
      ...
      while (var1 == null) {
         ...
         this.active = DumpArchiveEntry.parse(var3);
      ...
      var1.setName(var2);
      var1.setSimpleName(this.names.get(var1.getIno()).getName());
      var1.setOffset(this.filepos);
      return var1;
   }

   private void readDirectoryEntry(DumpArchiveEntry var1) {
      ...
      for (boolean var4 = true; var4 || DumpArchiveConstants.SEGMENT_TYPE.ADDR == var1.getHeaderType(); var2 -= 1024L) {
         ...
         while (var7 < var5 - 8 && var7 < var2 - 8L) {
            int var8 = DumpArchiveUtil.convert32(this.blockBuffer, var7);
            var6 = DumpArchiveUtil.convert16(this.blockBuffer, var7 + 4);
            ...
            if (!".".equals(var10) && !"..".equals(var10)) {
               ...
               for (Entry var13 : this.pending.entrySet()) {
                  String var14 = this.getPath((DumpArchiveEntry)var13.getValue());
                  if (var14 != null) {
                     ((DumpArchiveEntry)var13.getValue()).setName(var14);
                     ((DumpArchiveEntry)var13.getValue()).setSimpleName(this.names.get(var13.getKey()).getName());
                     this.queue.add((DumpArchiveEntry)var13.getValue());
                  }
               }

               for (DumpArchiveEntry var18 : this.queue) {
                  this.pending.remove(var18.getIno());
               }
            }
   ...
   private String getPath(DumpArchiveEntry var1) {
      ...
      StringBuilder var6 = new StringBuilder((String)var2.pop());

      while (!var2.isEmpty()) {
         var6.append('/');
         var6.append((String)var2.pop());
      }
   ...
   public int read(byte[] var1, int var2, int var3) {
      ...
      if (!this.hasHitEOF && !this.isClosed && this.entryOffset < this.entrySize) {
         ...
         if (var3 + this.entryOffset > this.entrySize) {
   ...
   public static boolean matches(byte[] var0, int var1) {
      if (var1 < 32) {
         ...
         return var1 >= 1024 ? DumpArchiveUtil.verify(var0) : 60012 == DumpArchiveUtil.convert32(var0, 24);
      }
   }
}
