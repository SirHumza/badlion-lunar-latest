...
public class DumpArchiveSummary {
   ...
   DumpArchiveSummary(byte[] var1, ZipEncoding var2) {
      this.dumpDate = 1000L * DumpArchiveUtil.convert32(var1, 4);
      this.previousDumpDate = 1000L * DumpArchiveUtil.convert32(var1, 8);
   ...
   public int hashCode() {
      ...
      var1 = (int)(var1 + 31L * this.dumpDate);
   ...
   public boolean equals(Object var1) {
      ...
      if (var1 != null && var1.getClass().equals(this.getClass())) {
         ...
         if (this.dumpDate != var2.dumpDate) {
            ...
            return this.getHostname() == null || !this.getHostname().equals(var2.getHostname())
               ? false
               : this.getDevname() != null && this.getDevname().equals(var2.getDevname());
         }
      } else {
         return false;
      }
