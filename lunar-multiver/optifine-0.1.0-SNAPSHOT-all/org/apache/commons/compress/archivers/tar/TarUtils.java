...
public class TarUtils {
   ...
   private static long parseBinaryLong(byte[] var0, int var1, int var2, boolean var3) {
      ...
      for (int var6 = 1; var6 < var2; var6++) {
         var4 = (var4 << 8) + (var0[var1 + var6] & 0xFF);
      }

      if (var3) {
         var4 = --var4 ^ (long)Math.pow(2.0, (var2 - 1) * 8) - 1L;
      }
   ...
   private static String exceptionMessage(byte[] var0, int var1, int var2, int var3, byte var4) {
      ...
      return "Invalid byte " + var4 + " at offset " + (var3 - var1) + " in '" + var5 + "' len=" + var2;
   }
   ...
   public static String parseName(byte[] var0, int var1, int var2, ZipEncoding var3) {
      int var4 = var2;

      while (var4 > 0 && var0[var1 + var4 - 1] == 0) {
         var4--;
      }
   ...
   public static int formatNameBytes(String var0, byte[] var1, int var2, int var3, ZipEncoding var4) {
      int var5 = var0.length();
      ByteBuffer var6 = var4.encode(var0);

      while (var6.limit() > var3 && var5 > 0) {
         var6 = var4.encode(var0.substring(0, --var5));
      }
   ...
   public static void formatUnsignedOctalString(long var0, byte[] var2, int var3, int var4) {
      ...
      if (var0 == 0L) {
         ...
         for (var6 = var0; var5 >= 0 && var6 != 0L; var5--) {
            var2[var3 + var5] = (byte)(48 + (byte)(var6 & 7L));
            var6 >>>= 3;
         }
