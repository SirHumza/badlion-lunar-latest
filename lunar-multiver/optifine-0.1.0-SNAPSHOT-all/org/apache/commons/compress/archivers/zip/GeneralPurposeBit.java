...
public final class GeneralPurposeBit {
   ...
   public byte[] encode() {
      return ZipShort.getBytes(
         (this.dataDescriptorFlag ? 8 : 0) | (this.languageEncodingFlag ? 2048 : 0) | (this.encryptionFlag ? 1 : 0) | (this.strongEncryptionFlag ? 64 : 0)
      );
   }
   ...
   public int hashCode() {
      return 3
         * (
            7 * (13 * (17 * (this.encryptionFlag ? 1 : 0) + (this.strongEncryptionFlag ? 1 : 0)) + (this.languageEncodingFlag ? 1 : 0))
   ...
   public boolean equals(Object var1) {
      ...
      return var2.encryptionFlag == this.encryptionFlag
         && var2.strongEncryptionFlag == this.strongEncryptionFlag
         && var2.languageEncodingFlag == this.languageEncodingFlag
         && var2.dataDescriptorFlag == this.dataDescriptorFlag;
   }
}
