...
public class Zip64ExtendedInformationExtraField implements ZipExtraField {
   ...
   public ZipShort getCentralDirectoryLength() {
      return new ZipShort(
         (this.size != null ? 8 : 0) + (this.compressedSize != null ? 8 : 0) + (this.relativeHeaderOffset != null ? 8 : 0) + (this.diskStart != null ? 4 : 0)
      );
   }
   ...
   public void reparseCentralDirectoryData(boolean var1, boolean var2, boolean var3, boolean var4) {
         ...
         if (this.rawCentralDirectoryData.length < var5) {
            throw new ZipException(
               "central directory zip64 extended information extra field's length doesn't match central directory data.  Expected length "
                  + var5
                  + " but is "
                  + this.rawCentralDirectoryData.length
            );
         }
