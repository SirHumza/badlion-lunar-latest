...
class UnshrinkingInputStream extends InternalLZWInputStream {
   ...
   public UnshrinkingInputStream(InputStream var1) {
      super(var1);
   ...
   @Override
   protected int addEntry(int var1, byte var2) {
   ...
   private void partialClear() {
      ...
      for (int var2 = 0; var2 < this.isUsed.length; var2++) {
         if (this.isUsed[var2] && this.prefixes[var2] != -1) {
            var1[this.prefixes[var2]] = true;
         }
      }

      for (int var3 = this.clearCode + 1; var3 < var1.length; var3++) {
         if (!var1[var3]) {
            this.isUsed[var3] = false;
            this.prefixes[var3] = -1;
         }
      }
   }
