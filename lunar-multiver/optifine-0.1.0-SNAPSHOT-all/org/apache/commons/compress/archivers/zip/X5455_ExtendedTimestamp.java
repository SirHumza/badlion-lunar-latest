...
public class X5455_ExtendedTimestamp implements Serializable, Cloneable, ZipExtraField {
   ...
   public byte[] getLocalFileDataData() {
      ...
      if (this.bit0_modifyTimePresent) {
         ...
         System.arraycopy(this.modifyTime.getBytes(), 0, var1, var2, 4);
         var2 += 4;
      }

      if (this.bit1_accessTimePresent && this.accessTime != null) {
         var1[0] = (byte)(var1[0] | 2);
         System.arraycopy(this.accessTime.getBytes(), 0, var1, var2, 4);
         var2 += 4;
      }

      if (this.bit2_createTimePresent && this.createTime != null) {
         var1[0] = (byte)(var1[0] | 4);
         System.arraycopy(this.createTime.getBytes(), 0, var1, var2, 4);
         var2 += 4;
      }
   ...
   public String toString() {
      ...
      if (this.bit0_modifyTimePresent && this.modifyTime != null) {
         Date var2 = this.getModifyJavaTime();
         var1.append(" Modify:[").append(var2).append("] ");
      }

      if (this.bit1_accessTimePresent && this.accessTime != null) {
         Date var3 = this.getAccessJavaTime();
         var1.append(" Access:[").append(var3).append("] ");
      }

      if (this.bit2_createTimePresent && this.createTime != null) {
         Date var4 = this.getCreateJavaTime();
         var1.append(" Create:[").append(var4).append("] ");
      }
   ...
   public boolean equals(Object var1) {
      ...
      return (this.flags & 7) == (var2.flags & 7)
         && (this.modifyTime == var2.modifyTime || this.modifyTime != null && this.modifyTime.equals(var2.modifyTime))
         && (this.accessTime == var2.accessTime || this.accessTime != null && this.accessTime.equals(var2.accessTime))
         && (this.createTime == var2.createTime || this.createTime != null && this.createTime.equals(var2.createTime));
   }
