...
public class CpioArchiveOutputStream extends ArchiveOutputStream implements CpioConstants {
   ...
   public void putArchiveEntry(ArchiveEntry var1) {
      ...
      if (this.names.put(var2.getName(), var2) != null) {
   ...
   private void writeHeader(CpioArchiveEntry var1) {
   ...
   private void writeNewEntry(CpioArchiveEntry var1) {
   ...
   private void writeOldAsciiEntry(CpioArchiveEntry var1) {
      ...
      this.writeAsciiLong(var1.getName().length() + 1, 6, 8);
      this.writeAsciiLong(var1.getSize(), 11, 8);
      this.writeCString(var1.getName());
   }

   private void writeOldBinaryEntry(CpioArchiveEntry var1, boolean var2) {
      ...
      this.writeBinaryLong(var1.getName().length() + 1, 2, var2);
   ...
   public void write(byte[] var1, int var2, int var3) {
      ...
      if (var3 != 0) {
         ...
         if (this.written + var3 > this.entry.getSize()) {
         ...
         if (this.entry.getFormat() == 2) {
            for (int var4 = 0; var4 < var3; var4++) {
               this.crc = this.crc + (var1[var4] & 0xFF);
            }
         }
   ...
   public void finish() {
      ...
      this.closeArchiveEntry();
      int var1 = (int)(this.getBytesWritten() % this.blockSize);
      if (var1 != 0) {
   ...
   private void writeBinaryLong(long var1, int var3, boolean var4) {
      byte[] var5 = CpioUtil.long2byteArray(var1, var3, var4);
      this.out.write(var5);
      this.count(var5.length);
   }

   private void writeAsciiLong(long var1, int var3, int var4) {
   ...
   private void writeCString(String var1) {
