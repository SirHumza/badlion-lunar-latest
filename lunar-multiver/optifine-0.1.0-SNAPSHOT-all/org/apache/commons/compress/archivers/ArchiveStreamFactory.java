...
public class ArchiveStreamFactory {
   ...
   public ArchiveInputStream createArchiveInputStream(String var1, InputStream var2) {
      if (var1 == null) {
   ...
   public ArchiveOutputStream createArchiveOutputStream(String var1, OutputStream var2) {
      if (var1 == null) {
         throw new IllegalArgumentException("Archivername must not be null.");
      }
      ...
      if ("ar".equalsIgnoreCase(var1)) {
         return new ArArchiveOutputStream(var2);
      }

      if ("zip".equalsIgnoreCase(var1)) {
   ...
   public ArchiveInputStream createArchiveInputStream(InputStream var1) {
      if (var1 == null) {
