...
public class ArArchiveOutputStream extends ArchiveOutputStream {
   ...
   private long fill(long var1, long var3, char var5) {
      long var6 = var3 - var1;
      if (var6 > 0L) {
   ...
   private long write(String var1) {
      byte[] var2 = var1.getBytes("ascii");
      this.write(var2);
      return var2.length;
   }

   private long writeEntryHeader(ArArchiveEntry var1) {
      long var2 = 0L;
      boolean var4 = false;
      ...
      String var10 = String.valueOf(var1.getLength() + (var4 ? var5.length() : 0));
      if (var10.length() > 10) {
