...
public class ArjArchiveInputStream extends ArchiveInputStream {
   ...
   public ArjArchiveInputStream(InputStream var1, String var2) {
   ...
   public ArjArchiveInputStream(InputStream var1) {
      this(var1, "CP437");
   }
   ...
   private int read8(DataInputStream var1) {
      int var2 = var1.readUnsignedByte();
      this.count(1);
      return var2;
   }

   private int read16(DataInputStream var1) {
      int var2 = var1.readUnsignedShort();
      this.count(2);
      return Integer.reverseBytes(var2) >>> 16;
   }

   private int read32(DataInputStream var1) {
      int var2 = var1.readInt();
      this.count(4);
      return Integer.reverseBytes(var2);
   }

   private String readString(DataInputStream var1) {
   ...
   private void readFully(DataInputStream var1, byte[] var2) {
      var1.readFully(var2);
   ...
   private byte[] readHeader() {
      ...
      do {
         ...
         if (var5 <= 2600) {
            ...
            long var6 = this.read32(this.in) & 4294967295L;
   ...
   private MainHeader readMainHeader() {
      ...
      var6.archiveSize = 4294967295L & this.read32(var5);
      ...
      if (var7 > 0) {
         ...
         long var8 = 4294967295L & this.read32(this.in);
   ...
   private LocalFileHeader readLocalFileHeader() {
      ...
      var6.reserved = var5.readUnsignedByte();
      var6.dateTimeModified = this.read32(var5);
      var6.compressedSize = 4294967295L & this.read32(var5);
      var6.originalSize = 4294967295L & this.read32(var5);
      var6.originalCrc32 = 4294967295L & this.read32(var5);
      var6.fileSpecPosition = this.read16(var5);
      ...
      while ((var8 = this.read16(this.in)) > 0) {
         ...
         long var10 = 4294967295L & this.read32(this.in);
      ...
      var6.extendedHeaders = var7.toArray(new byte[var7.size()][]);
      return var6;
   }

   private void readExtraData(int var1, DataInputStream var2, LocalFileHeader var3) {
      if (var1 >= 33) {
   ...
   public ArjArchiveEntry getNextEntry() {
      ...
      if (this.currentLocalFileHeader != null) {
         ...
         if (this.currentLocalFileHeader.method == 0) {
            this.currentInputStream = new CRC32VerifyingInputStream(
               this.currentInputStream, this.currentLocalFileHeader.originalSize, this.currentLocalFileHeader.originalCrc32
            );
         }
